...
//  differently)
template<class T>
class TargetCodeSourceFragment : public TargetCodeFragment {
...
public:
    ...
    virtual clang::SourceRange getRealRange() {
...
class TargetCodeRegion : public TargetCodeSourceFragment<clang::CapturedStmt *> {
// RTTI function
public:
    static bool classof(const TargetCodeFragment *TCF) {
...
public:
    TargetCodeRegion(clang::CapturedStmt *Node,
        ...
        : TargetCodeSourceFragment<clang::CapturedStmt *>(
              Node, TCFK_TargetCodeRegion),
