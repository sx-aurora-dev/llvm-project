...
namespace llvm {
  ...
  public:
    enum SimpleValueType : uint8_t {
      ...
      v32f16         =  76,   //   32 x f16
      v64f16         =  77,   //   64 x f16
      v128f16        =  78,   //  128 x f16
      v256f16        =  79,   //  256 x f16

      v2bf16         =  80,   //    2 x bf16
      v3bf16         =  81,   //    3 x bf16
      v4bf16         =  82,   //    4 x bf16
      v8bf16         =  83,   //    8 x bf16
      v16bf16        =  84,   //   16 x bf16
      v32bf16        =  85,   //   32 x bf16
      v64bf16        =  86,   //   64 x bf16
      v128bf16       =  87,   //  128 x bf16
      ...
      v32f64         = 107,   //   32 x f64
      v64f64         = 108,   //   64 x f64
      v128f64        = 109,   //  128 x f64
      v256f64        = 110,   //  256 x f64
      v512f64        = 111,   //  512 x f64
      ...
      nxv1bf16       = 150,  // n x  1 x bf16
      nxv2bf16       = 151,  // n x  2 x bf16
      nxv4bf16       = 152,  // n x  4 x bf16
      nxv8bf16       = 153,  // n x  8 x bf16

      nxv1f32        = 154,  // n x  1 x f32
      nxv2f32        = 155,  // n x  2 x f32
      nxv4f32        = 156,  // n x  4 x f32
      nxv8f32        = 157,  // n x  8 x f32
      nxv16f32       = 158,  // n x 16 x f32

      nxv1f64        = 159,  // n x  1 x f64
      nxv2f64        = 160,  // n x  2 x f64
      nxv4f64        = 161,  // n x  4 x f64
      nxv8f64        = 162,  // n x  8 x f64
      ...
      x86mmx         = 163,   // This is an X86 MMX value

      Glue           = 164,   // This glues nodes together during pre-RA sched

      isVoid         = 165,   // This has no value

      Untyped        = 166,   // This value takes a register, but has
                              // unspecified type.  The register class
                              // will be determined by the opcode.

      funcref        = 167,   // WebAssembly's funcref type
      externref      = 168,   // WebAssembly's externref type
      x86amx         = 169,   // This is an X86 AMX value
