...
static const IntrinsicData  IntrinsicsWithoutChain[] = {
  ...
  VE_INTRINSIC_DATA(pvbrd_vsMv_i64,     OP_XXMX,    VEISD::INT_PVBRD_M, 0),
  ...
  VE_INTRINSIC_DATA(vbrd_vsmv_f64,      OP_XXMX,    VEISD::INT_VBRD_M, 0),
  VE_INTRINSIC_DATA(vbrd_vsmv_i64,      OP_XXMX,    VEISD::INT_VBRD_M, 0),
  VE_INTRINSIC_DATA(vbrdl_vs_i32,       ADD_VL,     VEISD::INT_VBRDL, 0),
  VE_INTRINSIC_DATA(vbrdl_vsmv_i32,     OP_XXMX,    VEISD::INT_VBRDL_M, 0),
  VE_INTRINSIC_DATA(vbrdu_vs_f32,       ADD_VL,     VEISD::INT_VBRDU, 0),
  VE_INTRINSIC_DATA(vbrdu_vsmv_f32,     OP_XXMX,    VEISD::INT_VBRDU_M, 0),
