...
static const IntrinsicData  IntrinsicsWithoutChain[] = {
  ...
  VE_INTRINSIC_DATA(pvand_vsvMv,        CONVM_VL,   VEISD::INT_PVAND, 0),
  VE_INTRINSIC_DATA(pvand_vvvMv,        CONVM_VL,   VEISD::INT_PVAND, 0),
  ...
  VE_INTRINSIC_DATA(vand_vsvmv,         CONVM_VL,   VEISD::INT_VAND, 0),
  VE_INTRINSIC_DATA(vand_vvvmv,         CONVM_VL,   VEISD::INT_VAND, 0),
