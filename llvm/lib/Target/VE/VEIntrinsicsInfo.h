...
static const IntrinsicData  IntrinsicsWithoutChain[] = {
  ...
  VE_INTRINSIC_DATA(pvsla_vvsMv,        OP_VXXMV,   VEISD::INT_PVSLA, 0),
  VE_INTRINSIC_DATA(pvsla_vvvMv,        OP_VXXMV,   VEISD::INT_PVSLA, 0),
  VE_INTRINSIC_DATA(pvsll_vvsMv,        OP_VXXMV,   VEISD::INT_PVSLL, 0),
  VE_INTRINSIC_DATA(pvsll_vvvMv,        OP_VXXMV,   VEISD::INT_PVSLL, 0),
  VE_INTRINSIC_DATA(pvsra_vvsMv,        OP_VXXMV,   VEISD::INT_PVSRA, 0),
  VE_INTRINSIC_DATA(pvsra_vvvMv,        OP_VXXMV,   VEISD::INT_PVSRA, 0),
  VE_INTRINSIC_DATA(pvsrl_vvsMv,        OP_VXXMV,   VEISD::INT_PVSRL, 0),
  VE_INTRINSIC_DATA(pvsrl_vvvMv,        OP_VXXMV,   VEISD::INT_PVSRL, 0),
  ...
  VE_INTRINSIC_DATA(vslal_vvsmv,        OP_VXXMV,   VEISD::INT_VSLAL, 0),
  VE_INTRINSIC_DATA(vslal_vvvmv,        OP_VXXMV,   VEISD::INT_VSLAL, 0),
  VE_INTRINSIC_DATA(vslaw_vvsmv,        OP_VXXMV,   VEISD::INT_VSLAW, 0),
  VE_INTRINSIC_DATA(vslaw_vvvmv,        OP_VXXMV,   VEISD::INT_VSLAW, 0),
  VE_INTRINSIC_DATA(vsll_vvsmv,         OP_VXXMV,   VEISD::INT_VSLL, 0),
  VE_INTRINSIC_DATA(vsll_vvvmv,         OP_VXXMV,   VEISD::INT_VSLL, 0),
  VE_INTRINSIC_DATA(vsral_vvsmv,        OP_VXXMV,   VEISD::INT_VSRAL, 0),
  VE_INTRINSIC_DATA(vsral_vvvmv,        OP_VXXMV,   VEISD::INT_VSRAL, 0),
  VE_INTRINSIC_DATA(vsraw_vvsmv,        OP_VXXMV,   VEISD::INT_VSRAW, 0),
  VE_INTRINSIC_DATA(vsraw_vvvmv,        OP_VXXMV,   VEISD::INT_VSRAW, 0),
  VE_INTRINSIC_DATA(vsrl_vvsmv,         OP_VXXMV,   VEISD::INT_VSRL, 0),
  VE_INTRINSIC_DATA(vsrl_vvvmv,         OP_VXXMV,   VEISD::INT_VSRL, 0),
