...
; ModuleID = 'gen/tests/vslaw_vvv.c'
source_filename = "gen/tests/vslaw_vvv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vslaw_vvv(i32* %pvx, i32* %pvz, i64* %pvy, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vslaw_vvv
; CHECK: .LBB0_2
; CHECK: 	vsla.w %v0,%v0,%v1
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %pvz.addr.021 = phi i32* [ %add.ptr3, %for.body ], [ %pvz, %entry ]
  ...
  %0 = bitcast i32* %pvz.addr.021 to i8*
  ...
  %4 = tail call <256 x double> @llvm.ve.vslaw.vvv(<256 x double> %1, <256 x double> %3)
  ...
  %add.ptr3 = getelementptr inbounds i32, i32* %pvz.addr.021, i64 256
...
declare <256 x double> @llvm.ve.vslaw.vvv(<256 x double>, <256 x double>) #3
