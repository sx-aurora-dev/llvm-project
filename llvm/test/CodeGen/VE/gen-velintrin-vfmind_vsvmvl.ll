...
define void @vfmind_vsvmvl(double*, double, double*, i32*, double*, i32) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vfmind.vsvmvl(double, <256 x double>, <4 x i64>, <256 x double>, i32)
