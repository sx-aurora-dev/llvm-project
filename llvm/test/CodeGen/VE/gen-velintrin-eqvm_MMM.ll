...
; ModuleID = 'gen/tests/eqvm_MMM.c'
source_filename = "gen/tests/eqvm_MMM.c"
...
define dso_local void @eqvm_MMM(i64* nocapture %0, i64* nocapture readonly %1, i64* nocapture readonly %2, i32 signext %3) local_unnamed_addr #0 {
; CHECK: eqvm %vm2,%vm2,%vm4
; CHECK: eqvm %vm3,%vm3,%vm5
...
declare <8 x i64> @llvm.ve.vl.lvm.MMss(<8 x i64>, i64, i64) #1

; Function Attrs: nounwind readnone
declare <8 x i64> @llvm.ve.vl.eqvm.MMM(<8 x i64>, <8 x i64>) #1

; Function Attrs: nounwind readnone
declare i64 @llvm.ve.vl.svm.sMs(<8 x i64>, i64) #1
