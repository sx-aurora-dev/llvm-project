...
; ModuleID = 'gen/tests/pvsubs_vsv.c'
source_filename = "gen/tests/pvsubs_vsv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvsubs_vsv(i32* %pvx, i64 %sy, i32* %pvz, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: pvsubs_vsv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %3 = tail call <256 x double> @llvm.ve.pvsubs.vsv(i64 %sy, <256 x double> %2)
...
declare <256 x double> @llvm.ve.pvsubs.vsv(i64, <256 x double>) #3
