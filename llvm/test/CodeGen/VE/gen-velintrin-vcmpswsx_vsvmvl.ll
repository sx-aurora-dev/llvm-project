...
define dso_local void @vcmpswsx_vsvmvl(i32*, i32, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
...
9:                                                ; preds = %6, %9
  ...
  %26 = tail call <256 x double> @llvm.ve.vl.vcmpswsx.vsvmvl(i32 %1, <256 x double> %19, <4 x i64> %22, <256 x double> %24, i32 %17)
