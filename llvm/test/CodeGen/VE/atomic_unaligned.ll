...
; CHECK-NEXT:    sla.w.sx %s6, %s2, %s4
; CHECK-NEXT:    xor %s6, -1, %s6
; CHECK-NEXT:    and %s6, %s5, %s6
; CHECK-NEXT:    sla.w.sx %s4, %s3, %s4
; CHECK-NEXT:    or %s4, %s6, %s4
; CHECK-NEXT:    cas.w %s4, (%s1), %s5
; CHECK-NEXT:    brne.w %s4, %s5, .LBB20_1
...
; CHECK-NEXT:    or %s4, %s6, %s4
; CHECK-NEXT:    cas.w %s4, (%s1), %s5
; CHECK-NEXT:    brne.w %s4, %s5, .LBB21_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    and %s1, %s4, (32)0
; CHECK-NEXT:    adds.w.sx %s0, %s0, (0)1
; CHECK-NEXT:    and %s0, 3, %s0
...
; CHECK:       .LBB{{[0-9]+}}_5:
; CHECK-NEXT:    fencem 3
; CHECK-NEXT:    and %s2, %s1, (56)0
; CHECK-NEXT:    lea %s1, c@lo
; CHECK-NEXT:    and %s1, %s1, (32)0
; CHECK-NEXT:    lea.sl %s1, c@hi(%s1)
; CHECK-NEXT:    adds.w.sx %s3, %s1, (0)1
; CHECK-NEXT:    and %s3, 3, %s3
; CHECK-NEXT:    sla.w.sx %s6, %s3, 3
; CHECK-NEXT:    sla.w.sx %s2, %s2, %s6
; CHECK-NEXT:    and %s0, %s0, (56)0
; CHECK-NEXT:    sla.w.sx %s3, %s0, %s6
; CHECK-NEXT:    and %s4, -4, %s1
; CHECK-NEXT:    ldl.sx %s0, (,%s4)
; CHECK-NEXT:    lea %s5, 255
; CHECK-NEXT:    sla.w.sx %s6, %s5, %s6
; CHECK-NEXT:    xor %s6, -1, %s6
; CHECK-NEXT:    and %s35, %s0, %s6
; CHECK-NEXT:    or %s0, 0, (0)1
; CHECK:       .LBB{{[0-9]+}}_1:
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    or %s6, %s35, %s2
; CHECK-NEXT:    or %s7, %s35, %s3
; CHECK-NEXT:    cas.w %s6, (%s4), %s7
; CHECK-NEXT:    breq.w %s6, %s7, .LBB28_3
; CHECK-NEXT:  # %bb.2: # %partword.cmpxchg.failure
; CHECK-NEXT:    # in Loop: Header=BB28_1 Depth=1
; CHECK-NEXT:    or %s34, 0, %s35
; CHECK-NEXT:    adds.w.sx %s35, %s1, (0)1
; CHECK-NEXT:    and %s35, 3, %s35
; CHECK-NEXT:    sla.w.sx %s35, %s35, 3
; CHECK-NEXT:    sla.w.sx %s35, %s5, %s35
; CHECK-NEXT:    xor %s35, -1, %s35
; CHECK-NEXT:    and %s35, %s6, %s35
; CHECK-NEXT:    brne.w %s34, %s35, .LBB28_1
; CHECK:       .LBB{{[0-9]+}}_3:
; CHECK-NEXT:    fencem 3
; CHECK-NEXT:    cmps.w.sx %s1, %s6, %s7
...
; CHECK-NEXT:    or %s7, %s35, %s3
; CHECK-NEXT:    cas.w %s6, (%s4), %s7
; CHECK-NEXT:    breq.w %s6, %s7, .LBB29_3
; CHECK-NEXT:  # %bb.2: # %partword.cmpxchg.failure
; CHECK-NEXT:    # in Loop: Header=BB29_1 Depth=1
; CHECK-NEXT:    or %s34, 0, %s35
; CHECK-NEXT:    adds.w.sx %s35, %s1, (0)1
; CHECK-NEXT:    and %s35, 3, %s35
; CHECK-NEXT:    sla.w.sx %s35, %s35, 3
...
; CHECK-NEXT:    xor %s35, -1, %s35
; CHECK-NEXT:    and %s35, %s6, %s35
; CHECK-NEXT:    brne.w %s34, %s35, .LBB29_1
; CHECK:       .LBB{{[0-9]+}}_3:
; CHECK-NEXT:    fencem 3
; CHECK-NEXT:    cmps.w.sx %s1, %s6, %s7
; CHECK-NEXT:    cmov.w.eq %s0, (63)0, %s1
...
; CHECK-NEXT:    sla.w.sx %s4, %s4, 3
; CHECK-NEXT:    sla.w.sx %s6, %s2, %s4
; CHECK-NEXT:    adds.w.sx %s6, %s5, %s6
; CHECK-NEXT:    sla.w.sx %s4, %s3, %s4
; CHECK-NEXT:    and %s6, %s6, %s4
; CHECK-NEXT:    xor %s4, -1, %s4
; CHECK-NEXT:    and %s4, %s5, %s4
; CHECK-NEXT:    or %s4, %s4, %s6
; CHECK-NEXT:    cas.w %s4, (%s1), %s5
; CHECK-NEXT:    brne.w %s4, %s5, .LBB53_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    and %s1, %s4, (32)0
; CHECK-NEXT:    adds.w.sx %s0, %s0, (0)1
; CHECK-NEXT:    and %s0, 3, %s0
...
; CHECK-NEXT:    or %s4, %s4, %s6
; CHECK-NEXT:    cas.w %s4, (%s1), %s5
; CHECK-NEXT:    brne.w %s4, %s5, .LBB54_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    and %s1, %s4, (32)0
; CHECK-NEXT:    adds.w.sx %s0, %s0, (0)1
; CHECK-NEXT:    and %s0, 3, %s0
...
; CHECK-NEXT:    brne.w %s0, %s2, .LBB55_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    fencem 3
; CHECK-NEXT:    or %s11, 0, %s9
entry:
...
; CHECK-NEXT:    brne.l %s0, %s2, .LBB56_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    fencem 3
; CHECK-NEXT:    or %s11, 0, %s9
entry:
...
; CHECK-NEXT:    or %s4, %s4, %s6
; CHECK-NEXT:    cas.w %s4, (%s1), %s5
; CHECK-NEXT:    brne.w %s4, %s5, .LBB58_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    and %s1, %s4, (32)0
; CHECK-NEXT:    adds.w.sx %s0, %s0, (0)1
; CHECK-NEXT:    and %s0, 3, %s0
...
; CHECK-NEXT:    or %s4, %s4, %s6
; CHECK-NEXT:    cas.w %s4, (%s1), %s5
; CHECK-NEXT:    brne.w %s4, %s5, .LBB59_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    and %s1, %s4, (32)0
; CHECK-NEXT:    adds.w.sx %s0, %s0, (0)1
; CHECK-NEXT:    and %s0, 3, %s0
...
; CHECK-NEXT:    lea %s0, -1(%s0)
; CHECK-NEXT:    cas.w %s0, (%s1), %s2
; CHECK-NEXT:    brne.w %s0, %s2, .LBB60_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    fencem 3
; CHECK-NEXT:    or %s11, 0, %s9
entry:
...
; CHECK-NEXT:    lea %s0, -1(%s0)
; CHECK-NEXT:    cas.l %s0, (%s1), %s2
; CHECK-NEXT:    brne.l %s0, %s2, .LBB61_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    fencem 3
; CHECK-NEXT:    or %s11, 0, %s9
entry:
...
; CHECK-NEXT:    and %s4, %s5, %s4
; CHECK-NEXT:    cas.w %s4, (%s1), %s5
; CHECK-NEXT:    brne.w %s4, %s5, .LBB63_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    and %s1, %s4, (32)0
; CHECK-NEXT:    adds.w.sx %s0, %s0, (0)1
; CHECK-NEXT:    and %s0, 3, %s0
...
; CHECK-NEXT:    and %s4, %s5, %s4
; CHECK-NEXT:    cas.w %s4, (%s1), %s5
; CHECK-NEXT:    brne.w %s4, %s5, .LBB64_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    and %s1, %s4, (32)0
; CHECK-NEXT:    adds.w.sx %s0, %s0, (0)1
; CHECK-NEXT:    and %s0, 3, %s0
...
; CHECK-NEXT:    cas.w %s0, (%s1), %s2
; CHECK-NEXT:    brne.w %s0, %s2, .LBB65_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    fencem 3
; CHECK-NEXT:    or %s11, 0, %s9
entry:
...
; CHECK-NEXT:    and %s0, 1, %s0
; CHECK-NEXT:    cas.l %s0, (%s1), %s2
; CHECK-NEXT:    brne.l %s0, %s2, .LBB66_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    fencem 3
; CHECK-NEXT:    or %s11, 0, %s9
entry:
...
; CHECK-NEXT:    and %s3, 3, %s3
; CHECK-NEXT:    sla.w.sx %s3, %s3, 3
; CHECK-NEXT:    sla.w.sx %s3, %s2, %s3
; CHECK-NEXT:    or %s3, %s4, %s3
; CHECK-NEXT:    cas.w %s3, (%s1), %s4
; CHECK-NEXT:    brne.w %s3, %s4, .LBB68_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
...
; CHECK-NEXT:    or %s3, %s4, %s3
; CHECK-NEXT:    cas.w %s3, (%s1), %s4
; CHECK-NEXT:    brne.w %s3, %s4, .LBB69_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    and %s1, %s3, (32)0
; CHECK-NEXT:    adds.w.sx %s0, %s0, (0)1
; CHECK-NEXT:    and %s0, 3, %s0
...
; CHECK-NEXT:    cas.w %s0, (%s1), %s2
; CHECK-NEXT:    brne.w %s0, %s2, .LBB70_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    fencem 3
; CHECK-NEXT:    or %s11, 0, %s9
entry:
...
; CHECK-NEXT:    or %s0, 1, %s0
; CHECK-NEXT:    cas.l %s0, (%s1), %s2
; CHECK-NEXT:    brne.l %s0, %s2, .LBB71_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    fencem 3
; CHECK-NEXT:    or %s11, 0, %s9
entry:
...
; CHECK-NEXT:    sla.w.sx %s3, %s3, 3
; CHECK-NEXT:    sla.w.sx %s3, %s2, %s3
; CHECK-NEXT:    xor %s3, %s4, %s3
; CHECK-NEXT:    cas.w %s3, (%s1), %s4
; CHECK-NEXT:    brne.w %s3, %s4, .LBB73_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    and %s1, %s3, (32)0
; CHECK-NEXT:    adds.w.sx %s0, %s0, (0)1
; CHECK-NEXT:    and %s0, 3, %s0
...
; CHECK-NEXT:    xor %s3, %s4, %s3
; CHECK-NEXT:    cas.w %s3, (%s1), %s4
; CHECK-NEXT:    brne.w %s3, %s4, .LBB74_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    and %s1, %s3, (32)0
; CHECK-NEXT:    adds.w.sx %s0, %s0, (0)1
; CHECK-NEXT:    and %s0, 3, %s0
...
; CHECK-NEXT:    cas.w %s0, (%s1), %s2
; CHECK-NEXT:    brne.w %s0, %s2, .LBB75_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    fencem 3
; CHECK-NEXT:    or %s11, 0, %s9
entry:
...
; CHECK-NEXT:    xor %s0, 1, %s0
; CHECK-NEXT:    cas.l %s0, (%s1), %s2
; CHECK-NEXT:    brne.l %s0, %s2, .LBB76_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    fencem 3
; CHECK-NEXT:    or %s11, 0, %s9
entry:
...
; CHECK-NEXT:    or %s4, %s4, %s6
; CHECK-NEXT:    cas.w %s4, (%s1), %s5
; CHECK-NEXT:    brne.w %s4, %s5, .LBB78_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    and %s1, %s4, (32)0
; CHECK-NEXT:    adds.w.sx %s0, %s0, (0)1
; CHECK-NEXT:    and %s0, 3, %s0
...
; CHECK-NEXT:    or %s4, %s4, %s6
; CHECK-NEXT:    cas.w %s4, (%s1), %s5
; CHECK-NEXT:    brne.w %s4, %s5, .LBB79_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    and %s1, %s4, (32)0
; CHECK-NEXT:    adds.w.sx %s0, %s0, (0)1
; CHECK-NEXT:    and %s0, 3, %s0
...
; CHECK-NEXT:    cas.w %s0, (%s1), %s2
; CHECK-NEXT:    brne.w %s0, %s2, .LBB80_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    fencem 3
; CHECK-NEXT:    or %s11, 0, %s9
entry:
...
; CHECK-NEXT:    or %s0, -2, %s0
; CHECK-NEXT:    cas.l %s0, (%s1), %s2
; CHECK-NEXT:    brne.l %s0, %s2, .LBB81_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    fencem 3
; CHECK-NEXT:    or %s11, 0, %s9
entry:
...
; CHECK-NEXT:    brne.w %s0, %s3, .LBB83_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    fencem 3
; CHECK-NEXT:    or %s11, 0, %s9
entry:
...
; CHECK-NEXT:    brne.w %s0, %s4, .LBB84_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    fencem 3
; CHECK-NEXT:    # kill: def $sw0 killed $sw0 killed $sx0
; CHECK-NEXT:    or %s11, 0, %s9
...
; CHECK-NEXT:    cas.w %s0, (%s1), %s3
; CHECK-NEXT:    brne.w %s0, %s3, .LBB85_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    fencem 3
; CHECK-NEXT:    # kill: def $sw0 killed $sw0 killed $sx0
; CHECK-NEXT:    or %s11, 0, %s9
...
; CHECK-NEXT:    cmov.w.lt %s0, %s4, %s5
; CHECK-NEXT:    cas.w %s0, (%s1), %s4
; CHECK-NEXT:    brne.w %s0, %s4, .LBB86_1
; CHECK-NEXT:  # %bb.2: # %atomicrmw.end
; CHECK-NEXT:    fencem 3
; CHECK-NEXT:    # kill: def $sw0 killed $sw0 killed $sx0
; CHECK-NEXT:    or %s11, 0, %s9
