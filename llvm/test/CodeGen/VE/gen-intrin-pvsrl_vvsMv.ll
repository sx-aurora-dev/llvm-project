...
; ModuleID = 'gen/tests/pvsrl_vvsMv.c'
source_filename = "gen/tests/pvsrl_vvsMv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvsrl_vvsMv(i32* %pvx, i32* %pvz, i64 %sy, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: pvsrl_vvsMv
; CHECK: .LBB0_2
; CHECK: 	pvsrl %v2,%v0,%s2,%vm2
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %8 = tail call <256 x double> @llvm.ve.pvsrl.vvsMv(<256 x double> %2, i64 %sy, <8 x i64> %5, <256 x double> %7)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.pvsrl.vvsMv(<256 x double>, i64, <8 x i64>, <256 x double>) #3
