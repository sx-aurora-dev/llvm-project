...
define void @pvsrl_vvsMv(i32* %pvx, i32* %pvz, i64 %sy, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.pvsrl.vvsMv(<256 x double>, i64, <8 x i64>, <256 x double>)
