...
; ModuleID = 'gen/tests/negm_mml.c'
source_filename = "gen/tests/negm_mml.c"
...
define dso_local void @negm_mml(i64* nocapture, i64* nocapture readonly, i64* nocapture readnone, i32) local_unnamed_addr #0 {
; CHECK: negm %vm1,%vm1
...
; Function Attrs: nounwind readnone
declare <4 x i64> @llvm.ve.vl.negm.mml(<4 x i64>, i32) #1
