...
; ModuleID = 'gen/tests/vsrl_vvImv.c'
source_filename = "gen/tests/vsrl_vvImv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vsrl_vvImv(i64* %pvx, i64* %pvz, i32* %pvm, i64* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vsrl_vvImv
; CHECK: .LBB0_2
; CHECK: 	vsrl %v2,%v0,3,%vm1
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %7 = tail call <256 x double> @llvm.ve.vsrl.vvsmv(<256 x double> %1, i64 3, <4 x i64> %4, <256 x double> %6)
