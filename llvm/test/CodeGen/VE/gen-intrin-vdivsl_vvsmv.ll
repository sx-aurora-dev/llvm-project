...
define void @vdivsl_vvsmv(i64* %pvx, i64* %pvy, i64 %sy, i32* %pvm, i64* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vdivsl.vvsmv(<256 x double>, i64, <4 x i64>, <256 x double>)
