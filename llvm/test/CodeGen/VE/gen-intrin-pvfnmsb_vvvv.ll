...
; ModuleID = 'gen/tests/pvfnmsb_vvvv.c'
source_filename = "gen/tests/pvfnmsb_vvvv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvfnmsb_vvvv(float* %pvx, float* %pvy, float* %pvz, float* %pvw, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: pvfnmsb_vvvv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %7 = tail call <256 x double> @llvm.ve.pvfnmsb.vvvv(<256 x double> %2, <256 x double> %4, <256 x double> %6)
...
declare <256 x double> @llvm.ve.pvfnmsb.vvvv(<256 x double>, <256 x double>, <256 x double>) #3
