...
define void @pvfmax_vsvMv(float* %pvx, i64 %sy, float* %pvz, i32* %pvm, float* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.pvfmax.vsvMv(i64, <256 x double>, <8 x i64>, <256 x double>)
