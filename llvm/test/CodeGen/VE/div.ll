...
define i128 @divi128(i128 %a, i128 %b) {
; CHECK-LABEL: divi128:
; CHECK:       .LBB{{[0-9]+}}_2:
...
define i128 @divu128(i128 %a, i128 %b) {
; CHECK-LABEL: divu128:
; CHECK:       .LBB{{[0-9]+}}_2:
