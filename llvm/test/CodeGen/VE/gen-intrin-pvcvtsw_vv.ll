...
; ModuleID = 'gen/tests/pvcvtsw_vv.c'
source_filename = "gen/tests/pvcvtsw_vv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvcvtsw_vv(float* %pvx, i32* %pvy, i32 %n) local_unnamed_addr #0 {
...
declare <256 x double> @llvm.ve.pvcvtsw.vv(<256 x double>) #3
