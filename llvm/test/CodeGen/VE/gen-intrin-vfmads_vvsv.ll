...
; ModuleID = 'gen/tests/vfmads_vvsv.c'
source_filename = "gen/tests/vfmads_vvsv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vfmads_vvsv(float* %pvx, float* %pvy, float %sy, float* %pvw, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vfmads_vvsv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %4 = tail call <256 x double> @llvm.ve.vfmads.vvsv(<256 x double> %1, float %sy, <256 x double> %3)
...
declare <256 x double> @llvm.ve.vfmads.vvsv(<256 x double>, float, <256 x double>) #3
