...
; ModuleID = 'gen/tests/pvfmsb_vsvv.c'
source_filename = "gen/tests/pvfmsb_vsvv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvfmsb_vsvv(float* %pvx, i64 %sy, float* %pvz, float* %pvw, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: pvfmsb_vsvv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %5 = tail call <256 x double> @llvm.ve.pvfmsb.vsvv(i64 %sy, <256 x double> %2, <256 x double> %4)
...
declare <256 x double> @llvm.ve.pvfmsb.vsvv(i64, <256 x double>, <256 x double>) #3
