...
define void @vfmads_vvsvmvl(float*, float*, float, float*, i32*, float*, i32) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vfmads.vvsvmvl(<256 x double>, float, <256 x double>, <4 x i64>, <256 x double>, i32)
