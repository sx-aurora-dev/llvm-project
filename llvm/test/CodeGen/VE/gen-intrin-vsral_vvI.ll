...
; ModuleID = 'gen/tests/vsral_vvI.c'
source_filename = "gen/tests/vsral_vvI.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vsral_vvI(i64* %pvx, i64* %pvz, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vsral_vvI
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %2 = tail call <256 x double> @llvm.ve.vsral.vvs(<256 x double> %1, i64 3)
