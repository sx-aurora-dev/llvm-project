...
; ModuleID = 'gen/tests/vfdivs_vsv.c'
source_filename = "gen/tests/vfdivs_vsv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vfdivs_vsv(float* %pvx, float %sy, float* %pvz, i32 %n) local_unnamed_addr #0 {
...
declare <256 x double> @llvm.ve.vfdivs.vsv(float, <256 x double>) #3
