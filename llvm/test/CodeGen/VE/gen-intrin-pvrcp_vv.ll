...
; ModuleID = 'gen/tests/pvrcp_vv.c'
source_filename = "gen/tests/pvrcp_vv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvrcp_vv(float* %pvx, float* %pvy, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: pvrcp_vv
; CHECK: .LBB0_2
; CHECK: 	pvrcp %v0,%v0
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %pvy.addr.018 = phi float* [ %add.ptr4, %for.body ], [ %pvy, %entry ]
  ...
  %1 = bitcast float* %pvy.addr.018 to i8*
  %2 = tail call <256 x double> @llvm.ve.vld.vss(i64 8, i8* %1)
  %3 = tail call <256 x double> @llvm.ve.pvrcp.vv(<256 x double> %2)
  ...
  %add.ptr4 = getelementptr inbounds float, float* %pvy.addr.018, i64 512
...
declare <256 x double> @llvm.ve.pvrcp.vv(<256 x double>) #3
