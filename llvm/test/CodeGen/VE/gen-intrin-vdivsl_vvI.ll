...
; ModuleID = 'gen/tests/vdivsl_vvI.c'
source_filename = "gen/tests/vdivsl_vvI.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vdivsl_vvI(i64* %pvx, i64* %pvy, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vdivsl_vvI
; CHECK: .LBB0_2
; CHECK: 	vdivs.l %v0,%v0,3
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %2 = tail call <256 x double> @llvm.ve.vdivsl.vvs(<256 x double> %1, i64 3)
