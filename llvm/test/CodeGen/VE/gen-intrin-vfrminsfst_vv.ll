...
; ModuleID = 'gen/tests/vfrminsfst_vv.c'
source_filename = "gen/tests/vfrminsfst_vv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vfrminsfst_vv(float* %pvx, float* %pvy, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vfrminsfst_vv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %pvy.addr.017 = phi float* [ %add.ptr3, %for.body ], [ %pvy, %entry ]
  ...
  %0 = bitcast float* %pvy.addr.017 to i8*
  %1 = tail call <256 x double> @llvm.ve.vldu.vss(i64 4, i8* %0)
  %2 = tail call <256 x double> @llvm.ve.vfrminsfst.vv(<256 x double> %1)
  ...
  %add.ptr3 = getelementptr inbounds float, float* %pvy.addr.017, i64 256
...
declare <256 x double> @llvm.ve.vfrminsfst.vv(<256 x double>) #3
