...
; ModuleID = 'gen/tests/vdivswsx_vvImvl.c'
source_filename = "gen/tests/vdivswsx_vvImvl.c"
...
define dso_local void @vdivswsx_vvImvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
