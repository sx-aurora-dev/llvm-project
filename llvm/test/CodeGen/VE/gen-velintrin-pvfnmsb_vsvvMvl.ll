...
10:                                               ; preds = %7, %10
  ...
  %31 = tail call <256 x double> @llvm.ve.vl.pvfnmsb.vsvvMvl(i64 %1, <256 x double> %22, <256 x double> %24, <8 x i64> %27, <256 x double> %29, i32 %20)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.pvfnmsb.vsvvMvl(i64, <256 x double>, <256 x double>, <8 x i64>, <256 x double>, i32) #2
