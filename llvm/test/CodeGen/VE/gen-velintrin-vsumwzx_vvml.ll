...
7:                                                ; preds = %4, %7
  ...
  %21 = tail call <256 x double> @llvm.ve.vl.vsumwzx.vvml(<256 x double> %16, <4 x i64> %19, i32 %14)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vsumwzx.vvml(<256 x double>, <4 x i64>, i32) #2
