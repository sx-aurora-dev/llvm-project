...
; ModuleID = 'gen/tests/vfrmaxdfst_vv.c'
source_filename = "gen/tests/vfrmaxdfst_vv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vfrmaxdfst_vv(double* %pvx, double* %pvy, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vfrmaxdfst_vv
; CHECK: .LBB0_2
; CHECK: 	vfrmax.d.fst %v0,%v0
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %pvy.addr.017 = phi double* [ %add.ptr3, %for.body ], [ %pvy, %entry ]
  ...
  %0 = bitcast double* %pvy.addr.017 to i8*
  %1 = tail call <256 x double> @llvm.ve.vld.vss(i64 8, i8* %0)
  %2 = tail call <256 x double> @llvm.ve.vfrmaxdfst.vv(<256 x double> %1)
  ...
  %add.ptr3 = getelementptr inbounds double, double* %pvy.addr.017, i64 256
...
declare <256 x double> @llvm.ve.vfrmaxdfst.vv(<256 x double>) #3
