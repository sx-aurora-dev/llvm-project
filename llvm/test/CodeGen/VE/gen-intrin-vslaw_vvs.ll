...
; ModuleID = 'gen/tests/vslaw_vvs.c'
source_filename = "gen/tests/vslaw_vvs.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vslaw_vvs(i32* %pvx, i32* %pvz, i64 %sy, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vslaw_vvs
; CHECK: .LBB0_2
; CHECK: 	vsla.w %v0,%v0,%s2
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %2 = tail call <256 x double> @llvm.ve.vslaw.vvs(<256 x double> %1, i64 %sy)
...
declare <256 x double> @llvm.ve.vslaw.vvs(<256 x double>, i64) #3
