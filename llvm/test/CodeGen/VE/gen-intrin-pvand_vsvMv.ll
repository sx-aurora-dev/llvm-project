...
; ModuleID = 'gen/tests/pvand_vsvMv.c'
source_filename = "gen/tests/pvand_vsvMv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvand_vsvMv(i32* %pvx, i64 %sy, i32* %pvz, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: pvand_vsvMv
; CHECK: .LBB0_2
; CHECK: 	pvand %v2,%s1,%v0,%vm2
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %8 = tail call <256 x double> @llvm.ve.pvand.vsvMv(i64 %sy, <256 x double> %2, <8 x i64> %5, <256 x double> %7)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.pvand.vsvMv(i64, <256 x double>, <8 x i64>, <256 x double>) #3
