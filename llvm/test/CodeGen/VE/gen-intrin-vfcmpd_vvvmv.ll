...
define void @vfcmpd_vvvmv(double* %pvx, double* %pvy, double* %pvz, i32* %pvm, double* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vfcmpd.vvvmv(<256 x double>, <256 x double>, <4 x i64>, <256 x double>)
