...
; ModuleID = 'gen/tests/vdivswsx_vIvmvl.c'
source_filename = "gen/tests/vdivswsx_vIvmvl.c"
...
define dso_local void @vdivswsx_vIvmvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
