...
define void @vslaw_vvsmv(i32* %pvx, i32* %pvz, i64 %sy, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vslaw.vvsmv(<256 x double>, i64, <4 x i64>, <256 x double>)
