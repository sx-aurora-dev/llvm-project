...
define void @vcmpswsx_vIvmv(i32* %pvx, i32* %pvz, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vcmpswsx.vsvmv(i32, <256 x double>, <4 x i64>, <256 x double>)
