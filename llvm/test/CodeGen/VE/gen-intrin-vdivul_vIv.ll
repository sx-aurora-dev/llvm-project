...
; ModuleID = 'gen/tests/vdivul_vIv.c'
source_filename = "gen/tests/vdivul_vIv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vdivul_vIv(i64* %pvx, i64* %pvz, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vdivul_vIv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %2 = tail call <256 x double> @llvm.ve.vdivul.vsv(i64 3, <256 x double> %1)
...
declare <256 x double> @llvm.ve.vdivul.vsv(i64, <256 x double>) #3
