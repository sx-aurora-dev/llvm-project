...
; ModuleID = 'gen/tests/vmuluw_vsv.c'
source_filename = "gen/tests/vmuluw_vsv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vmuluw_vsv(i32* %pvx, i32 %sy, i32* %pvz, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vmuluw_vsv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %2 = tail call <256 x double> @llvm.ve.vmuluw.vsv(i32 %sy, <256 x double> %1)
...
declare <256 x double> @llvm.ve.vmuluw.vsv(i32, <256 x double>) #3
