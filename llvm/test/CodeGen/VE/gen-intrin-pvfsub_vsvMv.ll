...
; ModuleID = 'gen/tests/pvfsub_vsvMv.c'
source_filename = "gen/tests/pvfsub_vsvMv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvfsub_vsvMv(float* %pvx, i64 %sy, float* %pvz, i32* %pvm, float* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: pvfsub_vsvMv
; CHECK: .LBB0_2
; CHECK: 	pvfsub %v2,%s1,%v0,%vm2
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %8 = tail call <256 x double> @llvm.ve.pvfsub.vsvMv(i64 %sy, <256 x double> %2, <8 x i64> %5, <256 x double> %7)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.pvfsub.vsvMv(i64, <256 x double>, <8 x i64>, <256 x double>) #3
