...
define void @vfnmsbs_vvvvmvl(float*, float*, float*, float*, i32*, float*, i32) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vfnmsbs.vvvvmvl(<256 x double>, <256 x double>, <256 x double>, <4 x i64>, <256 x double>, i32)
