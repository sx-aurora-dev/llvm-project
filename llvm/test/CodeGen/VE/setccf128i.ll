...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:    lea %s2, .LCPI2_0@lo
; CHECK-NEXT:    and %s2, %s2, (32)0
; CHECK-NEXT:    lea.sl %s2, .LCPI2_0@hi(%s2)
...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:    lea %s2, .LCPI3_0@lo
; CHECK-NEXT:    and %s2, %s2, (32)0
; CHECK-NEXT:    lea.sl %s2, .LCPI3_0@hi(%s2)
; CHECK-NEXT:    ld %s4, 8(,%s2)
; CHECK-NEXT:    ld %s5, (,%s2)
; CHECK-NEXT:    fcmp.q %s1, %s0, %s4
; CHECK-NEXT:    or %s0, 0, (0)1
...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:    lea %s2, .LCPI4_0@lo
; CHECK-NEXT:    and %s2, %s2, (32)0
; CHECK-NEXT:    lea.sl %s2, .LCPI4_0@hi(%s2)
; CHECK-NEXT:    ld %s4, 8(,%s2)
; CHECK-NEXT:    ld %s5, (,%s2)
; CHECK-NEXT:    fcmp.q %s1, %s0, %s4
; CHECK-NEXT:    or %s0, 0, (0)1
...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:    lea %s2, .LCPI6_0@lo
; CHECK-NEXT:    and %s2, %s2, (32)0
; CHECK-NEXT:    lea.sl %s2, .LCPI6_0@hi(%s2)
; CHECK-NEXT:    ld %s4, 8(,%s2)
; CHECK-NEXT:    ld %s5, (,%s2)
; CHECK-NEXT:    fcmp.q %s1, %s0, %s4
; CHECK-NEXT:    or %s0, 0, (0)1
...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:    lea %s2, .LCPI7_0@lo
; CHECK-NEXT:    and %s2, %s2, (32)0
; CHECK-NEXT:    lea.sl %s2, .LCPI7_0@hi(%s2)
; CHECK-NEXT:    ld %s4, 8(,%s2)
; CHECK-NEXT:    ld %s5, (,%s2)
; CHECK-NEXT:    fcmp.q %s1, %s0, %s4
; CHECK-NEXT:    or %s0, 0, (0)1
...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:    lea %s2, .LCPI11_0@lo
; CHECK-NEXT:    and %s2, %s2, (32)0
; CHECK-NEXT:    lea.sl %s2, .LCPI11_0@hi(%s2)
; CHECK-NEXT:    ld %s4, 8(,%s2)
; CHECK-NEXT:    ld %s5, (,%s2)
; CHECK-NEXT:    fcmp.q %s1, %s0, %s4
; CHECK-NEXT:    or %s0, 0, (0)1
...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:    lea %s2, .LCPI13_0@lo
; CHECK-NEXT:    and %s2, %s2, (32)0
; CHECK-NEXT:    lea.sl %s2, .LCPI13_0@hi(%s2)
; CHECK-NEXT:    ld %s4, 8(,%s2)
; CHECK-NEXT:    ld %s5, (,%s2)
; CHECK-NEXT:    fcmp.q %s1, %s0, %s4
; CHECK-NEXT:    or %s0, 0, (0)1
...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:    lea %s2, .LCPI14_0@lo
; CHECK-NEXT:    and %s2, %s2, (32)0
; CHECK-NEXT:    lea.sl %s2, .LCPI14_0@hi(%s2)
; CHECK-NEXT:    ld %s4, 8(,%s2)
; CHECK-NEXT:    ld %s5, (,%s2)
; CHECK-NEXT:    fcmp.q %s1, %s0, %s4
; CHECK-NEXT:    or %s0, 0, (0)1
...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:    lea %s2, .LCPI15_0@lo
; CHECK-NEXT:    and %s2, %s2, (32)0
; CHECK-NEXT:    lea.sl %s2, .LCPI15_0@hi(%s2)
; CHECK-NEXT:    ld %s4, 8(,%s2)
; CHECK-NEXT:    ld %s5, (,%s2)
; CHECK-NEXT:    fcmp.q %s1, %s0, %s4
; CHECK-NEXT:    or %s0, 0, (0)1
