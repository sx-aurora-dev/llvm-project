...
define void @vfmaxs_vsvmv(float* %pvx, float %sy, float* %pvz, i32* %pvm, float* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vfmaxs.vsvmv(float, <256 x double>, <4 x i64>, <256 x double>)
