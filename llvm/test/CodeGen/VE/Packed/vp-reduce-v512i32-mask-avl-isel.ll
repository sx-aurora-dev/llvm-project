...
; CHECK-NEXT:    lea %s1, .LCPI12_0@lo
; CHECK-NEXT:    and %s1, %s1, (32)0
; CHECK-NEXT:    lea.sl %s1, .LCPI12_0@hi(, %s1)
...
; CHECK-NEXT:    # kill: def $sw1 killed $sw1 killed $sx1
; CHECK-NEXT:    adds.w.zx %s3, %s1, (0)1
; CHECK-NEXT:    # implicit-def: $sx1
...
; CHECK-NEXT:    lvs %s3, %v1(%s3)
; CHECK-NEXT:    srl %s4, %s3, 32
; CHECK-NEXT:    # kill: def $sw4 killed $sw4 killed $sx4
; CHECK-NEXT:    # implicit-def: $sx5
...
; CHECK-NEXT:    adds.w.zx %s5, %s3, (0)1
; CHECK-NEXT:    # implicit-def: $sx3
...
; CHECK-NEXT:    lvl %s0
; CHECK-NEXT:    vbrd %v2, %s1
; CHECK-NEXT:    lea %s1, .LCPI16_0@lo
; CHECK-NEXT:    and %s1, %s1, (32)0
; CHECK-NEXT:    lea.sl %s1, .LCPI16_0@hi(, %s1)
...
; CHECK-NEXT:    lvl %s0
; CHECK-NEXT:    vbrd %v2, %s1
; CHECK-NEXT:    lea %s1, .LCPI18_0@lo
; CHECK-NEXT:    and %s1, %s1, (32)0
; CHECK-NEXT:    lea.sl %s1, .LCPI18_0@hi(, %s1)
; CHECK-NEXT:    vld %v1, 8, %s1
; CHECK-NEXT:    vcmpu.l %v1, %v1, %v2
; CHECK-NEXT:    vfmk.l.lt %vm1, %v1
; CHECK-NEXT:    # implicit-def: $vmp2
...
; CHECK-NEXT:    lvl %s0
; CHECK-NEXT:    vbrd %v2, %s1
; CHECK-NEXT:    lea %s1, .LCPI19_0@lo
; CHECK-NEXT:    and %s1, %s1, (32)0
; CHECK-NEXT:    lea.sl %s1, .LCPI19_0@hi(, %s1)
; CHECK-NEXT:    vld %v1, 8, %s1
; CHECK-NEXT:    vcmpu.l %v1, %v1, %v2
; CHECK-NEXT:    vfmk.l.lt %vm1, %v1
; CHECK-NEXT:    # implicit-def: $vmp2
