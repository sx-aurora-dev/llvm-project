...
;; 256 elements
define <256 x i32> @vec_fptosi_v256f64_v256i64(<256 x double> %x) {
...
define <256 x i32> @vec_fptoui_v256f64_v256i64(<256 x double> %x) {
...
define <256 x i64> @vec_fptosi_v256f32_v256i32(<256 x float> %x) {
...
define <256 x i64> @vec_fptoui_v256f32_v256i32(<256 x float> %x) {
