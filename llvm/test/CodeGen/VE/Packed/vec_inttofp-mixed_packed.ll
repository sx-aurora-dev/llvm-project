...
;; 256 elements
define fastcc <256 x float> @vec_sitofp_v256f64_v256double(<256 x i64> %x) {
...
; CHECK-NEXT:    b.l.t (, %s10)
  %r = sitofp <256 x i64> %x to <256 x float>
  ret <256 x float> %r
}

define fastcc <256 x float> @vec_uitofp_v256f64_v256double(<256 x i64> %x) {
...
; CHECK-NEXT:    b.l.t (, %s10)
  %r = uitofp <256 x i64> %x to <256 x float>
  ret <256 x float> %r
}

define fastcc <256 x double> @vec_sitofp_v256f32_v256float(<256 x i32> %x) {
...
; CHECK-NEXT:    b.l.t (, %s10)
  %r = sitofp <256 x i32> %x to <256 x double>
  ret <256 x double> %r
}

define fastcc <256 x double> @vec_uitofp_v256f32_v256float(<256 x i32> %x) {
...
; CHECK-NEXT:    b.l.t (, %s10)
  %r = uitofp <256 x i32> %x to <256 x double>
  ret <256 x double> %r
}

;; 512 elements
define fastcc <512 x float> @vec_sitofp_v512f64_v512double(<512 x i64> %x) {
...
define fastcc <512 x float> @vec_uitofp_v512f64_v512double(<512 x i64> %x) {
...
; CHECK-NEXT:    and %s1, %s1, (32)0
; CHECK-NEXT:    lvl %s0
; CHECK-NEXT:    vand %v2, %s1, %v0
; CHECK-NEXT:    vcvt.d.l %v2, %v2
; CHECK-NEXT:    vcvt.s.d %v2, %v2
; CHECK-NEXT:    vand %v3, %s1, %v1
; CHECK-NEXT:    vcvt.d.l %v3, %v3
; CHECK-NEXT:    vcvt.s.d %v3, %v3
; CHECK-NEXT:    vshf %v2, %v3, %v2, 8
; CHECK-NEXT:    or %s1, 32, (0)1
; CHECK-NEXT:    vsrl %v0, %v0, %s1
; CHECK-NEXT:    vcvt.d.l %v0, %v0
; CHECK-NEXT:    vcvt.s.d %v0, %v0
; CHECK-NEXT:    vsrl %v1, %v1, %s1
; CHECK-NEXT:    vcvt.d.l %v1, %v1
; CHECK-NEXT:    vcvt.s.d %v1, %v1
; CHECK-NEXT:    vshf %v0, %v1, %v0, 8
; CHECK-NEXT:    lea.sl %s1, 1333788672
...
; CHECK-NEXT:    b.l.t (, %s10)
  %r = uitofp <512 x i64> %x to <512 x float>
  ret <512 x float> %r
}

define fastcc <512 x double> @vec_sitofp_v512f32_v512float(<512 x i32> %x) {
...
; CHECK-NEXT:    b.l.t (, %s10)
  %r = sitofp <512 x i32> %x to <512 x double>
  ret <512 x double> %r
}

define fastcc <512 x double> @vec_uitofp_v512f32_v512float(<512 x i32> %x) {
...
; CHECK-NEXT:    vor %v3, %s2, %v2
; CHECK-NEXT:    vshf %v0, %v0, %v0, 0
; CHECK-NEXT:    vadds.w.zx %v0, 0, %v0, %vm0
; CHECK-NEXT:    vsrl %v4, %v0, %s1
; CHECK-NEXT:    vor %v2, %s2, %v4
; CHECK-NEXT:    lea %s1, 1048576
; CHECK-NEXT:    lea.sl %s1, 1160773632(, %s1)
...
; CHECK-NEXT:    # kill: def $v0 killed $v0 def $vp0 killed $v1
; CHECK-NEXT:    b.l.t (, %s10)
  %r = uitofp <512 x i32> %x to <512 x double>
  ret <512 x double> %r
}
