...
define fastcc <512 x float> @vec_frsqrt_v512f32(<512 x float> %x, <512 x i1> %M, i32 %L) {
; CHECK-LABEL: vec_frsqrt_v512f32:
; CHECK:       # %bb.0:
...
; CHECK-NEXT:    b.l.t (, %s10)
  ...
  %r = call fast <512 x float> @llvm.vp.sqrt.v512f32(<512 x float> %x, <512 x i1> %M, i32 %L)
  %d = call fast <512 x float> @llvm.vp.fdiv.v512f32(<512 x float> %vone, <512 x float> %r, <512 x i1> %M, i32 %L)
  ret <512 x float> %d
}
