...
; CHECK-NEXT:    lea %s0, 256
; CHECK-NEXT:    lvl %s0
; CHECK-NEXT:    vmuls.l %v1, %v1, %v5
; CHECK-NEXT:    vmuls.l %v0, %v0, %v4
; CHECK-NEXT:    vmuls.l %v3, %v3, %v7
; CHECK-NEXT:    vmuls.l %v2, %v2, %v6
; CHECK-NEXT:    # kill: def $v0 killed $v0 def $vp0 killed $v1
; CHECK-NEXT:    # kill: def $v2 killed $v2 def $vp1 killed $v3
; CHECK-NEXT:    b.l.t (, %s10)
  %r = mul <1024 x i64> %a, %b
  ret <1024 x i64> %r
}
...
; CHECK-NEXT:    lea %s0, 256
; CHECK-NEXT:    lvl %s0
; CHECK-NEXT:    vmuls.w.sx %v4, %v0, %v2
