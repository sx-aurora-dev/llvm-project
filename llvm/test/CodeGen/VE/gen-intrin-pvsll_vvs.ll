...
; ModuleID = 'gen/tests/pvsll_vvs.c'
source_filename = "gen/tests/pvsll_vvs.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvsll_vvs(i32* %pvx, i32* %pvz, i64 %sy, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: pvsll_vvs
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %3 = tail call <256 x double> @llvm.ve.pvsll.vvs(<256 x double> %2, i64 %sy)
...
declare <256 x double> @llvm.ve.pvsll.vvs(<256 x double>, i64) #3
