...
9:                                                ; preds = %6, %9
  ...
  %26 = tail call <256 x double> @llvm.ve.vl.vmulswzx.vsvmvl(i32 %1, <256 x double> %19, <4 x i64> %22, <256 x double> %24, i32 %17)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vmulswzx.vsvmvl(i32, <256 x double>, <4 x i64>, <256 x double>, i32) #2
