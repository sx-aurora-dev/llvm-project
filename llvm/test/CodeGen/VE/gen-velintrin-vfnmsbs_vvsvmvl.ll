...
10:                                               ; preds = %7, %10
  ...
  %30 = tail call <256 x double> @llvm.ve.vl.vfnmsbs.vvsvmvl(<256 x double> %21, float %2, <256 x double> %23, <4 x i64> %26, <256 x double> %28, i32 %19)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vfnmsbs.vvsvmvl(<256 x double>, float, <256 x double>, <4 x i64>, <256 x double>, i32) #2
