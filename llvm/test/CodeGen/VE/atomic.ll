...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:  lea.sl %s34, c@hi
; CHECK-NEXT:  ld1b.zx %s34, c@lo(,%s34)
; CHECK-NEXT:  fencem 2
...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:  lea.sl %s34, s@hi
; CHECK-NEXT:  ld2b.zx %s34, s@lo(,%s34)
; CHECK-NEXT:  fencem 2
...
; CHECK-NEXT:  ts1am.w %s35, c@lo(%s34), 1
; CHECK-NEXT:  fencem 3
...
; CHECK-NEXT:  ts1am.w %s35, s@lo(%s34), 3
; CHECK-NEXT:  fencem 3
...
; CHECK-NEXT:  ts1am.w %s0, i@lo(%s34), 15
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  or %s11, 0, %s9
entry:
...
; CHECK-NEXT:  ts1am.l %s0, l@lo(%s34), 127
; CHECK-NEXT:  fencem 2
; CHECK-NEXT:  or %s11, 0, %s9
entry:
...
; CHECK-NEXT:  lea.sl %s35, c@hi(%s34)
; CHECK-NEXT:  and %s35, -4, %s35
; CHECK-NEXT:  ldl.sx %s36, (,%s35)
...
; CHECK-NEXT:  lea.sl %s36, c@hi(%s34)
; CHECK-NEXT:  and %s36, -4, %s36
; CHECK-NEXT:  cas.w %s38, (%s36), %s38
; CHECK-NEXT:  cmps.w.sx %s36, %s38, %s37
; CHECK-NEXT:  breq.w %s38, %s37, .LBB{{[0-9]+}}_3
; CHECK-NEXT:  # %partword.cmpxchg.failure
; CHECK-NEXT:  #   in Loop: Header=BB20_1 Depth=1
...
; CHECK-NEXT:  and %s34, %s34, (32)0
; CHECK-NEXT:  lea.sl %s35, s@hi(%s34)
; CHECK-NEXT:  and %s35, -4, %s35
; CHECK-NEXT:  or %s35, 2, %s35
...
; CHECK-NEXT:  # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:  or %s37, 0, %s38
; CHECK-NEXT:  lea.sl %s36, s@hi(%s34)
; CHECK-NEXT:  and %s36, -4, %s36
; CHECK-NEXT:  cas.w %s38, (%s36), %s38
; CHECK-NEXT:  cmps.w.sx %s36, %s38, %s37
; CHECK-NEXT:  breq.w %s38, %s37, .LBB{{[0-9]+}}_3
; CHECK-NEXT:  # %partword.cmpxchg.failure
; CHECK-NEXT:  #   in Loop: Header=BB21_1 Depth=1
; CHECK-NEXT:  and %s38, %s38, %s35
; CHECK-NEXT:  brne.w %s37, %s38, .LBB{{[0-9]+}}_1
; CHECK-NEXT:  .LBB{{[0-9]+}}_3:
; CHECK-NEXT:  fencem 3
...
; CHECK-NEXT:  lea.sl %s38, c@hi(%s34)
; CHECK-NEXT:  and %s38, -4, %s38
; CHECK-NEXT:  cas.w %s36, (%s38), %s37
...
; CHECK-NEXT:  and %s38, %s37, %s35
; CHECK-NEXT:  or %s36, %s38, %s36
; CHECK-NEXT:  lea.sl %s38, s@hi(%s34)
; CHECK-NEXT:  and %s38, -4, %s38
; CHECK-NEXT:  cas.w %s36, (%s38), %s37
; CHECK-NEXT:  brne.w %s36, %s37, .LBB{{[0-9]+}}_1
; CHECK-NEXT:  # %atomicrmw.end
...
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  lea.sl %s34, i@hi
; CHECK-NEXT:  ldl.sx %s0, i@lo(,%s34)
; CHECK-NEXT:  .LBB46_1:
; CHECK-NEXT:  # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:  or %s35, 0, %s0
; CHECK-NEXT:  lea %s0, 1(%s0)
; CHECK-NEXT:  cas.w %s0, i@lo(%s34), %s35
; CHECK-NEXT:  brne.w %s0, %s35, .LBB46_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  or %s11, 0, %s9
entry:
...
; CHECK-NEXT:  or %s35, 0, %s0
; CHECK-NEXT:  lea %s0, 1(%s0)
; CHECK-NEXT:  cas.l %s0, l@lo(%s34), %s35
; CHECK-NEXT:  brne.l %s0, %s35, .LBB47_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  or %s11, 0, %s9
entry:
...
; CHECK-NEXT:  and %s38, -4, %s38
; CHECK-NEXT:  cas.w %s36, (%s38), %s37
; CHECK-NEXT:  brne.w %s36, %s37, .LBB48_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  sla.w.sx %s34, %s36, 24
; CHECK-NEXT:  sra.w.sx %s0, %s34, 24
...
; CHECK-NEXT:  and %s38, -4, %s38
; CHECK-NEXT:  cas.w %s36, (%s38), %s37
; CHECK-NEXT:  brne.w %s36, %s37, .LBB49_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  sla.w.sx %s34, %s36, 16
; CHECK-NEXT:  sra.w.sx %s0, %s34, 16
...
; CHECK-NEXT:  lea %s0, -1(%s0)
; CHECK-NEXT:  cas.w %s0, i@lo(%s34), %s35
; CHECK-NEXT:  brne.w %s0, %s35, .LBB50_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  or %s11, 0, %s9
entry:
...
; CHECK-NEXT:  lea %s0, -1(%s0)
; CHECK-NEXT:  cas.l %s0, l@lo(%s34), %s35
; CHECK-NEXT:  brne.l %s0, %s35, .LBB51_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  or %s11, 0, %s9
entry:
...
; CHECK-NEXT:  lea.sl %s38, c@hi(%s34)
; CHECK-NEXT:  and %s38, -4, %s38
; CHECK-NEXT:  cas.w %s35, (%s38), %s37
; CHECK-NEXT:  brne.w %s35, %s37, .LBB52_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  sla.w.sx %s34, %s35, 24
; CHECK-NEXT:  sra.w.sx %s0, %s34, 24
...
; CHECK-NEXT:  and %s38, -4, %s38
; CHECK-NEXT:  cas.w %s35, (%s38), %s37
; CHECK-NEXT:  brne.w %s35, %s37, .LBB53_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  sla.w.sx %s34, %s35, 16
; CHECK-NEXT:  sra.w.sx %s0, %s34, 16
...
; CHECK-NEXT:  cas.w %s0, i@lo(%s34), %s35
; CHECK-NEXT:  brne.w %s0, %s35, .LBB54_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  or %s11, 0, %s9
entry:
...
; CHECK-NEXT:  and %s0, 1, %s0
; CHECK-NEXT:  cas.l %s0, l@lo(%s34), %s35
; CHECK-NEXT:  brne.l %s0, %s35, .LBB55_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  or %s11, 0, %s9
entry:
...
; CHECK-NEXT:  # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:  or %s36, 0, %s35
; CHECK-NEXT:  or %s35, 1, %s35
; CHECK-NEXT:  lea.sl %s37, c@hi(%s34)
; CHECK-NEXT:  and %s37, -4, %s37
; CHECK-NEXT:  cas.w %s35, (%s37), %s36
; CHECK-NEXT:  brne.w %s35, %s36, .LBB56_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  sla.w.sx %s34, %s35, 24
; CHECK-NEXT:  sra.w.sx %s0, %s34, 24
...
; CHECK-NEXT:  or %s36, 0, %s35
; CHECK-NEXT:  or %s35, 1, %s35
; CHECK-NEXT:  lea.sl %s37, s@hi(%s34)
; CHECK-NEXT:  and %s37, -4, %s37
; CHECK-NEXT:  cas.w %s35, (%s37), %s36
; CHECK-NEXT:  brne.w %s35, %s36, .LBB57_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  sla.w.sx %s34, %s35, 16
; CHECK-NEXT:  sra.w.sx %s0, %s34, 16
...
; CHECK-NEXT:  cas.w %s0, i@lo(%s34), %s35
; CHECK-NEXT:  brne.w %s0, %s35, .LBB58_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  or %s11, 0, %s9
entry:
...
; CHECK-NEXT:  or %s0, 1, %s0
; CHECK-NEXT:  cas.l %s0, l@lo(%s34), %s35
; CHECK-NEXT:  brne.l %s0, %s35, .LBB59_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  or %s11, 0, %s9
entry:
...
; CHECK-NEXT:  # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:  or %s36, 0, %s35
; CHECK-NEXT:  xor %s35, 1, %s35
; CHECK-NEXT:  lea.sl %s37, c@hi(%s34)
; CHECK-NEXT:  and %s37, -4, %s37
; CHECK-NEXT:  cas.w %s35, (%s37), %s36
; CHECK-NEXT:  brne.w %s35, %s36, .LBB60_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  sla.w.sx %s34, %s35, 24
; CHECK-NEXT:  sra.w.sx %s0, %s34, 24
...
; CHECK-NEXT:  and %s37, -4, %s37
; CHECK-NEXT:  cas.w %s35, (%s37), %s36
; CHECK-NEXT:  brne.w %s35, %s36, .LBB61_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  sla.w.sx %s34, %s35, 16
; CHECK-NEXT:  sra.w.sx %s0, %s34, 16
...
; CHECK-NEXT:  cas.w %s0, i@lo(%s34), %s35
; CHECK-NEXT:  brne.w %s0, %s35, .LBB62_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  or %s11, 0, %s9
entry:
...
; CHECK-NEXT:  xor %s0, 1, %s0
; CHECK-NEXT:  cas.l %s0, l@lo(%s34), %s35
; CHECK-NEXT:  brne.l %s0, %s35, .LBB63_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  or %s11, 0, %s9
entry:
...
; CHECK-NEXT:  lea.sl %s39, c@hi(%s34)
; CHECK-NEXT:  and %s39, -4, %s39
; CHECK-NEXT:  cas.w %s37, (%s39), %s38
; CHECK-NEXT:  brne.w %s37, %s38, .LBB64_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
...
; CHECK-NEXT:  and %s39, %s38, %s36
; CHECK-NEXT:  or %s37, %s39, %s37
; CHECK-NEXT:  lea.sl %s39, s@hi(%s34)
; CHECK-NEXT:  and %s39, -4, %s39
; CHECK-NEXT:  cas.w %s37, (%s39), %s38
; CHECK-NEXT:  brne.w %s37, %s38, .LBB65_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
...
; CHECK-NEXT:  cas.w %s0, i@lo(%s34), %s35
; CHECK-NEXT:  brne.w %s0, %s35, .LBB66_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  or %s11, 0, %s9
entry:
...
; CHECK-NEXT:  or %s0, -2, %s36
; CHECK-NEXT:  cas.l %s0, l@lo(%s34), %s35
; CHECK-NEXT:  brne.l %s0, %s35, .LBB67_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  or %s11, 0, %s9
entry:
...
; CHECK-NEXT:  cas.w %s0, i@lo(%s34), %s36
; CHECK-NEXT:  brne.w %s0, %s36, .LBB68_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  or %s11, 0, %s9
entry:
...
; CHECK-NEXT:  cas.w %s0, i@lo(%s34), %s37
; CHECK-NEXT:  brne.w %s0, %s37, .LBB69_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  # kill: def $sw0 killed $sw0 killed $sx0
; CHECK-NEXT:  or %s11, 0, %s9
...
; CHECK:       .LBB{{[0-9]+}}_4:
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  lea.sl %s34, ui@hi
; CHECK-NEXT:  ldl.sx %s0, ui@lo(,%s34)
; CHECK-NEXT:  or %s35, 1, (0)1
; CHECK-NEXT:  .LBB70_1:
; CHECK-NEXT:  # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:  or %s36, 0, %s0
...
; CHECK-NEXT:  cas.w %s0, ui@lo(%s34), %s36
; CHECK-NEXT:  brne.w %s0, %s36, .LBB70_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  # kill: def $sw0 killed $sw0 killed $sx0
; CHECK-NEXT:  or %s11, 0, %s9
...
; CHECK-NEXT:  or %s0, 0, %s35
; CHECK-NEXT:  cmov.w.lt %s0, %s37, %s38
; CHECK-NEXT:  cas.w %s0, ui@lo(%s34), %s37
; CHECK-NEXT:  brne.w %s0, %s37, .LBB71_1
; CHECK-NEXT:  # %atomicrmw.end
; CHECK-NEXT:  fencem 3
; CHECK-NEXT:  # kill: def $sw0 killed $sw0 killed $sx0
; CHECK-NEXT:  or %s11, 0, %s9
