...
; ModuleID = 'gen/tests/vbrdl_vsmv_i32.c'
source_filename = "gen/tests/vbrdl_vsmv_i32.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vbrdl_vsmv_i32(i32* %pvx, i32 %sy, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vbrdl_vsmv_i32
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %5 = tail call <256 x double> @llvm.ve.vbrdl.vsmv.i32(i32 %sy, <4 x i64> %2, <256 x double> %4)
