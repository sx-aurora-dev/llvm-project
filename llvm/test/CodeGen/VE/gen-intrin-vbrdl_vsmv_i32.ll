...
define void @vbrdl_vsmv_i32(i32* %pvx, i32 %sy, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vbrdl.vsmv.i32(i32, <4 x i64>, <256 x double>)
