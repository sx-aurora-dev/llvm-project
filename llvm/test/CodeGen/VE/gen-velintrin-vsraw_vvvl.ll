...
; ModuleID = 'gen/tests/vsraw_vvvl.c'
source_filename = "gen/tests/vsraw_vvvl.c"
...
define dso_local void @vsraw_vvvl(i32*, i32*, i64*, i32) local_unnamed_addr #0 {
...
7:                                                ; preds = %4, %7
  ...
  %19 = tail call <256 x double> @llvm.ve.vl.vsraw.vvvl(<256 x double> %16, <256 x double> %18, i32 %14)
...
declare <256 x double> @llvm.ve.vl.vsraw.vvvl(<256 x double>, <256 x double>, i32) #2
