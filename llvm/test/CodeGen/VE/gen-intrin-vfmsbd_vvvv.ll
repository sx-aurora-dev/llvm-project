...
; ModuleID = 'gen/tests/vfmsbd_vvvv.c'
source_filename = "gen/tests/vfmsbd_vvvv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vfmsbd_vvvv(double* %pvx, double* %pvy, double* %pvz, double* %pvw, i32 %n) local_unnamed_addr #0 {
...
declare <256 x double> @llvm.ve.vfmsbd.vvvv(<256 x double>, <256 x double>, <256 x double>) #3
