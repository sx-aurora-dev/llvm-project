...
; ModuleID = 'gen/tests/vdivuw_vvs.c'
source_filename = "gen/tests/vdivuw_vvs.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vdivuw_vvs(i32* %pvx, i32* %pvy, i32 %sy, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vdivuw_vvs
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %2 = tail call <256 x double> @llvm.ve.vdivuw.vvs(<256 x double> %1, i32 %sy)
...
declare <256 x double> @llvm.ve.vdivuw.vvs(<256 x double>, i32) #3
