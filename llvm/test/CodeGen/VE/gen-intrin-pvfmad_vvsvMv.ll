...
; ModuleID = 'gen/tests/pvfmad_vvsvMv.c'
source_filename = "gen/tests/pvfmad_vvsvMv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvfmad_vvsvMv(float* %pvx, float* %pvy, i64 %sy, float* %pvw, i32* %pvm, float* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.pvfmad.vvsvMv(<256 x double>, i64, <256 x double>, <8 x i64>, <256 x double>) #3
