...
; ModuleID = 'gen/tests/nndm_mmml.c'
source_filename = "gen/tests/nndm_mmml.c"
...
define dso_local void @nndm_mmml(i64* nocapture, i64* nocapture readonly, i64* nocapture readonly, i32) local_unnamed_addr #0 {
...
; Function Attrs: nounwind readnone
declare <4 x i64> @llvm.ve.vl.nndm.mmml(<4 x i64>, <4 x i64>, i32) #1
