...
; ModuleID = 'gen/tests/pvadds_vvv.c'
source_filename = "gen/tests/pvadds_vvv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvadds_vvv(i32* %pvx, i32* %pvy, i32* %pvz, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: pvadds_vvv
; CHECK: .LBB0_2
; CHECK: 	pvadds %v0,%v0,%v1
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %pvy.addr.022 = phi i32* [ %add.ptr4, %for.body ], [ %pvy, %entry ]
  %pvz.addr.021 = phi i32* [ %add.ptr5, %for.body ], [ %pvz, %entry ]
  ...
  %1 = bitcast i32* %pvy.addr.022 to i8*
  %2 = tail call <256 x double> @llvm.ve.vld.vss(i64 8, i8* %1)
  %3 = bitcast i32* %pvz.addr.021 to i8*
  %4 = tail call <256 x double> @llvm.ve.vld.vss(i64 8, i8* %3)
  %5 = tail call <256 x double> @llvm.ve.pvadds.vvv(<256 x double> %2, <256 x double> %4)
  ...
  %add.ptr4 = getelementptr inbounds i32, i32* %pvy.addr.022, i64 512
  %add.ptr5 = getelementptr inbounds i32, i32* %pvz.addr.021, i64 512
...
declare <256 x double> @llvm.ve.pvadds.vvv(<256 x double>, <256 x double>) #3
