...
; CHECK-NEXT:    cmov.l.eq %s3, %s2, %s34
...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:    cmps.l %s34, %s0, %s1
; CHECK-NEXT:    cmov.l.ne %s3, %s2, %s34
; CHECK-NEXT:    or %s0, 0, %s3
  %5 = icmp ne i64 %0, %1
  %6 = select i1 %5, i64 %2, i64 %3
  ret i64 %6
...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:    cmps.l %s34, %s0, %s1
; CHECK-NEXT:    cmov.l.ge %s3, %s2, %s34
; CHECK-NEXT:    or %s0, 0, %s3
  %5 = icmp sge i64 %0, %1
  %6 = select i1 %5, i64 %2, i64 %3
  ret i64 %6
...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:    cmps.l %s34, %s0, %s1
; CHECK-NEXT:    cmov.l.lt %s3, %s2, %s34
; CHECK-NEXT:    or %s0, 0, %s3
  %5 = icmp slt i64 %0, %1
  %6 = select i1 %5, i64 %2, i64 %3
  ret i64 %6
...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:    cmps.l %s34, %s0, %s1
; CHECK-NEXT:    cmov.l.le %s3, %s2, %s34
; CHECK-NEXT:    or %s0, 0, %s3
  %5 = icmp sle i64 %0, %1
  %6 = select i1 %5, i64 %2, i64 %3
  ret i64 %6
