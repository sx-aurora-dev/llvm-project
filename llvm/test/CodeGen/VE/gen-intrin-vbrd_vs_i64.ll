...
; ModuleID = 'gen/tests/vbrd_vs_i64.c'
source_filename = "gen/tests/vbrd_vs_i64.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vbrd_vs_i64(i64* %pvx, i64 %sy, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vbrd_vs_i64
; CHECK: .LBB0_2
; CHECK: 	vbrd %v0,%s1
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %0 = tail call <256 x double> @llvm.ve.vbrd.vs.i64(i64 %sy)
