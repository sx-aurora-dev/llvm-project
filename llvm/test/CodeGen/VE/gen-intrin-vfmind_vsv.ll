...
; ModuleID = 'gen/tests/vfmind_vsv.c'
source_filename = "gen/tests/vfmind_vsv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vfmind_vsv(double* %pvx, double %sy, double* %pvz, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vfmind_vsv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %2 = tail call <256 x double> @llvm.ve.vfmind.vsv(double %sy, <256 x double> %1)
...
declare <256 x double> @llvm.ve.vfmind.vsv(double, <256 x double>) #3
