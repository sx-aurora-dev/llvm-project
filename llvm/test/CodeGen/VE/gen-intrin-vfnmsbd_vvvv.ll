...
define void @vfnmsbd_vvvv(double* %pvx, double* %pvy, double* %pvz, double* %pvw, i32 %n) {
...
declare <256 x double> @llvm.ve.vfnmsbd.vvvv(<256 x double>, <256 x double>, <256 x double>)
