...
; ModuleID = 'gen/tests/orm_mmml.c'
source_filename = "gen/tests/orm_mmml.c"
...
define dso_local void @orm_mmml(i64* nocapture, i64* nocapture readonly, i64* nocapture readonly, i32) local_unnamed_addr #0 {
; CHECK: orm %vm1,%vm1,%vm2
  ...
  %27 = tail call <4 x i64> @llvm.ve.vl.orm.mmml(<4 x i64> %23, <4 x i64> %26, i32 256)
...
; Function Attrs: nounwind readnone
declare <4 x i64> @llvm.ve.vl.orm.mmml(<4 x i64>, <4 x i64>, i32) #1
