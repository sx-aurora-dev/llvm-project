...
; ModuleID = 'gen/tests/pvcmpu_vvvMv.c'
source_filename = "gen/tests/pvcmpu_vvvMv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvcmpu_vvvMv(i32* %pvx, i32* %pvy, i32* %pvz, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: pvcmpu_vvvMv
; CHECK: .LBB0_2
; CHECK: 	pvcmpu %v3,%v0,%v1,%vm2
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %10 = tail call <256 x double> @llvm.ve.pvcmpu.vvvMv(<256 x double> %2, <256 x double> %4, <8 x i64> %7, <256 x double> %9)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.pvcmpu.vvvMv(<256 x double>, <256 x double>, <8 x i64>, <256 x double>) #3
