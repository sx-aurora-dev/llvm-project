...
define float @func_i16fp32(ptr %a) nounwind {
...
define double @func_i16fp64(ptr %a) nounwind {
...
define float @func_fp16fp32(ptr %a) nounwind {
...
define double @func_fp16fp64(ptr %a) nounwind {
...
define void @func_fp32i16(ptr %fl.ptr, float %val) nounwind {
...
define half @func_fp32fp16(ptr %fl.ptr, float %a) nounwind {
...
define double @func_fp32fp64(ptr %a) nounwind {
...
define void @func_fp64i16(ptr %fl.ptr, double %val) nounwind {
...
define void @func_fp64fp16(ptr %fl.ptr, double %val) nounwind {
...
define void @func_fp64fp32(ptr %fl.ptr, double %val) nounwind {
