...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:  fcmp.q %s1, %s0, %s2
; CHECK-NEXT:  or %s0, 0, (0)1
; CHECK-NEXT:  cmov.d.eq %s0, (63)0, %s1
  
  %3 = fcmp oeq fp128 %0, %1
  ret i1 %3
}
