...
; CHECK-NEXT:  .8byte 0x0000000000000000 # fp128 -5
; CHECK-NEXT:  .8byte 0xc001400000000000
; CHECK-LABEL: m5f128:
; CHECK:       .LBB{{[0-9]+}}_2:
...
; CHECK-LABEL: .LCPI{{[0-9]+}}_0:
; CHECK-NEXT:  .8byte 0x6000000000000000 # fp128 2.29999999999999982236431605997495353
; CHECK-NEXT:  .8byte 0x4000266666666666
...
; CHECK-LABEL: .LCPI{{[0-9]+}}_0:
; CHECK-NEXT:  .8byte 0xa000000000000000 # fp128 128.300000000000011368683772161602974
; CHECK-NEXT:  .8byte 0x4006009999999999
