...
; Function Attrs: argmemonly nofree nounwind
define x86_fastcallcc void @storei64_stk_big(i64 noundef %0) {
...
; CHECK-NEXT:    b.l.t (, %s10)
  %2 = alloca i64, align 8
  %3 = alloca [268435455 x i64], align 8
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %2)
  call void @llvm.lifetime.start.p0(i64 2147483640, ptr nonnull %3)
  store volatile i64 %0, ptr %2, align 8, !tbaa !3
  br label %5

4:                                                ; preds = %5
  call void @llvm.lifetime.end.p0(i64 2147483640, ptr nonnull %3)
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %2)
  ret void

5:                                                ; preds = %1, %5
  %6 = phi i64 [ 0, %1 ], [ %8, %5 ]
  %7 = getelementptr inbounds [268435455 x i64], ptr %3, i64 0, i64 %6
  store volatile i64 %0, ptr %7, align 8, !tbaa !3
  %8 = add nuw nsw i64 %6, 1
  %9 = icmp eq i64 %8, 268435455
  br i1 %9, label %4, label %5, !llvm.loop !7
}

; Function Attrs: argmemonly nofree nounwind
define x86_fastcallcc void @storei64_stk_big2(i64 noundef %0) {
...
; CHECK-NEXT:    b.l.t (, %s10)
  %2 = alloca i64, align 8
  %3 = alloca [268435456 x i64], align 8
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %2)
  call void @llvm.lifetime.start.p0(i64 2147483648, ptr nonnull %3)
  store volatile i64 %0, ptr %2, align 8, !tbaa !3
  br label %5

4:                                                ; preds = %5
  call void @llvm.lifetime.end.p0(i64 2147483648, ptr nonnull %3)
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %2)
  ret void

5:                                                ; preds = %1, %5
  %6 = phi i64 [ 0, %1 ], [ %8, %5 ]
  %7 = getelementptr inbounds [268435456 x i64], ptr %3, i64 0, i64 %6
  store volatile i64 %0, ptr %7, align 8, !tbaa !3
  %8 = add nuw nsw i64 %6, 1
  %9 = icmp eq i64 %8, 268435456
  br i1 %9, label %4, label %5, !llvm.loop !9
}
