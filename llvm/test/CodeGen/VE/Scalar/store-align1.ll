...
; CHECK-NEXT:    srl %s2, %s0, 56
; CHECK-NEXT:    st1b %s2, 7(, %s1)
; CHECK-NEXT:    srl %s2, %s0, 48
; CHECK-NEXT:    st1b %s2, 6(, %s1)
; CHECK-NEXT:    srl %s2, %s0, 40
; CHECK-NEXT:    st1b %s2, 5(, %s1)
; CHECK-NEXT:    srl %s2, %s0, 32
; CHECK-NEXT:    st1b %s2, 4(, %s1)
; CHECK-NEXT:    srl %s2, %s0, 24
; CHECK-NEXT:    st1b %s2, 3(, %s1)
; CHECK-NEXT:    srl %s2, %s0, 16
; CHECK-NEXT:    st1b %s2, 2(, %s1)
; CHECK-NEXT:    srl %s0, %s0, 8
; CHECK-NEXT:    st1b %s0, 1(, %s1)
; CHECK-NEXT:    b.l.t (, %s10)
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    srl %s1, %s0, 56
; CHECK-NEXT:    lea %s2, vi64@lo
; CHECK-NEXT:    and %s2, %s2, (32)0
; CHECK-NEXT:    lea.sl %s2, vi64@hi(, %s2)
; CHECK-NEXT:    st1b %s1, 7(, %s2)
; CHECK-NEXT:    srl %s1, %s0, 48
; CHECK-NEXT:    st1b %s1, 6(, %s2)
; CHECK-NEXT:    srl %s1, %s0, 40
; CHECK-NEXT:    st1b %s1, 5(, %s2)
; CHECK-NEXT:    srl %s1, %s0, 32
; CHECK-NEXT:    st1b %s1, 4(, %s2)
; CHECK-NEXT:    srl %s1, %s0, 24
; CHECK-NEXT:    st1b %s1, 3(, %s2)
; CHECK-NEXT:    srl %s1, %s0, 16
; CHECK-NEXT:    st1b %s1, 2(, %s2)
; CHECK-NEXT:    srl %s1, %s0, 8
; CHECK-NEXT:    st1b %s1, 1(, %s2)
; CHECK-NEXT:    st1b %s0, (, %s2)
; CHECK-NEXT:    b.l.t (, %s10)
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    srl %s1, %s0, 8
; CHECK-NEXT:    lea %s2, vi16@lo
; CHECK-NEXT:    and %s2, %s2, (32)0
; CHECK-NEXT:    lea.sl %s2, vi16@hi(, %s2)
; CHECK-NEXT:    st1b %s1, 1(, %s2)
; CHECK-NEXT:    st1b %s0, (, %s2)
; CHECK-NEXT:    b.l.t (, %s10)
