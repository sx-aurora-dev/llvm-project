...
; CHECK-NEXT:    or %s11, 0, %s9
  %2 = tail call fast float @llvm.round.f32(float %0)
  ret float %2
}
...
; CHECK-NEXT:    bsic %s10, (, %s12)
; CHECK-NEXT:    or %s11, 0, %s9
  %2 = tail call fast double @llvm.round.f64(double %0)
  ret double %2
}
...
; CHECK-NEXT:    bsic %s10, (, %s12)
; CHECK-NEXT:    or %s11, 0, %s9
  %2 = tail call fast fp128 @llvm.round.f128(fp128 %0)
  ret fp128 %2
}
...
; CHECK-NEXT:    bsic %s10, (, %s12)
; CHECK-NEXT:    or %s11, 0, %s9
  %1 = tail call fast fp128 @llvm.round.f128(fp128 0xL00000000000000000000000000000000)
  ret fp128 %1
}
...
; CHECK-NEXT:    bsic %s10, (, %s12)
; CHECK-NEXT:    or %s11, 0, %s9
  %1 = tail call fast fp128 @llvm.round.f128(fp128 0xL0000000000000000C000000000000000)
  ret fp128 %1
}
