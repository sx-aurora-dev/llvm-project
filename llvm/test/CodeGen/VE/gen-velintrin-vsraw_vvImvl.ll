...
; ModuleID = 'gen/tests/vsraw_vvImvl.c'
source_filename = "gen/tests/vsraw_vvImvl.c"
...
define dso_local void @vsraw_vvImvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
...
8:                                                ; preds = %5, %8
  ...
  %25 = tail call <256 x double> @llvm.ve.vl.vsraw.vvsmvl(<256 x double> %18, i64 3, <4 x i64> %21, <256 x double> %23, i32 %16)
