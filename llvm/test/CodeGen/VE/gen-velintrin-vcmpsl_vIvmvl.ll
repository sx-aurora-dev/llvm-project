...
; ModuleID = 'gen/tests/vcmpsl_vIvmvl.c'
source_filename = "gen/tests/vcmpsl_vIvmvl.c"
...
define dso_local void @vcmpsl_vIvmvl(i64*, i64*, i32*, i64*, i32) local_unnamed_addr #0 {
