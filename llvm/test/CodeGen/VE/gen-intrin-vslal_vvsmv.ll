...
define void @vslal_vvsmv(i64* %pvx, i64* %pvz, i64 %sy, i32* %pvm, i64* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vslal.vvsmv(<256 x double>, i64, <4 x i64>, <256 x double>)
