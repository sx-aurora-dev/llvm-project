...
; ModuleID = 'gen/tests/vminswzx_vIv.c'
source_filename = "gen/tests/vminswzx_vIv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vminswzx_vIv(i32* %pvx, i32* %pvz, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vminswzx_vIv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %2 = tail call <256 x double> @llvm.ve.vminswzx.vsv(i32 3, <256 x double> %1)
