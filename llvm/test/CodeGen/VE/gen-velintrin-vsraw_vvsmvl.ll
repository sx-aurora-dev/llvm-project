...
; ModuleID = 'gen/tests/vsraw_vvsmvl.c'
source_filename = "gen/tests/vsraw_vvsmvl.c"
...
define dso_local void @vsraw_vvsmvl(i32*, i32*, i64, i32*, i32*, i32) local_unnamed_addr #0 {
...
9:                                                ; preds = %6, %9
  ...
  %26 = tail call <256 x double> @llvm.ve.vl.vsraw.vvsmvl(<256 x double> %19, i64 %2, <4 x i64> %22, <256 x double> %24, i32 %17)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vsraw.vvsmvl(<256 x double>, i64, <4 x i64>, <256 x double>, i32) #2
