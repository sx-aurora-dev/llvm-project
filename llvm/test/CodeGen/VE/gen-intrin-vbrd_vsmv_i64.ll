...
; ModuleID = 'gen/tests/vbrd_vsmv_i64.c'
source_filename = "gen/tests/vbrd_vsmv_i64.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vbrd_vsmv_i64(i64* %pvx, i64 %sy, i32* %pvm, i64* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vbrd_vsmv_i64
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %5 = tail call <256 x double> @llvm.ve.vbrd.vsmv.i64(i64 %sy, <4 x i64> %2, <256 x double> %4)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vbrd.vsmv.i64(i64, <4 x i64>, <256 x double>) #3
