...
; ModuleID = 'gen/tests/vsfa_vvssmv.c'
source_filename = "gen/tests/vsfa_vvssmv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vsfa_vvssmv(i64* %pvx, i64* %pvz, i64 %sy, i64 %sz, i32* %pvm, i64* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vsfa_vvssmv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %7 = tail call <256 x double> @llvm.ve.vsfa.vvssmv(<256 x double> %1, i64 %sy, i64 %sz, <4 x i64> %4, <256 x double> %6)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vsfa.vvssmv(<256 x double>, i64, i64, <4 x i64>, <256 x double>) #3
