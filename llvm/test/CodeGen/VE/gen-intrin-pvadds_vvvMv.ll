...
; ModuleID = 'gen/tests/pvadds_vvvMv.c'
source_filename = "gen/tests/pvadds_vvvMv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvadds_vvvMv(i32* %pvx, i32* %pvy, i32* %pvz, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: pvadds_vvvMv
; CHECK: .LBB0_2
; CHECK: 	pvadds %v3,%v0,%v1,%vm2
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %pvy.addr.029 = phi i32* [ %add.ptr4, %for.body ], [ %pvy, %entry ]
  %pvz.addr.028 = phi i32* [ %add.ptr5, %for.body ], [ %pvz, %entry ]
  ...
  %1 = bitcast i32* %pvy.addr.029 to i8*
  %2 = tail call <256 x double> @llvm.ve.vld.vss(i64 8, i8* %1)
  %3 = bitcast i32* %pvz.addr.028 to i8*
  ...
  %10 = tail call <256 x double> @llvm.ve.pvadds.vvvMv(<256 x double> %2, <256 x double> %4, <8 x i64> %7, <256 x double> %9)
  tail call void @llvm.ve.vst.vss(<256 x double> %10, i64 8, i8* %8)
  %add.ptr = getelementptr inbounds i32, i32* %pvx.addr.030, i64 512
  %add.ptr4 = getelementptr inbounds i32, i32* %pvy.addr.029, i64 512
  %add.ptr5 = getelementptr inbounds i32, i32* %pvz.addr.028, i64 512
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.pvadds.vvvMv(<256 x double>, <256 x double>, <8 x i64>, <256 x double>) #3
