...
; ModuleID = 'gen/tests/vcmpul_vIvmvl.c'
source_filename = "gen/tests/vcmpul_vIvmvl.c"
...
define dso_local void @vcmpul_vIvmvl(i64*, i64*, i32*, i64*, i32) local_unnamed_addr #0 {
