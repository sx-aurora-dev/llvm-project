...
; ModuleID = 'gen/tests/vdivsl_vvImvl.c'
source_filename = "gen/tests/vdivsl_vvImvl.c"
...
define dso_local void @vdivsl_vvImvl(i64*, i64*, i32*, i64*, i32) local_unnamed_addr #0 {
