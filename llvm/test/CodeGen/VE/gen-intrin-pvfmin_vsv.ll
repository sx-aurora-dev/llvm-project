...
; ModuleID = 'gen/tests/pvfmin_vsv.c'
source_filename = "gen/tests/pvfmin_vsv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvfmin_vsv(float* %pvx, i64 %sy, float* %pvz, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: pvfmin_vsv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %3 = tail call <256 x double> @llvm.ve.pvfmin.vsv(i64 %sy, <256 x double> %2)
...
declare <256 x double> @llvm.ve.pvfmin.vsv(i64, <256 x double>) #3
