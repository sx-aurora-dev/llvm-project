...
; ModuleID = 'gen/tests/orm_MMM.c'
source_filename = "gen/tests/orm_MMM.c"
...
define dso_local void @orm_MMM(i64* nocapture %0, i64* nocapture readonly %1, i64* nocapture readonly %2, i32 signext %3) local_unnamed_addr #0 {
; CHECK: orm %vm2,%vm2,%vm4
; CHECK: orm %vm3,%vm3,%vm5
  ...
  %51 = tail call <8 x i64> @llvm.ve.vl.orm.MMM(<8 x i64> %47, <8 x i64> %50)
...
; Function Attrs: nounwind readnone
declare <8 x i64> @llvm.ve.vl.orm.MMM(<8 x i64>, <8 x i64>) #1
