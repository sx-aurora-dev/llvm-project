...
; ModuleID = 'gen/tests/vsrawsx_vvsl.c'
source_filename = "gen/tests/vsrawsx_vvsl.c"
...
define dso_local void @vsrawsx_vvsl(i32* %0, i32* %1, i32 %2, i32 signext %3) local_unnamed_addr #0 {
; CHECK: vsra.w.sx %v0, %v0, %s2
  %5 = icmp sgt i32 %3, 0
...
7:                                                ; preds = %4, %7
  ...
  %16 = tail call <256 x double> @llvm.ve.vl.vsrawsx.vvsl(<256 x double> %15, i32 %2, i32 %13)
