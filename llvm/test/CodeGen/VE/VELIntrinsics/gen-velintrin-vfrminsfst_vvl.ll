...
; ModuleID = 'gen/tests/vfrminsfst_vvl.c'
source_filename = "gen/tests/vfrminsfst_vvl.c"
...
define dso_local void @vfrminsfst_vvl(float* %0, float* %1, i32 signext %2) local_unnamed_addr #0 {
; CHECK: vfrmin.s.fst %v0, %v0
  %4 = icmp sgt i32 %2, 0
...
6:                                                ; preds = %3, %6
  %7 = phi float* [ %17, %6 ], [ %0, %3 ]
  %8 = phi float* [ %18, %6 ], [ %1, %3 ]
  %9 = phi i32 [ %19, %6 ], [ 0, %3 ]
  %10 = sub nsw i32 %2, %9
  %11 = icmp slt i32 %10, 256
  %12 = select i1 %11, i32 %10, i32 256
  %13 = bitcast float* %8 to i8*
  %14 = tail call <256 x double> @llvm.ve.vl.vldu.vssl(i64 4, i8* %13, i32 %12)
  %15 = tail call <256 x double> @llvm.ve.vl.vfrminsfst.vvl(<256 x double> %14, i32 %12)
  %16 = bitcast float* %7 to i8*
  tail call void @llvm.ve.vl.vstu.vssl(<256 x double> %15, i64 4, i8* %16, i32 %12)
  %17 = getelementptr inbounds float, float* %7, i64 256
...
declare <256 x double> @llvm.ve.vl.vfrminsfst.vvl(<256 x double>, i32) #2
