...
; ModuleID = 'gen/tests/vdivswsx_vvsmvl.c'
source_filename = "gen/tests/vdivswsx_vvsmvl.c"
...
define dso_local void @vdivswsx_vvsmvl(i32* %0, i32* %1, i32 signext %2, i32* %3, i32* %4, i32 signext %5) local_unnamed_addr #0 {
...
9:                                                ; preds = %6, %9
  ...
  %26 = tail call <256 x double> @llvm.ve.vl.vdivswsx.vvsmvl(<256 x double> %19, i32 %2, <256 x i1> %22, <256 x double> %24, i32 %17)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vdivswsx.vvsmvl(<256 x double>, i32, <256 x i1>, <256 x double>, i32) #2
