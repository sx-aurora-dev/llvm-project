...
; ModuleID = 'gen/tests/vfdivs_vsvmvl.c'
source_filename = "gen/tests/vfdivs_vsvmvl.c"
...
define dso_local void @vfdivs_vsvmvl(float* %0, float %1, float* %2, i32* %3, float* %4, i32 signext %5) local_unnamed_addr #0 {
...
9:                                                ; preds = %6, %9
  %10 = phi float* [ %27, %9 ], [ %0, %6 ]
  %11 = phi float* [ %28, %9 ], [ %2, %6 ]
  %12 = phi i32* [ %29, %9 ], [ %3, %6 ]
  %13 = phi float* [ %30, %9 ], [ %4, %6 ]
  %14 = phi i32 [ %31, %9 ], [ 0, %6 ]
  %15 = sub nsw i32 %5, %14
  %16 = icmp slt i32 %15, 256
  %17 = select i1 %16, i32 %15, i32 256
  %18 = bitcast float* %11 to i8*
  %19 = tail call <256 x double> @llvm.ve.vl.vldu.vssl(i64 4, i8* %18, i32 %17)
  ...
  %24 = tail call <256 x double> @llvm.ve.vl.vldu.vssl(i64 4, i8* %23, i32 %17)
  %25 = bitcast float* %10 to i8*
  %26 = tail call <256 x double> @llvm.ve.vl.vfdivs.vsvmvl(float %1, <256 x double> %19, <256 x i1> %22, <256 x double> %24, i32 %17)
  tail call void @llvm.ve.vl.vstu.vssl(<256 x double> %26, i64 4, i8* %25, i32 %17)
  %27 = getelementptr inbounds float, float* %10, i64 256
  %28 = getelementptr inbounds float, float* %11, i64 256
  %29 = getelementptr inbounds i32, i32* %12, i64 256
  %30 = getelementptr inbounds float, float* %13, i64 256
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vfdivs.vsvmvl(float, <256 x double>, <256 x i1>, <256 x double>, i32) #2
