...
; ModuleID = 'gen/tests/pvfadd_vvvl.c'
source_filename = "gen/tests/pvfadd_vvvl.c"
...
define dso_local void @pvfadd_vvvl(float* %0, float* %1, float* %2, i32 signext %3) local_unnamed_addr #0 {
...
7:                                                ; preds = %4, %7
  ...
  %20 = tail call <256 x double> @llvm.ve.vl.pvfadd.vvvl(<256 x double> %17, <256 x double> %19, i32 %15)
...
declare <256 x double> @llvm.ve.vl.pvfadd.vvvl(<256 x double>, <256 x double>, i32) #2
