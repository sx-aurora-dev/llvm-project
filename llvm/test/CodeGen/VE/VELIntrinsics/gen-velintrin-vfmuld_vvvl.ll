...
; ModuleID = 'gen/tests/vfmuld_vvvl.c'
source_filename = "gen/tests/vfmuld_vvvl.c"
...
define dso_local void @vfmuld_vvvl(double* %0, double* %1, double* %2, i32 signext %3) local_unnamed_addr #0 {
...
7:                                                ; preds = %4, %7
  ...
  %19 = tail call <256 x double> @llvm.ve.vl.vfmuld.vvvl(<256 x double> %16, <256 x double> %18, i32 %14)
...
declare <256 x double> @llvm.ve.vl.vfmuld.vvvl(<256 x double>, <256 x double>, i32) #2
