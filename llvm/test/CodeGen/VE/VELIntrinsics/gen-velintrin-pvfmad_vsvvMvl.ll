...
; ModuleID = 'gen/tests/pvfmad_vsvvMvl.c'
source_filename = "gen/tests/pvfmad_vsvvMvl.c"
...
define dso_local void @pvfmad_vsvvMvl(float* %0, i64 %1, float* %2, float* %3, i32* %4, float* %5, i32 signext %6) local_unnamed_addr #0 {
...
10:                                               ; preds = %7, %10
  ...
  %31 = tail call <256 x double> @llvm.ve.vl.pvfmad.vsvvMvl(i64 %1, <256 x double> %22, <256 x double> %24, <512 x i1> %27, <256 x double> %29, i32 %20)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.pvfmad.vsvvMvl(i64, <256 x double>, <256 x double>, <512 x i1>, <256 x double>, i32) #2
