...
; ModuleID = 'gen/tests/pvfnmsb_vvsvl.c'
source_filename = "gen/tests/pvfnmsb_vvsvl.c"
...
define dso_local void @pvfnmsb_vvsvl(float* %0, float* %1, i64 %2, float* %3, i32 signext %4) local_unnamed_addr #0 {
; CHECK: pvfnmsb %v0, %v0, %s2, %v1
  %6 = icmp sgt i32 %4, 0
...
8:                                                ; preds = %5, %8
  ...
  %21 = tail call <256 x double> @llvm.ve.vl.pvfnmsb.vvsvl(<256 x double> %18, i64 %2, <256 x double> %20, i32 %16)
...
declare <256 x double> @llvm.ve.vl.pvfnmsb.vvsvl(<256 x double>, i64, <256 x double>, i32) #2
