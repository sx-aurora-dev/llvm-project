...
define dso_local void @vbrdl_vsmvl(i64* %0, i64 %1, i32* %2, i64* %3, i32 signext %4) local_unnamed_addr #0 {
...
8:                                                ; preds = %5, %8
  ...
  %22 = tail call <256 x double> @llvm.ve.vl.vbrdl.vsmvl(i64 %1, <256 x i1> %18, <256 x double> %20, i32 %15)
