...
; ModuleID = 'gen/tests/pvfnmad_vvvvl.c'
source_filename = "gen/tests/pvfnmad_vvvvl.c"
...
define dso_local void @pvfnmad_vvvvl(float* %0, float* %1, float* %2, float* %3, i32 signext %4) local_unnamed_addr #0 {
...
8:                                                ; preds = %5, %8
  ...
  %24 = tail call <256 x double> @llvm.ve.vl.pvfnmad.vvvvl(<256 x double> %19, <256 x double> %21, <256 x double> %23, i32 %17)
...
declare <256 x double> @llvm.ve.vl.pvfnmad.vvvvl(<256 x double>, <256 x double>, <256 x double>, i32) #2
