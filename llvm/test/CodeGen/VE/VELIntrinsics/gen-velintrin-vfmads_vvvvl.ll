...
; ModuleID = 'gen/tests/vfmads_vvvvl.c'
source_filename = "gen/tests/vfmads_vvvvl.c"
...
define dso_local void @vfmads_vvvvl(float* %0, float* %1, float* %2, float* %3, i32 signext %4) local_unnamed_addr #0 {
...
8:                                                ; preds = %5, %8
  ...
  %23 = tail call <256 x double> @llvm.ve.vl.vfmads.vvvvl(<256 x double> %18, <256 x double> %20, <256 x double> %22, i32 %16)
...
declare <256 x double> @llvm.ve.vl.vfmads.vvvvl(<256 x double>, <256 x double>, <256 x double>, i32) #2
