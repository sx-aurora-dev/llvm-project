...
; ModuleID = 'gen/tests/pvfcmp_vvvMvl.c'
source_filename = "gen/tests/pvfcmp_vvvMvl.c"
...
define dso_local void @pvfcmp_vvvMvl(float* %0, float* %1, float* %2, i32* %3, float* %4, i32 signext %5) local_unnamed_addr #0 {
...
9:                                                ; preds = %6, %9
  ...
  %30 = tail call <256 x double> @llvm.ve.vl.pvfcmp.vvvMvl(<256 x double> %21, <256 x double> %23, <512 x i1> %26, <256 x double> %28, i32 %19)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.pvfcmp.vvvMvl(<256 x double>, <256 x double>, <512 x i1>, <256 x double>, i32) #2
