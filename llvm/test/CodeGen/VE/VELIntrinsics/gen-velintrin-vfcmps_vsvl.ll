...
; ModuleID = 'gen/tests/vfcmps_vsvl.c'
source_filename = "gen/tests/vfcmps_vsvl.c"
...
define dso_local void @vfcmps_vsvl(float* %0, float %1, float* %2, i32 signext %3) local_unnamed_addr #0 {
...
declare <256 x double> @llvm.ve.vl.vfcmps.vsvl(float, <256 x double>, i32) #2
