...
; ModuleID = 'gen/tests/vfmind_vsvl.c'
source_filename = "gen/tests/vfmind_vsvl.c"
...
define dso_local void @vfmind_vsvl(double* %0, double %1, double* %2, i32 signext %3) local_unnamed_addr #0 {
; CHECK: vfmin.d %v0, %s1, %v0
  %5 = icmp sgt i32 %3, 0
...
7:                                                ; preds = %4, %7
  %8 = phi double* [ %18, %7 ], [ %0, %4 ]
  %9 = phi double* [ %19, %7 ], [ %2, %4 ]
  %10 = phi i32 [ %20, %7 ], [ 0, %4 ]
  %11 = sub nsw i32 %3, %10
  ...
  %16 = tail call <256 x double> @llvm.ve.vl.vfmind.vsvl(double %1, <256 x double> %15, i32 %13)
  ...
  %19 = getelementptr inbounds double, double* %9, i64 256
...
declare <256 x double> @llvm.ve.vl.vfmind.vsvl(double, <256 x double>, i32) #2
