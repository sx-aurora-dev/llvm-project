...
; ModuleID = 'gen/tests/pvsra_vvsMvl.c'
source_filename = "gen/tests/pvsra_vvsMvl.c"
...
define dso_local void @pvsra_vvsMvl(i32* %0, i32* %1, i64 %2, i32* %3, i32* %4, i32 signext %5) local_unnamed_addr #0 {
...
9:                                                ; preds = %6, %9
  ...
  %27 = tail call <256 x double> @llvm.ve.vl.pvsra.vvsMvl(<256 x double> %20, i64 %2, <512 x i1> %23, <256 x double> %25, i32 %18)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.pvsra.vvsMvl(<256 x double>, i64, <512 x i1>, <256 x double>, i32) #2
