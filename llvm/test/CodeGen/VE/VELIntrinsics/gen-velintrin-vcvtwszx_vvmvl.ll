...
; ModuleID = 'gen/tests/vcvtwszx_vvmvl.c'
source_filename = "gen/tests/vcvtwszx_vvmvl.c"
...
define dso_local void @vcvtwszx_vvmvl(i32* %0, float* %1, i32* %2, i32* %3, i32 signext %4) local_unnamed_addr #0 {
; CHECK: vcvt.w.s.zx %v2, %v0, %vm1
  %6 = icmp sgt i32 %4, 0
...
8:                                                ; preds = %5, %8
  ...
  %25 = tail call <256 x double> @llvm.ve.vl.vcvtwszx.vvmvl(<256 x double> %18, <256 x i1> %21, <256 x double> %23, i32 %16)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vcvtwszx.vvmvl(<256 x double>, <256 x i1>, <256 x double>, i32) #2
