...
; ModuleID = 'gen/tests/vfsums_vvml.c'
source_filename = "gen/tests/vfsums_vvml.c"
...
define dso_local void @vfsums_vvml(float* %0, float* %1, i32* %2, i32 signext %3) local_unnamed_addr #0 {
; CHECK: vfsum.s %v0, %v0, %vm1
  %5 = icmp sgt i32 %3, 0
...
7:                                                ; preds = %4, %7
  ...
  %21 = tail call <256 x double> @llvm.ve.vl.vfsums.vvml(<256 x double> %16, <256 x i1> %19, i32 %14)
  tail call void @llvm.ve.vl.vstu.vssl(<256 x double> %21, i64 4, i8* %20, i32 %14)
  %22 = getelementptr inbounds float, float* %8, i64 256
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vfsums.vvml(<256 x double>, <256 x i1>, i32) #2
