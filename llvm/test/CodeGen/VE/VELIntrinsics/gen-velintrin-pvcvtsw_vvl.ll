...
; ModuleID = 'gen/tests/pvcvtsw_vvl.c'
source_filename = "gen/tests/pvcvtsw_vvl.c"
...
define dso_local void @pvcvtsw_vvl(float* %0, i32* %1, i32 signext %2) local_unnamed_addr #0 {
...
declare <256 x double> @llvm.ve.vl.pvcvtsw.vvl(<256 x double>, i32) #2
