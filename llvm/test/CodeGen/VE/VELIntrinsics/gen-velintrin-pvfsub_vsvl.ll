...
; ModuleID = 'gen/tests/pvfsub_vsvl.c'
source_filename = "gen/tests/pvfsub_vsvl.c"
...
define dso_local void @pvfsub_vsvl(float* %0, i64 %1, float* %2, i32 signext %3) local_unnamed_addr #0 {
; CHECK: pvfsub %v0, %s1, %v0
  %5 = icmp sgt i32 %3, 0
...
7:                                                ; preds = %4, %7
  ...
  %17 = tail call <256 x double> @llvm.ve.vl.pvfsub.vsvl(i64 %1, <256 x double> %16, i32 %14)
...
declare <256 x double> @llvm.ve.vl.pvfsub.vsvl(i64, <256 x double>, i32) #2
