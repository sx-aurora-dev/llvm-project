...
; ModuleID = 'gen/tests/vfmaxs_vsvl.c'
source_filename = "gen/tests/vfmaxs_vsvl.c"
...
define dso_local void @vfmaxs_vsvl(float* %0, float %1, float* %2, i32 signext %3) local_unnamed_addr #0 {
; CHECK: vfmax.s %v0, %s1, %v0
  %5 = icmp sgt i32 %3, 0
...
7:                                                ; preds = %4, %7
  ...
  %16 = tail call <256 x double> @llvm.ve.vl.vfmaxs.vsvl(float %1, <256 x double> %15, i32 %13)
...
declare <256 x double> @llvm.ve.vl.vfmaxs.vsvl(float, <256 x double>, i32) #2
