...
; ModuleID = 'gen/tests/vsubuw_vIvmvl.c'
source_filename = "gen/tests/vsubuw_vIvmvl.c"
...
define dso_local void @vsubuw_vIvmvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
