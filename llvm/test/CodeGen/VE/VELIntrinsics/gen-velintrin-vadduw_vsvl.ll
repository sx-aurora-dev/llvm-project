...
; ModuleID = 'gen/tests/vadduw_vsvl.c'
source_filename = "gen/tests/vadduw_vsvl.c"
...
define dso_local void @vadduw_vsvl(i32* %0, i32 zeroext %1, i32* %2, i32 signext %3) local_unnamed_addr #0 {
; CHECK: vaddu.w %v0, %s1, %v0
  %5 = icmp sgt i32 %3, 0
...
7:                                                ; preds = %4, %7
  ...
  %16 = tail call <256 x double> @llvm.ve.vl.vadduw.vsvl(i32 %1, <256 x double> %15, i32 %13)
...
declare <256 x double> @llvm.ve.vl.vadduw.vsvl(i32, <256 x double>, i32) #2
