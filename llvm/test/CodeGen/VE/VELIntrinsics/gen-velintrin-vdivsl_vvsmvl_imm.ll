...
; ModuleID = 'gen/tests/vdivsl_vvsmvl_imm.c'
source_filename = "gen/tests/vdivsl_vvsmvl_imm.c"
...
define dso_local void @vdivsl_vvsmvl_imm(i64* %0, i64* %1, i32* %2, i64* %3, i32 signext %4) local_unnamed_addr #0 {
...
8:                                                ; preds = %5, %8
  ...
  %25 = tail call <256 x double> @llvm.ve.vl.vdivsl.vvsmvl(<256 x double> %18, i64 3, <256 x i1> %21, <256 x double> %23, i32 %16)
