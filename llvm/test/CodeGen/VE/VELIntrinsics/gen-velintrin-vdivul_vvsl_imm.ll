...
; ModuleID = 'gen/tests/vdivul_vvsl_imm.c'
source_filename = "gen/tests/vdivul_vvsl_imm.c"
...
define dso_local void @vdivul_vvsl_imm(i64* %0, i64* %1, i32 signext %2) local_unnamed_addr #0 {
...
6:                                                ; preds = %3, %6
  ...
  %15 = tail call <256 x double> @llvm.ve.vl.vdivul.vvsl(<256 x double> %14, i64 3, i32 %12)
...
declare <256 x double> @llvm.ve.vl.vdivul.vvsl(<256 x double>, i64, i32) #2
