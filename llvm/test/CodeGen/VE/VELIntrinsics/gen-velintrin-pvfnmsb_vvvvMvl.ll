...
define dso_local void @pvfnmsb_vvvvMvl(float*, float*, float*, float*, i32*, float*, i32) local_unnamed_addr #0 {
...
10:                                               ; preds = %7, %10
  ...
  %34 = tail call <256 x double> @llvm.ve.vl.pvfnmsb.vvvvMvl(<256 x double> %23, <256 x double> %25, <256 x double> %27, <8 x i64> %30, <256 x double> %32, i32 %21)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.pvfnmsb.vvvvMvl(<256 x double>, <256 x double>, <256 x double>, <8 x i64>, <256 x double>, i32) #2
