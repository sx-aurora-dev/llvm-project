...
; ModuleID = 'gen/tests/vminswzx_vIvmvl.c'
source_filename = "gen/tests/vminswzx_vIvmvl.c"
...
define dso_local void @vminswzx_vIvmvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
