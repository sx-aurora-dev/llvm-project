...
; ModuleID = 'gen/tests/vshf_vvvsl_imm.c'
source_filename = "gen/tests/vshf_vvvsl_imm.c"
...
define dso_local void @vshf_vvvsl_imm(i64* %0, i64* %1, i64* %2, i32 signext %3) local_unnamed_addr #0 {
; CHECK: vshf %v0, %v0, %v1, 3
  %5 = icmp sgt i32 %3, 0
...
7:                                                ; preds = %4, %7
  ...
  %19 = tail call <256 x double> @llvm.ve.vl.vshf.vvvsl(<256 x double> %16, <256 x double> %18, i64 3, i32 %14)
  %20 = bitcast i64* %8 to i8*
  tail call void @llvm.ve.vl.vst.vssl(<256 x double> %19, i64 8, i8* %20, i32 %14)
  %21 = getelementptr inbounds i64, i64* %8, i64 256
...
declare <256 x double> @llvm.ve.vl.vshf.vvvsl(<256 x double>, <256 x double>, i64, i32) #2
