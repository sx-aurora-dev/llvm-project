...
; ModuleID = 'gen/tests/pvrcp_vvl.c'
source_filename = "gen/tests/pvrcp_vvl.c"
...
define dso_local void @pvrcp_vvl(float* %0, float* %1, i32 signext %2) local_unnamed_addr #0 {
; CHECK: pvrcp %v0, %v0
  %4 = icmp sgt i32 %2, 0
...
6:                                                ; preds = %3, %6
  ...
  %16 = tail call <256 x double> @llvm.ve.vl.pvrcp.vvl(<256 x double> %15, i32 %13)
...
declare <256 x double> @llvm.ve.vl.pvrcp.vvl(<256 x double>, i32) #2
