...
; ModuleID = 'gen/tests/vbrdw_vsl.c'
source_filename = "gen/tests/vbrdw_vsl.c"
...
define dso_local void @vbrdw_vsl(i32* %0, i32 signext %1, i32 signext %2) local_unnamed_addr #0 {
; CHECK: vbrdl %v0, %s1
  %4 = icmp sgt i32 %2, 0
