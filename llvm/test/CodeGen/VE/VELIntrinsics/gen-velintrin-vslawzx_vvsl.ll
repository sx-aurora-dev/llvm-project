...
; ModuleID = 'gen/tests/vslawzx_vvsl.c'
source_filename = "gen/tests/vslawzx_vvsl.c"
...
define dso_local void @vslawzx_vvsl(i32* %0, i32* %1, i32 %2, i32 signext %3) local_unnamed_addr #0 {
; CHECK: vsla.w.zx %v0, %v0, %s2
  %5 = icmp sgt i32 %3, 0
...
7:                                                ; preds = %4, %7
  ...
  %16 = tail call <256 x double> @llvm.ve.vl.vslawzx.vvsl(<256 x double> %15, i32 %2, i32 %13)
