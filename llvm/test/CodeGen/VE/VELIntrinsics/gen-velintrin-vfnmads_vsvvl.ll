...
; ModuleID = 'gen/tests/vfnmads_vsvvl.c'
source_filename = "gen/tests/vfnmads_vsvvl.c"
...
define dso_local void @vfnmads_vsvvl(float* %0, float %1, float* %2, float* %3, i32 signext %4) local_unnamed_addr #0 {
...
declare <256 x double> @llvm.ve.vl.vfnmads.vsvvl(float, <256 x double>, <256 x double>, i32) #2
