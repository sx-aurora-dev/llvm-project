...
; ModuleID = 'gen/tests/vrxor_vvml.c'
source_filename = "gen/tests/vrxor_vvml.c"
...
define dso_local void @vrxor_vvml(i64* %0, i64* %1, i32* %2, i32 signext %3) local_unnamed_addr #0 {
; CHECK: vrxor %v0, %v0, %vm1
  %5 = icmp sgt i32 %3, 0
