...
; ModuleID = 'gen/tests/vfmaxd_vsvl.c'
source_filename = "gen/tests/vfmaxd_vsvl.c"
...
define dso_local void @vfmaxd_vsvl(double* %0, double %1, double* %2, i32 signext %3) local_unnamed_addr #0 {
; CHECK: vfmax.d %v0, %s1, %v0
  %5 = icmp sgt i32 %3, 0
...
7:                                                ; preds = %4, %7
  ...
  %16 = tail call <256 x double> @llvm.ve.vl.vfmaxd.vsvl(double %1, <256 x double> %15, i32 %13)
...
declare <256 x double> @llvm.ve.vl.vfmaxd.vsvl(double, <256 x double>, i32) #2
