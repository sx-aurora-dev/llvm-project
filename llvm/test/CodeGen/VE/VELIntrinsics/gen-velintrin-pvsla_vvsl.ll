...
; ModuleID = 'gen/tests/pvsla_vvsl.c'
source_filename = "gen/tests/pvsla_vvsl.c"
...
define dso_local void @pvsla_vvsl(i32* %0, i32* %1, i64 %2, i32 signext %3) local_unnamed_addr #0 {
; CHECK: pvsla %v0, %v0, %s2
  %5 = icmp sgt i32 %3, 0
...
7:                                                ; preds = %4, %7
  ...
  %17 = tail call <256 x double> @llvm.ve.vl.pvsla.vvsl(<256 x double> %16, i64 %2, i32 %14)
...
declare <256 x double> @llvm.ve.vl.pvsla.vvsl(<256 x double>, i64, i32) #2
