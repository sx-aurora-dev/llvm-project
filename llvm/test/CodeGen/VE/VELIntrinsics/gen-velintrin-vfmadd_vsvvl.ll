...
; ModuleID = 'gen/tests/vfmadd_vsvvl.c'
source_filename = "gen/tests/vfmadd_vsvvl.c"
...
define dso_local void @vfmadd_vsvvl(double* %0, double %1, double* %2, double* %3, i32 signext %4) local_unnamed_addr #0 {
...
8:                                                ; preds = %5, %8
  ...
  %20 = tail call <256 x double> @llvm.ve.vl.vfmadd.vsvvl(double %1, <256 x double> %17, <256 x double> %19, i32 %15)
...
declare <256 x double> @llvm.ve.vl.vfmadd.vsvvl(double, <256 x double>, <256 x double>, i32) #2
