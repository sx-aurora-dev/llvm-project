...
; ModuleID = 'gen/tests/vdivsl_vsvmvl_imm.c'
source_filename = "gen/tests/vdivsl_vsvmvl_imm.c"
...
define dso_local void @vdivsl_vsvmvl_imm(i64* %0, i64* %1, i32* %2, i64* %3, i32 signext %4) local_unnamed_addr #0 {
...
8:                                                ; preds = %5, %8
  ...
  %25 = tail call <256 x double> @llvm.ve.vl.vdivsl.vsvmvl(i64 3, <256 x double> %18, <256 x i1> %21, <256 x double> %23, i32 %16)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vdivsl.vsvmvl(i64, <256 x double>, <256 x i1>, <256 x double>, i32) #2
