...
; ModuleID = 'gen/tests/pvaddu_vsvMvl.c'
source_filename = "gen/tests/pvaddu_vsvMvl.c"
...
define dso_local void @pvaddu_vsvMvl(i32* %0, i64 %1, i32* %2, i32* %3, i32* %4, i32 signext %5) local_unnamed_addr #0 {
...
9:                                                ; preds = %6, %9
  ...
  %27 = tail call <256 x double> @llvm.ve.vl.pvaddu.vsvMvl(i64 %1, <256 x double> %20, <512 x i1> %23, <256 x double> %25, i32 %18)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.pvaddu.vsvMvl(i64, <256 x double>, <512 x i1>, <256 x double>, i32) #2
