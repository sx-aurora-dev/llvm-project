...
; ModuleID = 'gen/tests/vdivul_vvvmvl.c'
source_filename = "gen/tests/vdivul_vvvmvl.c"
...
define dso_local void @vdivul_vvvmvl(i64* %0, i64* %1, i64* %2, i32* %3, i64* %4, i32 signext %5) local_unnamed_addr #0 {
...
9:                                                ; preds = %6, %9
  ...
  %29 = tail call <256 x double> @llvm.ve.vl.vdivul.vvvmvl(<256 x double> %20, <256 x double> %22, <256 x i1> %25, <256 x double> %27, i32 %18)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vdivul.vvvmvl(<256 x double>, <256 x double>, <256 x i1>, <256 x double>, i32) #2
