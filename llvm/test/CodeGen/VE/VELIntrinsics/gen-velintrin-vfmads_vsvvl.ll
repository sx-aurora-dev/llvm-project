...
; ModuleID = 'gen/tests/vfmads_vsvvl.c'
source_filename = "gen/tests/vfmads_vsvvl.c"
...
define dso_local void @vfmads_vsvvl(float* %0, float %1, float* %2, float* %3, i32 signext %4) local_unnamed_addr #0 {
; CHECK: vfmad.s %v0, %s1, %v0, %v1
  %6 = icmp sgt i32 %4, 0
...
8:                                                ; preds = %5, %8
  ...
  %20 = tail call <256 x double> @llvm.ve.vl.vfmads.vsvvl(float %1, <256 x double> %17, <256 x double> %19, i32 %15)
...
declare <256 x double> @llvm.ve.vl.vfmads.vsvvl(float, <256 x double>, <256 x double>, i32) #2
