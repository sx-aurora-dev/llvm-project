...
; ModuleID = 'gen/tests/pvfcmp_vsvl.c'
source_filename = "gen/tests/pvfcmp_vsvl.c"
...
define dso_local void @pvfcmp_vsvl(float* %0, i64 %1, float* %2, i32 signext %3) local_unnamed_addr #0 {
...
declare <256 x double> @llvm.ve.vl.pvfcmp.vsvl(i64, <256 x double>, i32) #2
