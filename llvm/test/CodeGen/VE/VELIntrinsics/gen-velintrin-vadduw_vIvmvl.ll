...
; ModuleID = 'gen/tests/vadduw_vIvmvl.c'
source_filename = "gen/tests/vadduw_vIvmvl.c"
...
define dso_local void @vadduw_vIvmvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
