...
; ModuleID = 'gen/tests/vbrdw_vsmvl.c'
source_filename = "gen/tests/vbrdw_vsmvl.c"
...
define dso_local void @vbrdw_vsmvl(i32* %0, i32 signext %1, i32* %2, i32* %3, i32 signext %4) local_unnamed_addr #0 {
...
8:                                                ; preds = %5, %8
  ...
  %22 = tail call <256 x double> @llvm.ve.vl.vbrdw.vsmvl(i32 %1, <256 x i1> %18, <256 x double> %20, i32 %15)
