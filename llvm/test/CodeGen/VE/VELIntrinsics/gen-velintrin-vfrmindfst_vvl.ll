...
; ModuleID = 'gen/tests/vfrmindfst_vvl.c'
source_filename = "gen/tests/vfrmindfst_vvl.c"
...
define dso_local void @vfrmindfst_vvl(double* %0, double* %1, i32 signext %2) local_unnamed_addr #0 {
...
declare <256 x double> @llvm.ve.vl.vfrmindfst.vvl(<256 x double>, i32) #2
