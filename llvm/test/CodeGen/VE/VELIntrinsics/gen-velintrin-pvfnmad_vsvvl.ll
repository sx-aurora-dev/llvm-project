...
; ModuleID = 'gen/tests/pvfnmad_vsvvl.c'
source_filename = "gen/tests/pvfnmad_vsvvl.c"
...
define dso_local void @pvfnmad_vsvvl(float* %0, i64 %1, float* %2, float* %3, i32 signext %4) local_unnamed_addr #0 {
...
8:                                                ; preds = %5, %8
  ...
  %21 = tail call <256 x double> @llvm.ve.vl.pvfnmad.vsvvl(i64 %1, <256 x double> %18, <256 x double> %20, i32 %16)
...
declare <256 x double> @llvm.ve.vl.pvfnmad.vsvvl(i64, <256 x double>, <256 x double>, i32) #2
