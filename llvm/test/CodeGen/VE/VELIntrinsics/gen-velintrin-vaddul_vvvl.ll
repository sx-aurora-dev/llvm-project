...
; ModuleID = 'gen/tests/vaddul_vvvl.c'
source_filename = "gen/tests/vaddul_vvvl.c"
...
define dso_local void @vaddul_vvvl(i64* %0, i64* %1, i64* %2, i32 signext %3) local_unnamed_addr #0 {
; CHECK: vaddu.l %v0, %v0, %v1
  %5 = icmp sgt i32 %3, 0
...
7:                                                ; preds = %4, %7
  ...
  %19 = tail call <256 x double> @llvm.ve.vl.vaddul.vvvl(<256 x double> %16, <256 x double> %18, i32 %14)
...
declare <256 x double> @llvm.ve.vl.vaddul.vvvl(<256 x double>, <256 x double>, i32) #2
