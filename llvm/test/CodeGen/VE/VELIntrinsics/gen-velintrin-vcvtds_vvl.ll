...
; ModuleID = 'gen/tests/vcvtds_vvl.c'
source_filename = "gen/tests/vcvtds_vvl.c"
...
define dso_local void @vcvtds_vvl(double* %0, float* %1, i32 signext %2) local_unnamed_addr #0 {
...
6:                                                ; preds = %3, %6
  ...
  %15 = tail call <256 x double> @llvm.ve.vl.vcvtds.vvl(<256 x double> %14, i32 %12)
...
declare <256 x double> @llvm.ve.vl.vcvtds.vvl(<256 x double>, i32) #2
