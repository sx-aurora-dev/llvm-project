...
define dso_local void @pvfnmsb_vvsvMvl(float* %0, float* %1, i64 %2, float* %3, i32* %4, float* %5, i32 signext %6) local_unnamed_addr #0 {
...
10:                                               ; preds = %7, %10
  ...
  %31 = tail call <256 x double> @llvm.ve.vl.pvfnmsb.vvsvMvl(<256 x double> %22, i64 %2, <256 x double> %24, <512 x i1> %27, <256 x double> %29, i32 %20)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.pvfnmsb.vvsvMvl(<256 x double>, i64, <256 x double>, <512 x i1>, <256 x double>, i32) #2
