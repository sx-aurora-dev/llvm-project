...
; ModuleID = 'gen/tests/vmulswsx_vIvmvl.c'
source_filename = "gen/tests/vmulswsx_vIvmvl.c"
...
define dso_local void @vmulswsx_vIvmvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
...
8:                                                ; preds = %5, %8
  ...
  %25 = tail call <256 x double> @llvm.ve.vl.vmulswsx.vsvmvl(i32 3, <256 x double> %18, <4 x i64> %21, <256 x double> %23, i32 %16)
