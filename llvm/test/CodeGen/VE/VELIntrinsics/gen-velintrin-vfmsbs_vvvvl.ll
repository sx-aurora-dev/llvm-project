...
; ModuleID = 'gen/tests/vfmsbs_vvvvl.c'
source_filename = "gen/tests/vfmsbs_vvvvl.c"
...
define dso_local void @vfmsbs_vvvvl(float* %0, float* %1, float* %2, float* %3, i32 signext %4) local_unnamed_addr #0 {
...
declare <256 x double> @llvm.ve.vl.vfmsbs.vvvvl(<256 x double>, <256 x double>, <256 x double>, i32) #2
