...
; ModuleID = 'gen/tests/vbrdl_vsmvl_imm.c'
source_filename = "gen/tests/vbrdl_vsmvl_imm.c"
...
define dso_local void @vbrdl_vsmvl_imm(i64* %0, i32* %1, i64* %2, i32 signext %3) local_unnamed_addr #0 {
; CHECK: vbrd %v1, 3, %vm1
  %5 = icmp sgt i32 %3, 0
