...
; ModuleID = 'gen/tests/vcvtld_vvmvl.c'
source_filename = "gen/tests/vcvtld_vvmvl.c"
...
define dso_local void @vcvtld_vvmvl(i64* %0, double* %1, i32* %2, i64* %3, i32 signext %4) local_unnamed_addr #0 {
; CHECK: vcvt.l.d %v2, %v0, %vm1
  %6 = icmp sgt i32 %4, 0
...
8:                                                ; preds = %5, %8
  ...
  %25 = tail call <256 x double> @llvm.ve.vl.vcvtld.vvmvl(<256 x double> %18, <256 x i1> %21, <256 x double> %23, i32 %16)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vcvtld.vvmvl(<256 x double>, <256 x i1>, <256 x double>, i32) #2
