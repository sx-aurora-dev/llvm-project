...
; ModuleID = 'gen/tests/vcmpuw_vIvmvl.c'
source_filename = "gen/tests/vcmpuw_vIvmvl.c"
...
define dso_local void @vcmpuw_vIvmvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
