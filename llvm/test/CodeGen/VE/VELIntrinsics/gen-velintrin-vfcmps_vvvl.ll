...
; ModuleID = 'gen/tests/vfcmps_vvvl.c'
source_filename = "gen/tests/vfcmps_vvvl.c"
...
define dso_local void @vfcmps_vvvl(float* %0, float* %1, float* %2, i32 signext %3) local_unnamed_addr #0 {
; CHECK: vfcmp.s %v0, %v0, %v1
  %5 = icmp sgt i32 %3, 0
...
7:                                                ; preds = %4, %7
  %8 = phi float* [ %21, %7 ], [ %0, %4 ]
  %9 = phi float* [ %22, %7 ], [ %1, %4 ]
  %10 = phi float* [ %23, %7 ], [ %2, %4 ]
  %11 = phi i32 [ %24, %7 ], [ 0, %4 ]
  %12 = sub nsw i32 %3, %11
  %13 = icmp slt i32 %12, 256
  %14 = select i1 %13, i32 %12, i32 256
  %15 = bitcast float* %9 to i8*
  %16 = tail call <256 x double> @llvm.ve.vl.vldu.vssl(i64 4, i8* %15, i32 %14)
  %17 = bitcast float* %10 to i8*
  %18 = tail call <256 x double> @llvm.ve.vl.vldu.vssl(i64 4, i8* %17, i32 %14)
  %19 = tail call <256 x double> @llvm.ve.vl.vfcmps.vvvl(<256 x double> %16, <256 x double> %18, i32 %14)
  %20 = bitcast float* %8 to i8*
  tail call void @llvm.ve.vl.vstu.vssl(<256 x double> %19, i64 4, i8* %20, i32 %14)
  %21 = getelementptr inbounds float, float* %8, i64 256
...
declare <256 x double> @llvm.ve.vl.vfcmps.vvvl(<256 x double>, <256 x double>, i32) #2
