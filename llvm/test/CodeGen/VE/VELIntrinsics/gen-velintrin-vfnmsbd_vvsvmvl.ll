...
; ModuleID = 'gen/tests/vfnmsbd_vvsvmvl.c'
source_filename = "gen/tests/vfnmsbd_vvsvmvl.c"
...
define dso_local void @vfnmsbd_vvsvmvl(double* %0, double* %1, double %2, double* %3, i32* %4, double* %5, i32 signext %6) local_unnamed_addr #0 {
...
10:                                               ; preds = %7, %10
  ...
  %30 = tail call <256 x double> @llvm.ve.vl.vfnmsbd.vvsvmvl(<256 x double> %21, double %2, <256 x double> %23, <256 x i1> %26, <256 x double> %28, i32 %19)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vfnmsbd.vvsvmvl(<256 x double>, double, <256 x double>, <256 x i1>, <256 x double>, i32) #2
