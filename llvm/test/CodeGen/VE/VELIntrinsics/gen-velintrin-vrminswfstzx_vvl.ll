...
; ModuleID = 'gen/tests/vrminswfstzx_vvl.c'
source_filename = "gen/tests/vrminswfstzx_vvl.c"
...
define dso_local void @vrminswfstzx_vvl(i32* %0, i32* %1, i32 signext %2) local_unnamed_addr #0 {
...
declare <256 x double> @llvm.ve.vl.vrminswfstzx.vvl(<256 x double>, i32) #2
