...
; ModuleID = 'gen/tests/vfnmsbs_vvvvmvl.c'
source_filename = "gen/tests/vfnmsbs_vvvvmvl.c"
...
define dso_local void @vfnmsbs_vvvvmvl(float* %0, float* %1, float* %2, float* %3, i32* %4, float* %5, i32 signext %6) local_unnamed_addr #0 {
...
10:                                               ; preds = %7, %10
  ...
  %33 = tail call <256 x double> @llvm.ve.vl.vfnmsbs.vvvvmvl(<256 x double> %22, <256 x double> %24, <256 x double> %26, <256 x i1> %29, <256 x double> %31, i32 %20)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vfnmsbs.vvvvmvl(<256 x double>, <256 x double>, <256 x double>, <256 x i1>, <256 x double>, i32) #2
