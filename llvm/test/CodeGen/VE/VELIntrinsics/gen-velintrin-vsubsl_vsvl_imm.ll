...
; ModuleID = 'gen/tests/vsubsl_vsvl_imm.c'
source_filename = "gen/tests/vsubsl_vsvl_imm.c"
...
define dso_local void @vsubsl_vsvl_imm(i64* %0, i64* %1, i32 signext %2) local_unnamed_addr #0 {
; CHECK: vsubs.l %v0, 3, %v0
  %4 = icmp sgt i32 %2, 0
...
6:                                                ; preds = %3, %6
  ...
  %15 = tail call <256 x double> @llvm.ve.vl.vsubsl.vsvl(i64 3, <256 x double> %14, i32 %12)
