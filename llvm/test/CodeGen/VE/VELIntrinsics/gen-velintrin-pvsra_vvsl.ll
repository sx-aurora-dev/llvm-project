...
; ModuleID = 'gen/tests/pvsra_vvsl.c'
source_filename = "gen/tests/pvsra_vvsl.c"
...
define dso_local void @pvsra_vvsl(i32* %0, i32* %1, i64 %2, i32 signext %3) local_unnamed_addr #0 {
...
declare <256 x double> @llvm.ve.vl.pvsra.vvsl(<256 x double>, i64, i32) #2
