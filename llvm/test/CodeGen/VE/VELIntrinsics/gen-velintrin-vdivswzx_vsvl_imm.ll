...
; ModuleID = 'gen/tests/vdivswzx_vsvl_imm.c'
source_filename = "gen/tests/vdivswzx_vsvl_imm.c"
...
define dso_local void @vdivswzx_vsvl_imm(i32* %0, i32* %1, i32 signext %2) local_unnamed_addr #0 {
...
6:                                                ; preds = %3, %6
  ...
  %15 = tail call <256 x double> @llvm.ve.vl.vdivswzx.vsvl(i32 3, <256 x double> %14, i32 %12)
