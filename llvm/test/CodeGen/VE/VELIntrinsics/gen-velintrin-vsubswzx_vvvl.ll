...
; ModuleID = 'gen/tests/vsubswzx_vvvl.c'
source_filename = "gen/tests/vsubswzx_vvvl.c"
...
define dso_local void @vsubswzx_vvvl(i32* %0, i32* %1, i32* %2, i32 signext %3) local_unnamed_addr #0 {
...
declare <256 x double> @llvm.ve.vl.vsubswzx.vvvl(<256 x double>, <256 x double>, i32) #2
