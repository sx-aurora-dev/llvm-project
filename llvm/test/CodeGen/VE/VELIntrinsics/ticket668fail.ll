; RUN: llc -mtriple ve -mattr=-velintrin < %s | FileCheck %s
; XFAIL: *
...
6:                                                ; preds = %4
  %7 = tail call <4 x i64> @llvm.ve.vl.vfmklat.ml(i32 256)
  br label %9
...
9:                                                ; preds = %9, %6
  ...
  %20 = tail call <4 x i64> @llvm.ve.vl.vfmkwgt.mvl(<256 x double> %19, i32 %17)
  %21 = tail call <4 x i64> @llvm.ve.vl.nndm.mmm(<4 x i64> %13, <4 x i64> %20)
  ...
  %26 = tail call <256 x double> @llvm.ve.vl.vfaddd.vvvmvl(<256 x double> %23, <256 x double> %25, <4 x i64> %21, <256 x double> %23, i32 %17)
...
declare <4 x i64> @llvm.ve.vl.vfmklat.ml(i32)
...
; Function Attrs: nounwind readnone
declare <4 x i64> @llvm.ve.vl.nndm.mmm(<4 x i64>, <4 x i64>)
