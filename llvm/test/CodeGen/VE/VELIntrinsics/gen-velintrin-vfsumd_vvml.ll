...
; ModuleID = 'gen/tests/vfsumd_vvml.c'
source_filename = "gen/tests/vfsumd_vvml.c"
...
define dso_local void @vfsumd_vvml(double* %0, double* %1, i32* %2, i32 signext %3) local_unnamed_addr #0 {
...
7:                                                ; preds = %4, %7
  ...
  %21 = tail call <256 x double> @llvm.ve.vl.vfsumd.vvml(<256 x double> %16, <256 x i1> %19, i32 %14)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vfsumd.vvml(<256 x double>, <256 x i1>, i32) #2
