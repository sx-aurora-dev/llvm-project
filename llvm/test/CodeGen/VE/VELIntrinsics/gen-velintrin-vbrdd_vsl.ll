...
; ModuleID = 'gen/tests/vbrdd_vsl.c'
source_filename = "gen/tests/vbrdd_vsl.c"
...
define dso_local void @vbrdd_vsl(double* %0, double %1, i32 signext %2) local_unnamed_addr #0 {
; CHECK: vbrd %v0, %s1
  %4 = icmp sgt i32 %2, 0
...
declare <256 x double> @llvm.ve.vl.vbrdd.vsl(double, i32) #1
