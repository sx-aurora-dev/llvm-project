...
; ModuleID = 'gen/tests/vfnmsbd_vvvvl.c'
source_filename = "gen/tests/vfnmsbd_vvvvl.c"
...
define dso_local void @vfnmsbd_vvvvl(double* %0, double* %1, double* %2, double* %3, i32 signext %4) local_unnamed_addr #0 {
; CHECK: vfnmsb.d %v0, %v0, %v1, %v2
  %6 = icmp sgt i32 %4, 0
...
8:                                                ; preds = %5, %8
  ...
  %23 = tail call <256 x double> @llvm.ve.vl.vfnmsbd.vvvvl(<256 x double> %18, <256 x double> %20, <256 x double> %22, i32 %16)
...
declare <256 x double> @llvm.ve.vl.vfnmsbd.vvvvl(<256 x double>, <256 x double>, <256 x double>, i32) #2
