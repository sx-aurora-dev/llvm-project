...
; ModuleID = 'gen/tests/vslaw_vvIl.c'
source_filename = "gen/tests/vslaw_vvIl.c"
...
define dso_local void @vslaw_vvIl(i32*, i32*, i32) local_unnamed_addr #0 {
...
6:                                                ; preds = %3, %6
  ...
  %15 = tail call <256 x double> @llvm.ve.vl.vslaw.vvsl(<256 x double> %14, i64 3, i32 %12)
