...
; ModuleID = 'gen/tests/vsrawzx_vvsl_imm.c'
source_filename = "gen/tests/vsrawzx_vvsl_imm.c"
...
define dso_local void @vsrawzx_vvsl_imm(i32* %0, i32* %1, i32 signext %2) local_unnamed_addr #0 {
; CHECK: vsra.w.zx %v0, %v0, 3
  %4 = icmp sgt i32 %2, 0
