...
; ModuleID = 'gen/tests/vdivswzx_vvImvl.c'
source_filename = "gen/tests/vdivswzx_vvImvl.c"
...
define dso_local void @vdivswzx_vvImvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
