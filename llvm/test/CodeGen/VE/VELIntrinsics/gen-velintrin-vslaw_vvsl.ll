...
; ModuleID = 'gen/tests/vslaw_vvsl.c'
source_filename = "gen/tests/vslaw_vvsl.c"
...
define dso_local void @vslaw_vvsl(i32*, i32*, i64, i32) local_unnamed_addr #0 {
...
7:                                                ; preds = %4, %7
  ...
  %16 = tail call <256 x double> @llvm.ve.vl.vslaw.vvsl(<256 x double> %15, i64 %2, i32 %13)
...
declare <256 x double> @llvm.ve.vl.vslaw.vvsl(<256 x double>, i64, i32) #2
