...
; ModuleID = 'gen/tests/vmulswzx_vIvmvl.c'
source_filename = "gen/tests/vmulswzx_vIvmvl.c"
...
define dso_local void @vmulswzx_vIvmvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
