...
; ModuleID = 'gen/tests/vdivswzx_vvsl.c'
source_filename = "gen/tests/vdivswzx_vvsl.c"
...
define dso_local void @vdivswzx_vvsl(i32* %0, i32* %1, i32 signext %2, i32 signext %3) local_unnamed_addr #0 {
...
7:                                                ; preds = %4, %7
  ...
  %16 = tail call <256 x double> @llvm.ve.vl.vdivswzx.vvsl(<256 x double> %15, i32 %2, i32 %13)
