...
; ModuleID = 'gen/tests/vfsubd_vvvl.c'
source_filename = "gen/tests/vfsubd_vvvl.c"
...
define dso_local void @vfsubd_vvvl(double* %0, double* %1, double* %2, i32 signext %3) local_unnamed_addr #0 {
...
declare <256 x double> @llvm.ve.vl.vfsubd.vvvl(<256 x double>, <256 x double>, i32) #2
