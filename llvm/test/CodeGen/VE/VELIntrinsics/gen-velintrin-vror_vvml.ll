...
; ModuleID = 'gen/tests/vror_vvml.c'
source_filename = "gen/tests/vror_vvml.c"
...
define dso_local void @vror_vvml(i64* %0, i64* %1, i32* %2, i32 signext %3) local_unnamed_addr #0 {
; CHECK: vror %v0, %v0, %vm1
  %5 = icmp sgt i32 %3, 0
...
7:                                                ; preds = %4, %7
  ...
  %21 = tail call <256 x double> @llvm.ve.vl.vror.vvml(<256 x double> %16, <256 x i1> %19, i32 %14)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vror.vvml(<256 x double>, <256 x i1>, i32) #2
