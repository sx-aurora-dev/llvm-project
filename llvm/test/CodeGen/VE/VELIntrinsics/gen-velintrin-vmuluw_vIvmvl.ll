...
; ModuleID = 'gen/tests/vmuluw_vIvmvl.c'
source_filename = "gen/tests/vmuluw_vIvmvl.c"
...
define dso_local void @vmuluw_vIvmvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
