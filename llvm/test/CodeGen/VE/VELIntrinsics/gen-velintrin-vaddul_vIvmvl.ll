...
; ModuleID = 'gen/tests/vaddul_vIvmvl.c'
source_filename = "gen/tests/vaddul_vIvmvl.c"
...
define dso_local void @vaddul_vIvmvl(i64*, i64*, i32*, i64*, i32) local_unnamed_addr #0 {
