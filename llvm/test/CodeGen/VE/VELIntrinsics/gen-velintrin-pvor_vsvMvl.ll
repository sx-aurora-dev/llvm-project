...
; ModuleID = 'gen/tests/pvor_vsvMvl.c'
source_filename = "gen/tests/pvor_vsvMvl.c"
...
define dso_local void @pvor_vsvMvl(i32* %0, i64 %1, i32* %2, i32* %3, i32* %4, i32 signext %5) local_unnamed_addr #0 {
; CHECK: pvor %v2, %s1, %v0, %vm2
  %7 = icmp sgt i32 %5, 0
...
9:                                                ; preds = %6, %9
  ...
  %27 = tail call <256 x double> @llvm.ve.vl.pvor.vsvMvl(i64 %1, <256 x double> %20, <512 x i1> %23, <256 x double> %25, i32 %18)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.pvor.vsvMvl(i64, <256 x double>, <512 x i1>, <256 x double>, i32) #2
