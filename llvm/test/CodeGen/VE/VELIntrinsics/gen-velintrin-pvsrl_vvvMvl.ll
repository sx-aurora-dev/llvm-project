...
; ModuleID = 'gen/tests/pvsrl_vvvMvl.c'
source_filename = "gen/tests/pvsrl_vvvMvl.c"
...
define dso_local void @pvsrl_vvvMvl(i32* %0, i32* %1, i32* %2, i32* %3, i32* %4, i32 signext %5) local_unnamed_addr #0 {
...
9:                                                ; preds = %6, %9
  ...
  %30 = tail call <256 x double> @llvm.ve.vl.pvsrl.vvvMvl(<256 x double> %21, <256 x double> %23, <512 x i1> %26, <256 x double> %28, i32 %19)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.pvsrl.vvvMvl(<256 x double>, <256 x double>, <512 x i1>, <256 x double>, i32) #2
