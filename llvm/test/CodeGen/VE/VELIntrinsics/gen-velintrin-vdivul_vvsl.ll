...
; ModuleID = 'gen/tests/vdivul_vvsl.c'
source_filename = "gen/tests/vdivul_vvsl.c"
...
define dso_local void @vdivul_vvsl(i64* %0, i64* %1, i64 %2, i32 signext %3) local_unnamed_addr #0 {
...
7:                                                ; preds = %4, %7
  ...
  %16 = tail call <256 x double> @llvm.ve.vl.vdivul.vvsl(<256 x double> %15, i64 %2, i32 %13)
