...
; ModuleID = 'gen/tests/pvfnmsb_vvvvl.c'
source_filename = "gen/tests/pvfnmsb_vvvvl.c"
...
define dso_local void @pvfnmsb_vvvvl(float* %0, float* %1, float* %2, float* %3, i32 signext %4) local_unnamed_addr #0 {
; CHECK: pvfnmsb %v0, %v0, %v1, %v2
  %6 = icmp sgt i32 %4, 0
...
8:                                                ; preds = %5, %8
  ...
  %24 = tail call <256 x double> @llvm.ve.vl.pvfnmsb.vvvvl(<256 x double> %19, <256 x double> %21, <256 x double> %23, i32 %17)
...
declare <256 x double> @llvm.ve.vl.pvfnmsb.vvvvl(<256 x double>, <256 x double>, <256 x double>, i32) #2
