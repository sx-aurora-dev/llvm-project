...
; ModuleID = 'gen/tests/vsrawsx_vvsl_imm.c'
source_filename = "gen/tests/vsrawsx_vvsl_imm.c"
...
define dso_local void @vsrawsx_vvsl_imm(i32* %0, i32* %1, i32 signext %2) local_unnamed_addr #0 {
; CHECK: vsra.w.sx %v0, %v0, 3
  %4 = icmp sgt i32 %2, 0
...
6:                                                ; preds = %3, %6
  ...
  %15 = tail call <256 x double> @llvm.ve.vl.vsrawsx.vvsl(<256 x double> %14, i32 3, i32 %12)
...
declare <256 x double> @llvm.ve.vl.vsrawsx.vvsl(<256 x double>, i32, i32) #2
