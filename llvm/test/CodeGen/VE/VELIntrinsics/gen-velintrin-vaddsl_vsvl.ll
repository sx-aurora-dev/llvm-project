...
; ModuleID = 'gen/tests/vaddsl_vsvl.c'
source_filename = "gen/tests/vaddsl_vsvl.c"
...
define dso_local void @vaddsl_vsvl(i64* %0, i64 %1, i64* %2, i32 signext %3) local_unnamed_addr #0 {
; CHECK: vadds.l %v0, %s1, %v0
  %5 = icmp sgt i32 %3, 0
...
7:                                                ; preds = %4, %7
  ...
  %16 = tail call <256 x double> @llvm.ve.vl.vaddsl.vsvl(i64 %1, <256 x double> %15, i32 %13)
