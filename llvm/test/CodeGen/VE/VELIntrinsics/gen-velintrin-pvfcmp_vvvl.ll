...
; ModuleID = 'gen/tests/pvfcmp_vvvl.c'
source_filename = "gen/tests/pvfcmp_vvvl.c"
...
define dso_local void @pvfcmp_vvvl(float* %0, float* %1, float* %2, i32 signext %3) local_unnamed_addr #0 {
...
declare <256 x double> @llvm.ve.vl.pvfcmp.vvvl(<256 x double>, <256 x double>, i32) #2
