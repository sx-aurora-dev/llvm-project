...
; ModuleID = 'gen/tests/vmrg_vvvml.c'
source_filename = "gen/tests/vmrg_vvvml.c"
...
define dso_local void @vmrg_vvvml(i64*, i64*, i64*, i32*, i32) local_unnamed_addr #0 {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vmrg.vvvml(<256 x double>, <256 x double>, <4 x i64>, i32) #2
