...
; ModuleID = 'gen/tests/vfcmps_vsvmvl.c'
source_filename = "gen/tests/vfcmps_vsvmvl.c"
...
define dso_local void @vfcmps_vsvmvl(float* %0, float %1, float* %2, i32* %3, float* %4, i32 signext %5) local_unnamed_addr #0 {
...
9:                                                ; preds = %6, %9
  ...
  %26 = tail call <256 x double> @llvm.ve.vl.vfcmps.vsvmvl(float %1, <256 x double> %19, <256 x i1> %22, <256 x double> %24, i32 %17)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vfcmps.vsvmvl(float, <256 x double>, <256 x i1>, <256 x double>, i32) #2
