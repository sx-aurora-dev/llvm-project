...
; ModuleID = 'gen/tests/vcvtwdsxrz_vvl.c'
source_filename = "gen/tests/vcvtwdsxrz_vvl.c"
...
define dso_local void @vcvtwdsxrz_vvl(i32* %0, double* %1, i32 signext %2) local_unnamed_addr #0 {
; CHECK: vcvt.w.d.sx.rz %v0, %v0
  %4 = icmp sgt i32 %2, 0
...
6:                                                ; preds = %3, %6
  ...
  %15 = tail call <256 x double> @llvm.ve.vl.vcvtwdsxrz.vvl(<256 x double> %14, i32 %12)
...
declare <256 x double> @llvm.ve.vl.vcvtwdsxrz.vvl(<256 x double>, i32) #2
