...
; ModuleID = 'gen/tests/vmulul_vIvmvl.c'
source_filename = "gen/tests/vmulul_vIvmvl.c"
...
define dso_local void @vmulul_vIvmvl(i64*, i64*, i32*, i64*, i32) local_unnamed_addr #0 {
