...
; ModuleID = 'gen/tests/vsubswzx_vIvmvl.c'
source_filename = "gen/tests/vsubswzx_vIvmvl.c"
...
define dso_local void @vsubswzx_vIvmvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
