...
; ModuleID = 'gen/tests/vfnmads_vsvvmvl.c'
source_filename = "gen/tests/vfnmads_vsvvmvl.c"
...
define dso_local void @vfnmads_vsvvmvl(float* %0, float %1, float* %2, float* %3, i32* %4, float* %5, i32 signext %6) local_unnamed_addr #0 {
...
10:                                               ; preds = %7, %10
  ...
  %30 = tail call <256 x double> @llvm.ve.vl.vfnmads.vsvvmvl(float %1, <256 x double> %21, <256 x double> %23, <256 x i1> %26, <256 x double> %28, i32 %19)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vfnmads.vsvvmvl(float, <256 x double>, <256 x double>, <256 x i1>, <256 x double>, i32) #2
