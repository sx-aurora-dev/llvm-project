...
; ModuleID = 'gen/tests/vfrmaxdfst_vvl.c'
source_filename = "gen/tests/vfrmaxdfst_vvl.c"
...
define dso_local void @vfrmaxdfst_vvl(double* %0, double* %1, i32 signext %2) local_unnamed_addr #0 {
...
6:                                                ; preds = %3, %6
  ...
  %15 = tail call <256 x double> @llvm.ve.vl.vfrmaxdfst.vvl(<256 x double> %14, i32 %12)
...
declare <256 x double> @llvm.ve.vl.vfrmaxdfst.vvl(<256 x double>, i32) #2
