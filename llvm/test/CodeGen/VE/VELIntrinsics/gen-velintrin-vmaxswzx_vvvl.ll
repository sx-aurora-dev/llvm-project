...
; ModuleID = 'gen/tests/vmaxswzx_vvvl.c'
source_filename = "gen/tests/vmaxswzx_vvvl.c"
...
define dso_local void @vmaxswzx_vvvl(i32* %0, i32* %1, i32* %2, i32 signext %3) local_unnamed_addr #0 {
; CHECK: vmaxs.w.zx %v0, %v0, %v1
  %5 = icmp sgt i32 %3, 0
...
7:                                                ; preds = %4, %7
  ...
  %19 = tail call <256 x double> @llvm.ve.vl.vmaxswzx.vvvl(<256 x double> %16, <256 x double> %18, i32 %14)
...
declare <256 x double> @llvm.ve.vl.vmaxswzx.vvvl(<256 x double>, <256 x double>, i32) #2
