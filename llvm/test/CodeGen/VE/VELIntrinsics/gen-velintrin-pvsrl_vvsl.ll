...
; ModuleID = 'gen/tests/pvsrl_vvsl.c'
source_filename = "gen/tests/pvsrl_vvsl.c"
...
define dso_local void @pvsrl_vvsl(i32* %0, i32* %1, i64 %2, i32 signext %3) local_unnamed_addr #0 {
...
7:                                                ; preds = %4, %7
  ...
  %17 = tail call <256 x double> @llvm.ve.vl.pvsrl.vvsl(<256 x double> %16, i64 %2, i32 %14)
...
declare <256 x double> @llvm.ve.vl.pvsrl.vvsl(<256 x double>, i64, i32) #2
