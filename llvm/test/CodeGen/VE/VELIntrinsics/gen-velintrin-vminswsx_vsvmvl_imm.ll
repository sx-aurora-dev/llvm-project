...
; ModuleID = 'gen/tests/vminswsx_vsvmvl_imm.c'
source_filename = "gen/tests/vminswsx_vsvmvl_imm.c"
...
define dso_local void @vminswsx_vsvmvl_imm(i32* %0, i32* %1, i32* %2, i32* %3, i32 signext %4) local_unnamed_addr #0 {
...
8:                                                ; preds = %5, %8
  ...
  %25 = tail call <256 x double> @llvm.ve.vl.vminswsx.vsvmvl(i32 3, <256 x double> %18, <256 x i1> %21, <256 x double> %23, i32 %16)
