...
; ModuleID = 'gen/tests/vfnmsbd_vvsvl.c'
source_filename = "gen/tests/vfnmsbd_vvsvl.c"
...
define dso_local void @vfnmsbd_vvsvl(double* %0, double* %1, double %2, double* %3, i32 signext %4) local_unnamed_addr #0 {
...
8:                                                ; preds = %5, %8
  ...
  %20 = tail call <256 x double> @llvm.ve.vl.vfnmsbd.vvsvl(<256 x double> %17, double %2, <256 x double> %19, i32 %15)
...
declare <256 x double> @llvm.ve.vl.vfnmsbd.vvsvl(<256 x double>, double, <256 x double>, i32) #2
