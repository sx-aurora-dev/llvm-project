...
; ModuleID = 'gen/tests/pvxor_vsvl.c'
source_filename = "gen/tests/pvxor_vsvl.c"
...
define dso_local void @pvxor_vsvl(i32* %0, i64 %1, i32* %2, i32 signext %3) local_unnamed_addr #0 {
; CHECK: pvxor %v0, %s1, %v0
  %5 = icmp sgt i32 %3, 0
...
7:                                                ; preds = %4, %7
  ...
  %17 = tail call <256 x double> @llvm.ve.vl.pvxor.vsvl(i64 %1, <256 x double> %16, i32 %14)
...
declare <256 x double> @llvm.ve.vl.pvxor.vsvl(i64, <256 x double>, i32) #2
