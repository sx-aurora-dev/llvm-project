...
; Function Attrs: nounwind readnone
define fastcc <256 x double> @vfaddd_vsvl(fp128 %0, <256 x double> %1) {
...
; CHECK-NEXT:    b.l.t (, %s10)
  ...
  %4 = tail call fast <256 x double> @llvm.ve.vl.vfaddd.vsvl(double %3, <256 x double> %1, i32 256)
  ret <256 x double> %4
}
...
; Function Attrs: nounwind readnone
define fastcc <256 x double> @vfaddd_vsvvl(fp128 %0, <256 x double> %1, <256 x double> %2) {
...
; CHECK-NEXT:    b.l.t (, %s10)
  ...
  %5 = tail call fast <256 x double> @llvm.ve.vl.vfaddd.vsvvl(double %4, <256 x double> %1, <256 x double> %2, i32 128)
  ret <256 x double> %5
}
...
; Function Attrs: nounwind readnone
define fastcc <256 x double> @vfaddd_vsvmvl(fp128 %0, <256 x double> %1, <256 x i1> %2, <256 x double> %3) {
...
; CHECK-NEXT:    b.l.t (, %s10)
  ...
  %6 = tail call fast <256 x double> @llvm.ve.vl.vfaddd.vsvmvl(double %5, <256 x double> %1, <256 x i1> %2, <256 x double> %3, i32 128)
  ret <256 x double> %6
}
...
; Function Attrs: nounwind readnone
define fastcc <256 x double> @vfadds_vsvl(double %0, <256 x double> %1) {
...
; CHECK-NEXT:    b.l.t (, %s10)
  ...
  %4 = tail call fast <256 x double> @llvm.ve.vl.vfadds.vsvl(float %3, <256 x double> %1, i32 256)
  ret <256 x double> %4
}
...
; Function Attrs: nounwind readnone
define fastcc <256 x double> @vfadds_vsvvl(double %0, <256 x double> %1, <256 x double> %2) {
...
; CHECK-NEXT:    b.l.t (, %s10)
  ...
  %5 = tail call fast <256 x double> @llvm.ve.vl.vfadds.vsvvl(float %4, <256 x double> %1, <256 x double> %2, i32 128)
  ret <256 x double> %5
}
...
; Function Attrs: nounwind readnone
define fastcc <256 x double> @vfadds_vsvmvl(double %0, <256 x double> %1, <256 x i1> %2, <256 x double> %3) {
...
; CHECK-NEXT:    b.l.t (, %s10)
  ...
  %6 = tail call fast <256 x double> @llvm.ve.vl.vfadds.vsvmvl(float %5, <256 x double> %1, <256 x i1> %2, <256 x double> %3, i32 128)
  ret <256 x double> %6
}
