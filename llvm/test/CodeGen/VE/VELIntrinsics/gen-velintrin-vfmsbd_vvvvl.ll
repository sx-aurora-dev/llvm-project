...
; ModuleID = 'gen/tests/vfmsbd_vvvvl.c'
source_filename = "gen/tests/vfmsbd_vvvvl.c"
...
define dso_local void @vfmsbd_vvvvl(double* %0, double* %1, double* %2, double* %3, i32 signext %4) local_unnamed_addr #0 {
...
8:                                                ; preds = %5, %8
  ...
  %23 = tail call <256 x double> @llvm.ve.vl.vfmsbd.vvvvl(<256 x double> %18, <256 x double> %20, <256 x double> %22, i32 %16)
...
declare <256 x double> @llvm.ve.vl.vfmsbd.vvvvl(<256 x double>, <256 x double>, <256 x double>, i32) #2
