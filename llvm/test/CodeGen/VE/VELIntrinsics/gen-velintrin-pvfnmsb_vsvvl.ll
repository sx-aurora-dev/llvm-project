...
; ModuleID = 'gen/tests/pvfnmsb_vsvvl.c'
source_filename = "gen/tests/pvfnmsb_vsvvl.c"
...
define dso_local void @pvfnmsb_vsvvl(float* %0, i64 %1, float* %2, float* %3, i32 signext %4) local_unnamed_addr #0 {
...
declare <256 x double> @llvm.ve.vl.pvfnmsb.vsvvl(i64, <256 x double>, <256 x double>, i32) #2
