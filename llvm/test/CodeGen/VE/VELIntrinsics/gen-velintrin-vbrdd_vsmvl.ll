...
; ModuleID = 'gen/tests/vbrdd_vsmvl.c'
source_filename = "gen/tests/vbrdd_vsmvl.c"
...
define dso_local void @vbrdd_vsmvl(double* %0, double %1, i32* %2, double* %3, i32 signext %4) local_unnamed_addr #0 {
...
8:                                                ; preds = %5, %8
  ...
  %22 = tail call <256 x double> @llvm.ve.vl.vbrdd.vsmvl(double %1, <256 x i1> %18, <256 x double> %20, i32 %15)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vbrdd.vsmvl(double, <256 x i1>, <256 x double>, i32) #2
