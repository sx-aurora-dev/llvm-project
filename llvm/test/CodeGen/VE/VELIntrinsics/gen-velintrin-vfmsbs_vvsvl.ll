...
; ModuleID = 'gen/tests/vfmsbs_vvsvl.c'
source_filename = "gen/tests/vfmsbs_vvsvl.c"
...
define dso_local void @vfmsbs_vvsvl(float* %0, float* %1, float %2, float* %3, i32 signext %4) local_unnamed_addr #0 {
; CHECK: vfmsb.s %v0, %v0, %s2, %v1
  %6 = icmp sgt i32 %4, 0
...
8:                                                ; preds = %5, %8
  ...
  %20 = tail call <256 x double> @llvm.ve.vl.vfmsbs.vvsvl(<256 x double> %17, float %2, <256 x double> %19, i32 %15)
...
declare <256 x double> @llvm.ve.vl.vfmsbs.vvsvl(<256 x double>, float, <256 x double>, i32) #2
