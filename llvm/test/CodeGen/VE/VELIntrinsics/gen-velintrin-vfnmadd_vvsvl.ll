...
; ModuleID = 'gen/tests/vfnmadd_vvsvl.c'
source_filename = "gen/tests/vfnmadd_vvsvl.c"
...
define dso_local void @vfnmadd_vvsvl(double* %0, double* %1, double %2, double* %3, i32 signext %4) local_unnamed_addr #0 {
...
declare <256 x double> @llvm.ve.vl.vfnmadd.vvsvl(<256 x double>, double, <256 x double>, i32) #2
