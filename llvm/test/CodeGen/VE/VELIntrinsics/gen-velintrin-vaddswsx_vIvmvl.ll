...
; ModuleID = 'gen/tests/vaddswsx_vIvmvl.c'
source_filename = "gen/tests/vaddswsx_vIvmvl.c"
...
define dso_local void @vaddswsx_vIvmvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
