...
; ModuleID = 'gen/tests/vbrdl_vsl_imm.c'
source_filename = "gen/tests/vbrdl_vsl_imm.c"
...
define dso_local void @vbrdl_vsl_imm(i64* %0, i32 signext %1) local_unnamed_addr #0 {
; CHECK: vbrd %v0, 3
  %3 = icmp sgt i32 %1, 0
