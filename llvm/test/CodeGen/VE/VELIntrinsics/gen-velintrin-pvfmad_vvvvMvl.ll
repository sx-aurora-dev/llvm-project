...
; ModuleID = 'gen/tests/pvfmad_vvvvMvl.c'
source_filename = "gen/tests/pvfmad_vvvvMvl.c"
...
define dso_local void @pvfmad_vvvvMvl(float* %0, float* %1, float* %2, float* %3, i32* %4, float* %5, i32 signext %6) local_unnamed_addr #0 {
...
10:                                               ; preds = %7, %10
  ...
  %34 = tail call <256 x double> @llvm.ve.vl.pvfmad.vvvvMvl(<256 x double> %23, <256 x double> %25, <256 x double> %27, <512 x i1> %30, <256 x double> %32, i32 %21)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.pvfmad.vvvvMvl(<256 x double>, <256 x double>, <256 x double>, <512 x i1>, <256 x double>, i32) #2
