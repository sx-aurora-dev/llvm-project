...
; ModuleID = 'gen/tests/vaddswzx_vIvmvl.c'
source_filename = "gen/tests/vaddswzx_vIvmvl.c"
...
define dso_local void @vaddswzx_vIvmvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
