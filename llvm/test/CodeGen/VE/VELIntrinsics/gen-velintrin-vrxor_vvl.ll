...
; ModuleID = 'gen/tests/vrxor_vvl.c'
source_filename = "gen/tests/vrxor_vvl.c"
...
define dso_local void @vrxor_vvl(i64* %0, i64* %1, i32 signext %2) local_unnamed_addr #0 {
; CHECK: vrxor %v0, %v0
  %4 = icmp sgt i32 %2, 0
...
6:                                                ; preds = %3, %6
  ...
  %15 = tail call <256 x double> @llvm.ve.vl.vrxor.vvl(<256 x double> %14, i32 %12)
...
declare <256 x double> @llvm.ve.vl.vrxor.vvl(<256 x double>, i32) #2
