...
; ModuleID = 'gen/tests/vdivsl_vvsmvl.c'
source_filename = "gen/tests/vdivsl_vvsmvl.c"
...
define dso_local void @vdivsl_vvsmvl(i64* %0, i64* %1, i64 %2, i32* %3, i64* %4, i32 signext %5) local_unnamed_addr #0 {
; CHECK: vdivs.l %v2, %v0, %s2, %vm1
  %7 = icmp sgt i32 %5, 0
...
9:                                                ; preds = %6, %9
  ...
  %26 = tail call <256 x double> @llvm.ve.vl.vdivsl.vvsmvl(<256 x double> %19, i64 %2, <256 x i1> %22, <256 x double> %24, i32 %17)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vdivsl.vvsmvl(<256 x double>, i64, <256 x i1>, <256 x double>, i32) #2
