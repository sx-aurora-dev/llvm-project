...
; ModuleID = 'gen/tests/vrminswfstsx_vv.c'
source_filename = "gen/tests/vrminswfstsx_vv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vrminswfstsx_vv(i32* %pvx, i32* %pvy, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vrminswfstsx_vv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %2 = tail call <256 x double> @llvm.ve.vrminswfstsx.vv(<256 x double> %1)
...
declare <256 x double> @llvm.ve.vrminswfstsx.vv(<256 x double>) #3
