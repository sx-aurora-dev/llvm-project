...
; ModuleID = 'gen/tests/vbrdl_vs_i32.c'
source_filename = "gen/tests/vbrdl_vs_i32.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vbrdl_vs_i32(i32* %pvx, i32 %sy, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vbrdl_vs_i32
; CHECK: .LBB0_2
; CHECK: 	vbrdl %v0,%s1
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %0 = tail call <256 x double> @llvm.ve.vbrdl.vs.i32(i32 %sy)
...
declare <256 x double> @llvm.ve.vbrdl.vs.i32(i32) #2

; Function Attrs: nounwind writeonly
declare void @llvm.ve.vstl.vss(<256 x double>, i64, i8*) #3
