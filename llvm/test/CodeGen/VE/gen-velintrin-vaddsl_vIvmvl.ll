...
; ModuleID = 'gen/tests/vaddsl_vIvmvl.c'
source_filename = "gen/tests/vaddsl_vIvmvl.c"
...
define dso_local void @vaddsl_vIvmvl(i64*, i64*, i32*, i64*, i32) local_unnamed_addr #0 {
