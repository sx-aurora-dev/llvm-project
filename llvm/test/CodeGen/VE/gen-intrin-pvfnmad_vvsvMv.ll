...
define void @pvfnmad_vvsvMv(float* %pvx, float* %pvy, i64 %sy, float* %pvw, i32* %pvm, float* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.pvfnmad.vvsvMv(<256 x double>, i64, <256 x double>, <8 x i64>, <256 x double>)
