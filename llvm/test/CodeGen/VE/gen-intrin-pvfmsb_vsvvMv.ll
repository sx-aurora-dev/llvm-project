...
; ModuleID = 'gen/tests/pvfmsb_vsvvMv.c'
source_filename = "gen/tests/pvfmsb_vsvvMv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvfmsb_vsvvMv(float* %pvx, i64 %sy, float* %pvz, float* %pvw, i32* %pvm, float* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: pvfmsb_vsvvMv
; CHECK: .LBB0_2
; CHECK: 	pvfmsb %v3,%s1,%v0,%v1,%vm2
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %10 = tail call <256 x double> @llvm.ve.pvfmsb.vsvvMv(i64 %sy, <256 x double> %2, <256 x double> %4, <8 x i64> %7, <256 x double> %9)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.pvfmsb.vsvvMv(i64, <256 x double>, <256 x double>, <8 x i64>, <256 x double>) #3
