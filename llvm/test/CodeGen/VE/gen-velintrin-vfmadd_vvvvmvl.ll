...
10:                                               ; preds = %7, %10
  ...
  %33 = tail call <256 x double> @llvm.ve.vl.vfmadd.vvvvmvl(<256 x double> %22, <256 x double> %24, <256 x double> %26, <4 x i64> %29, <256 x double> %31, i32 %20)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vfmadd.vvvvmvl(<256 x double>, <256 x double>, <256 x double>, <4 x i64>, <256 x double>, i32) #2
