...
; ModuleID = 'gen/tests/vfnmads_vvsvmv.c'
source_filename = "gen/tests/vfnmads_vvsvmv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vfnmads_vvsvmv(float* %pvx, float* %pvy, float %sy, float* %pvw, i32* %pvm, float* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vfnmads_vvsvmv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %9 = tail call <256 x double> @llvm.ve.vfnmads.vvsvmv(<256 x double> %1, float %sy, <256 x double> %3, <4 x i64> %6, <256 x double> %8)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vfnmads.vvsvmv(<256 x double>, float, <256 x double>, <4 x i64>, <256 x double>) #3
