...
; CHECK-NEXT:    cmov.d.gtnan %s1, %s0, %s34
...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:    fcmp.d %s34, %s0, %s1
; CHECK-NEXT:    cmov.d.genan %s1, %s0, %s34
; CHECK-NEXT:    or %s0, 0, %s1
...
; CHECK-NEXT:    cmov.s.gtnan %s1, %s0, %s34
; CHECK-NEXT:    or %s0, 0, %s1
...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:    fcmp.s %s34, %s0, %s1
; CHECK-NEXT:    cmov.s.genan %s1, %s0, %s34
; CHECK-NEXT:    or %s0, 0, %s1
...
; CHECK-LABEL: maxu64:
; CHECK:       .LBB{{[0-9]+}}_2:
; CHEKC-NEXT:    cmpu.l %s34, %s0, %s1
; CHEKC-NEXT:    cmov.l.gt %s1, %s0, %s34
; CHEKC-NEXT:    or %s0, 0, %s1
  %3 = icmp ugt i64 %0, %1
  %4 = select i1 %3, i64 %0, i64 %1
  ret i64 %4
}
...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHEKC-NEXT:    cmpu.l %s34, %s0, %s1
; CHEKC-NEXT:    cmov.l.ge %s1, %s0, %s34
; CHEKC-NEXT:    or %s0, 0, %s1
  %3 = icmp uge i64 %0, %1
  %4 = select i1 %3, i64 %0, i64 %1
  ret i64 %4
...
; CHECK-NEXT:    cmov.w.gt %s1, %s0, %s34
; CHECK-NEXT:    or %s0, 0, %s1
  %3 = icmp ugt i32 %0, %1
  %4 = select i1 %3, i32 %0, i32 %1
  ret i32 %4
...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:    cmpu.w %s34, %s0, %s1
; CHECK-NEXT:    cmov.w.ge %s1, %s0, %s34
; CHECK-NEXT:    or %s0, 0, %s1
  %3 = icmp uge i32 %0, %1
  %4 = select i1 %3, i32 %0, i32 %1
  ret i32 %4
