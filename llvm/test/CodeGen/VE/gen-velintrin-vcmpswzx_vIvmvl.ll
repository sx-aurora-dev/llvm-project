...
; ModuleID = 'gen/tests/vcmpswzx_vIvmvl.c'
source_filename = "gen/tests/vcmpswzx_vIvmvl.c"
...
define dso_local void @vcmpswzx_vIvmvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
