...
; ModuleID = 'gen/tests/vsfa_vvIsmvl.c'
source_filename = "gen/tests/vsfa_vvIsmvl.c"
...
define dso_local void @vsfa_vvIsmvl(i64*, i64*, i64, i32*, i64*, i32) local_unnamed_addr #0 {
