...
define void @pvfmul_vvvMv(float* %pvx, float* %pvy, float* %pvz, i32* %pvm, float* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.pvfmul.vvvMv(<256 x double>, <256 x double>, <8 x i64>, <256 x double>)
