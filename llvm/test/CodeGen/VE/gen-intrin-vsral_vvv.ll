...
; ModuleID = 'gen/tests/vsral_vvv.c'
source_filename = "gen/tests/vsral_vvv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vsral_vvv(i64* %pvx, i64* %pvz, i64* %pvy, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vsral_vvv
; CHECK: .LBB0_2
; CHECK: 	vsra.l %v0,%v0,%v1
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %pvz.addr.021 = phi i64* [ %add.ptr3, %for.body ], [ %pvz, %entry ]
  %pvy.addr.020 = phi i64* [ %add.ptr4, %for.body ], [ %pvy, %entry ]
  ...
  %0 = bitcast i64* %pvz.addr.021 to i8*
  %1 = tail call <256 x double> @llvm.ve.vld.vss(i64 8, i8* %0)
  %2 = bitcast i64* %pvy.addr.020 to i8*
  %3 = tail call <256 x double> @llvm.ve.vld.vss(i64 8, i8* %2)
  %4 = tail call <256 x double> @llvm.ve.vsral.vvv(<256 x double> %1, <256 x double> %3)
  ...
  %add.ptr3 = getelementptr inbounds i64, i64* %pvz.addr.021, i64 256
  %add.ptr4 = getelementptr inbounds i64, i64* %pvy.addr.020, i64 256
...
declare <256 x double> @llvm.ve.vsral.vvv(<256 x double>, <256 x double>) #3
