...
; ModuleID = 'gen/tests/vsubswzx_vsvmv.c'
source_filename = "gen/tests/vsubswzx_vsvmv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vsubswzx_vsvmv(i32* %pvx, i32 %sy, i32* %pvz, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vsubswzx_vsvmv
; CHECK: .LBB0_2
; CHECK: 	vsubs.w.zx %v2,%s1,%v0,%vm1
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %7 = tail call <256 x double> @llvm.ve.vsubswzx.vsvmv(i32 %sy, <256 x double> %1, <4 x i64> %4, <256 x double> %6)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vsubswzx.vsvmv(i32, <256 x double>, <4 x i64>, <256 x double>) #3
