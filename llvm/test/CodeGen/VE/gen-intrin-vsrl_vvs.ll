...
; ModuleID = 'gen/tests/vsrl_vvs.c'
source_filename = "gen/tests/vsrl_vvs.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vsrl_vvs(i64* %pvx, i64* %pvz, i64 %sy, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vsrl_vvs
; CHECK: .LBB0_2
; CHECK: 	vsrl %v0,%v0,%s2
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %2 = tail call <256 x double> @llvm.ve.vsrl.vvs(<256 x double> %1, i64 %sy)
...
declare <256 x double> @llvm.ve.vsrl.vvs(<256 x double>, i64) #3
