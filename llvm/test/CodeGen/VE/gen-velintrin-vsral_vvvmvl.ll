...
9:                                                ; preds = %6, %9
  ...
  %29 = tail call <256 x double> @llvm.ve.vl.vsral.vvvmvl(<256 x double> %20, <256 x double> %22, <4 x i64> %25, <256 x double> %27, i32 %18)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vsral.vvvmvl(<256 x double>, <256 x double>, <4 x i64>, <256 x double>, i32) #2
