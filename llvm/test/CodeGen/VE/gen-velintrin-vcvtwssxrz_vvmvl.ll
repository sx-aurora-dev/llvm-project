...
8:                                                ; preds = %5, %8
  ...
  %25 = tail call <256 x double> @llvm.ve.vl.vcvtwssxrz.vvmvl(<256 x double> %18, <4 x i64> %21, <256 x double> %23, i32 %16)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vcvtwssxrz.vvmvl(<256 x double>, <4 x i64>, <256 x double>, i32) #2
