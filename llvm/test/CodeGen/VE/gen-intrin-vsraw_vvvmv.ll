...
define void @vsraw_vvvmv(i32* %pvx, i32* %pvz, i64* %pvy, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vsraw.vvvmv(<256 x double>, <256 x double>, <4 x i64>, <256 x double>)
