...
; ModuleID = 'gen/tests/vminswsx_vIvmvl.c'
source_filename = "gen/tests/vminswsx_vIvmvl.c"
...
define dso_local void @vminswsx_vIvmvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
