...
; ModuleID = 'gen/tests/vfmuls_vvv.c'
source_filename = "gen/tests/vfmuls_vvv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vfmuls_vvv(float* %pvx, float* %pvy, float* %pvz, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vfmuls_vvv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %4 = tail call <256 x double> @llvm.ve.vfmuls.vvv(<256 x double> %1, <256 x double> %3)
...
declare <256 x double> @llvm.ve.vfmuls.vvv(<256 x double>, <256 x double>) #3
