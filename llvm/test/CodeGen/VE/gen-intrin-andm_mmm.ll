...
define dso_local void @andm_mmm(i64* nocapture %px, i64* nocapture readonly %py, i64* nocapture readonly %pz, i32 %n) local_unnamed_addr #0 {
...
entry:
  ...
  %16 = tail call <4 x i64> @llvm.ve.andm.mmm(<4 x i64> %13, <4 x i64> %15)
...
; Function Attrs: nounwind readnone
declare <4 x i64> @llvm.ve.andm.mmm(<4 x i64>, <4 x i64>) #1
