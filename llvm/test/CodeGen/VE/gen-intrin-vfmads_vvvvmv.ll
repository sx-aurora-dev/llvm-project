...
; ModuleID = 'gen/tests/vfmads_vvvvmv.c'
source_filename = "gen/tests/vfmads_vvvvmv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vfmads_vvvvmv(float* %pvx, float* %pvy, float* %pvz, float* %pvw, i32* %pvm, float* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vfmads_vvvvmv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %11 = tail call <256 x double> @llvm.ve.vfmads.vvvvmv(<256 x double> %1, <256 x double> %3, <256 x double> %5, <4 x i64> %8, <256 x double> %10)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vfmads.vvvvmv(<256 x double>, <256 x double>, <256 x double>, <4 x i64>, <256 x double>) #3
