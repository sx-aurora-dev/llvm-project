...
define void @vfmads_vvvvmv(float* %pvx, float* %pvy, float* %pvz, float* %pvw, i32* %pvm, float* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vfmads.vvvvmv(<256 x double>, <256 x double>, <256 x double>, <4 x i64>, <256 x double>)
