...
; ModuleID = 'gen/tests/vbrd_vsmv_f64.c'
source_filename = "gen/tests/vbrd_vsmv_f64.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vbrd_vsmv_f64(double* %pvx, double %sy, i32* %pvm, double* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vbrd_vsmv_f64
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  %pvx.addr.021 = phi double* [ %add.ptr, %for.body ], [ %pvx, %entry ]
  ...
  %3 = bitcast double* %pvx.addr.021 to i8*
  %4 = tail call <256 x double> @llvm.ve.vld.vss(i64 8, i8* %3)
  %5 = tail call <256 x double> @llvm.ve.vbrd.vsmv.f64(double %sy, <4 x i64> %2, <256 x double> %4)
  tail call void @llvm.ve.vst.vss(<256 x double> %5, i64 8, i8* %3)
  %add.ptr = getelementptr inbounds double, double* %pvx.addr.021, i64 256
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vbrd.vsmv.f64(double, <4 x i64>, <256 x double>) #3
