...
define void @vbrd_vsmv_f64(double* %pvx, double %sy, i32* %pvm, double* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vbrd.vsmv.f64(double, <4 x i64>, <256 x double>)
