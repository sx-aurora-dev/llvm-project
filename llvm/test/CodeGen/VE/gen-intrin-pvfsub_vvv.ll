...
; ModuleID = 'gen/tests/pvfsub_vvv.c'
source_filename = "gen/tests/pvfsub_vvv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvfsub_vvv(float* %pvx, float* %pvy, float* %pvz, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: pvfsub_vvv
; CHECK: .LBB0_2
; CHECK: 	pvfsub %v0,%v0,%v1
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %pvz.addr.021 = phi float* [ %add.ptr5, %for.body ], [ %pvz, %entry ]
  ...
  %3 = bitcast float* %pvz.addr.021 to i8*
  %4 = tail call <256 x double> @llvm.ve.vld.vss(i64 8, i8* %3)
  %5 = tail call <256 x double> @llvm.ve.pvfsub.vvv(<256 x double> %2, <256 x double> %4)
  ...
  %add.ptr5 = getelementptr inbounds float, float* %pvz.addr.021, i64 512
...
declare <256 x double> @llvm.ve.pvfsub.vvv(<256 x double>, <256 x double>) #3
