...
define void @vadduw_vsvmv(i32* %pvx, i32 %sy, i32* %pvz, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vadduw.vsvmv(i32, <256 x double>, <4 x i64>, <256 x double>)
