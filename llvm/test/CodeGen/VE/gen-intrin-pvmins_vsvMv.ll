...
define void @pvmins_vsvMv(i32* %pvx, i64 %sy, i32* %pvz, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.pvmins.vsvMv(i64, <256 x double>, <8 x i64>, <256 x double>)
