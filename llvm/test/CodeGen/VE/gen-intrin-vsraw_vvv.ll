...
; ModuleID = 'gen/tests/vsraw_vvv.c'
source_filename = "gen/tests/vsraw_vvv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vsraw_vvv(i32* %pvx, i32* %pvz, i64* %pvy, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vsraw_vvv
; CHECK: .LBB0_2
; CHECK: 	vsra.w %v0,%v0,%v1
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %4 = tail call <256 x double> @llvm.ve.vsraw.vvv(<256 x double> %1, <256 x double> %3)
...
declare <256 x double> @llvm.ve.vsraw.vvv(<256 x double>, <256 x double>) #3
