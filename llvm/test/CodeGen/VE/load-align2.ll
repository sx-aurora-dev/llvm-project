...
; CHECK-NEXT:    ld %s0, (, %s0)
; CHECK-NEXT:    b.l.t (, %s10)
  %2 = load double, double* %0, align 2
  ret double %2
}
...
; CHECK-NEXT:    or %s11, 0, %s9
  ...
  %1 = load fp128, fp128* %addr, align 2
  ret fp128 %1
}
...
; CHECK-NEXT:    ld %s1, (, %s2)
; CHECK-NEXT:    b.l.t (, %s10)
  %1 = load fp128, fp128* @vf128, align 2
  ret fp128 %1
}
...
; CHECK-NEXT:    b.l.t (, %s10)
  %1 = load i128, i128* @vi128, align 2
  ret i128 %1
}
