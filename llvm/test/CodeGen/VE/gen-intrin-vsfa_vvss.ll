...
; ModuleID = 'gen/tests/vsfa_vvss.c'
source_filename = "gen/tests/vsfa_vvss.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vsfa_vvss(i64* %pvx, i64* %pvz, i64 %sy, i64 %sz, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vsfa_vvss
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %2 = tail call <256 x double> @llvm.ve.vsfa.vvss(<256 x double> %1, i64 %sy, i64 %sz)
