...
define dso_local void @orm_MMM(i64* nocapture %px, i64* nocapture readonly %py, i64* nocapture readonly %pz, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: orm_MMM
; CHECK: .LBB0_2
...
entry:
  ...
  %32 = tail call <8 x i64> @llvm.ve.orm.MMM(<8 x i64> %29, <8 x i64> %31)
...
; Function Attrs: nounwind readnone
declare <8 x i64> @llvm.ve.orm.MMM(<8 x i64>, <8 x i64>) #1
