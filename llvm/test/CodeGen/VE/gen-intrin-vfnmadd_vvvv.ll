...
; ModuleID = 'gen/tests/vfnmadd_vvvv.c'
source_filename = "gen/tests/vfnmadd_vvvv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vfnmadd_vvvv(double* %pvx, double* %pvy, double* %pvz, double* %pvw, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vfnmadd_vvvv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %6 = tail call <256 x double> @llvm.ve.vfnmadd.vvvv(<256 x double> %1, <256 x double> %3, <256 x double> %5)
...
declare <256 x double> @llvm.ve.vfnmadd.vvvv(<256 x double>, <256 x double>, <256 x double>) #3
