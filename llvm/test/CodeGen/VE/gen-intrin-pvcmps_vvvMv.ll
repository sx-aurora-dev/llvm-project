...
define void @pvcmps_vvvMv(i32* %pvx, i32* %pvy, i32* %pvz, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.pvcmps.vvvMv(<256 x double>, <256 x double>, <8 x i64>, <256 x double>)
