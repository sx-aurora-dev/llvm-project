...
; ModuleID = 'gen/tests/pveqv_vvv.c'
source_filename = "gen/tests/pveqv_vvv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pveqv_vvv(i32* %pvx, i32* %pvy, i32* %pvz, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: pveqv_vvv
; CHECK: .LBB0_2
; CHECK: 	pveqv %v0,%v0,%v1
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %5 = tail call <256 x double> @llvm.ve.pveqv.vvv(<256 x double> %2, <256 x double> %4)
...
declare <256 x double> @llvm.ve.pveqv.vvv(<256 x double>, <256 x double>) #3
