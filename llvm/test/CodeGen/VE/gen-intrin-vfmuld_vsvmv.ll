...
define void @vfmuld_vsvmv(double* %pvx, double %sy, double* %pvz, i32* %pvm, double* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vfmuld.vsvmv(double, <256 x double>, <4 x i64>, <256 x double>)
