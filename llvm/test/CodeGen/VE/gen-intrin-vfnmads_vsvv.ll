...
; ModuleID = 'gen/tests/vfnmads_vsvv.c'
source_filename = "gen/tests/vfnmads_vsvv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vfnmads_vsvv(float* %pvx, float %sy, float* %pvz, float* %pvw, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vfnmads_vsvv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %4 = tail call <256 x double> @llvm.ve.vfnmads.vsvv(float %sy, <256 x double> %1, <256 x double> %3)
...
declare <256 x double> @llvm.ve.vfnmads.vsvv(float, <256 x double>, <256 x double>) #3
