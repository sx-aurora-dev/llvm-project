...
; ModuleID = 'gen/tests/vsrawzx_vvsmvl_imm.c'
source_filename = "gen/tests/vsrawzx_vvsmvl_imm.c"
...
define dso_local void @vsrawzx_vvsmvl_imm(i32* %0, i32* %1, i32* %2, i32* %3, i32 signext %4) local_unnamed_addr #0 {
; CHECK: vsra.w.zx %v2, %v0, 3, %vm1
  %6 = icmp sgt i32 %4, 0
...
8:                                                ; preds = %5, %8
  ...
  %25 = tail call <256 x double> @llvm.ve.vl.vsrawzx.vvsmvl(<256 x double> %18, i64 3, <4 x i64> %21, <256 x double> %23, i32 %16)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vsrawzx.vvsmvl(<256 x double>, i64, <4 x i64>, <256 x double>, i32) #2
