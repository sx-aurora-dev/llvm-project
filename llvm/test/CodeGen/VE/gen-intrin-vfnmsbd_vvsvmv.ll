...
; ModuleID = 'gen/tests/vfnmsbd_vvsvmv.c'
source_filename = "gen/tests/vfnmsbd_vvsvmv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vfnmsbd_vvsvmv(double* %pvx, double* %pvy, double %sy, double* %pvw, i32* %pvm, double* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vfnmsbd_vvsvmv
; CHECK: .LBB0_2
; CHECK: 	vfnmsb.d %v3,%v0,%s2,%v1,%vm1
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %9 = tail call <256 x double> @llvm.ve.vfnmsbd.vvsvmv(<256 x double> %1, double %sy, <256 x double> %3, <4 x i64> %6, <256 x double> %8)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vfnmsbd.vvsvmv(<256 x double>, double, <256 x double>, <4 x i64>, <256 x double>) #3
