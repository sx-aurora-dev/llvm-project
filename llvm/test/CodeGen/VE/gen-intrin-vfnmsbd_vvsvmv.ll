...
define void @vfnmsbd_vvsvmv(double* %pvx, double* %pvy, double %sy, double* %pvw, i32* %pvm, double* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vfnmsbd.vvsvmv(<256 x double>, double, <256 x double>, <4 x i64>, <256 x double>)
