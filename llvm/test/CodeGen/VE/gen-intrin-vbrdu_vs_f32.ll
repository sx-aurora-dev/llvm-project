...
; ModuleID = 'gen/tests/vbrdu_vs_f32.c'
source_filename = "gen/tests/vbrdu_vs_f32.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vbrdu_vs_f32(float* %pvx, float %sy, i32 %n) local_unnamed_addr #0 {
...
declare <256 x double> @llvm.ve.vbrdu.vs.f32(float) #2

; Function Attrs: nounwind writeonly
declare void @llvm.ve.vstu.vss(<256 x double>, i64, i8*) #3
