...
; ModuleID = 'gen/tests/vsraw_vvImv.c'
source_filename = "gen/tests/vsraw_vvImv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vsraw_vvImv(i32* %pvx, i32* %pvz, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vsraw_vvImv
; CHECK: .LBB0_2
; CHECK: 	vsra.w %v2,%v0,3,%vm1
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %7 = tail call <256 x double> @llvm.ve.vsraw.vvsmv(<256 x double> %1, i64 3, <4 x i64> %4, <256 x double> %6)
