...
define void @vmulsl_vvvmv(i64* %pvx, i64* %pvy, i64* %pvz, i32* %pvm, i64* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vmulsl.vvvmv(<256 x double>, <256 x double>, <4 x i64>, <256 x double>)
