...
; ModuleID = 'gen/tests/vdivul_vvI.c'
source_filename = "gen/tests/vdivul_vvI.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vdivul_vvI(i64* %pvx, i64* %pvy, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vdivul_vvI
; CHECK: .LBB0_2
; CHECK: 	vdivu.l %v0,%v0,3
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %2 = tail call <256 x double> @llvm.ve.vdivul.vvs(<256 x double> %1, i64 3)
