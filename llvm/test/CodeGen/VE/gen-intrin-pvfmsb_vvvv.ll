...
; ModuleID = 'gen/tests/pvfmsb_vvvv.c'
source_filename = "gen/tests/pvfmsb_vvvv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvfmsb_vvvv(float* %pvx, float* %pvy, float* %pvz, float* %pvw, i32 %n) local_unnamed_addr #0 {
...
declare <256 x double> @llvm.ve.pvfmsb.vvvv(<256 x double>, <256 x double>, <256 x double>) #3
