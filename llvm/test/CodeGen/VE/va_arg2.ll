...
; CHECK-NEXT:  lea %s34, 199(%s9)
; CHECK-NEXT:  and %s34, -16, %s34
; CHECK-NEXT:  lea %s35, 16(%s34)
; CHECK-NEXT:  st %s35, -16(,%s9)
; CHECK-NEXT:  or %s35, 8, %s34
; CHECK-NEXT:  ld %s2, (,%s35)
; CHECK-NEXT:  ld %s3, (,%s34)
; CHECK-NEXT:  lea %s35, 24(%s34)
; CHECK-NEXT:  st %s35, -16(,%s9)
; CHECK-NEXT:  ld %s35, 16(,%s34)
; CHECK-NEXT:  ldl.sx %s19, (,%s35)
; CHECK-NEXT:  ldl.sx %s21, 4(,%s35)
; CHECK-NEXT:  lea %s35, 32(%s34)
; CHECK-NEXT:  st %s35, -16(,%s9)
; CHECK-NEXT:  ld %s35, 24(,%s34)
; CHECK-NEXT:  ld %s24, 8(,%s35)
; CHECK-NEXT:  ld %s25, (,%s35)
; CHECK-NEXT:  ld %s22, 24(,%s35)
; CHECK-NEXT:  ld %s23, 16(,%s35)
; CHECK-NEXT:  lea %s35, 40(%s34)
; CHECK-NEXT:  st %s35, -16(,%s9)
; CHECK-NEXT:  ld %s35, 32(,%s34)
; CHECK-NEXT:  ld %s26, (,%s35)
; CHECK-NEXT:  ld %s27, 8(,%s35)
; CHECK-NEXT:  lea %s35, 48(%s34)
; CHECK-NEXT:  st %s35, -16(,%s9)
; CHECK-NEXT:  ld %s34, 40(,%s34)
; CHECK-NEXT:  ldu %s28, (,%s34)
; CHECK-NEXT:  ldu %s29, 4(,%s34)
