...
; ModuleID = 'gen/tests/vdivsl_vsv.c'
source_filename = "gen/tests/vdivsl_vsv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vdivsl_vsv(i64* %pvx, i64 %sy, i64* %pvz, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vdivsl_vsv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %2 = tail call <256 x double> @llvm.ve.vdivsl.vsv(i64 %sy, <256 x double> %1)
...
declare <256 x double> @llvm.ve.vdivsl.vsv(i64, <256 x double>) #3
