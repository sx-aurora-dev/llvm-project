...
; ModuleID = 'gen/tests/vdivswsx_vIvmv.c'
source_filename = "gen/tests/vdivswsx_vIvmv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vdivswsx_vIvmv(i32* %pvx, i32* %pvz, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vdivswsx_vIvmv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %7 = tail call <256 x double> @llvm.ve.vdivswsx.vsvmv(i32 3, <256 x double> %1, <4 x i64> %4, <256 x double> %6)
