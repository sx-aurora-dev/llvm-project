...
; ModuleID = 'gen/tests/vmaxswzx_vIvmvl.c'
source_filename = "gen/tests/vmaxswzx_vIvmvl.c"
...
define dso_local void @vmaxswzx_vIvmvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
