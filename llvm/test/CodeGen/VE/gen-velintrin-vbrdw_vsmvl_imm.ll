...
7:                                                ; preds = %4, %7
  ...
  %21 = tail call <256 x double> @llvm.ve.vl.vbrdw.vsmvl(i32 3, <4 x i64> %17, <256 x double> %19, i32 %14)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vbrdw.vsmvl(i32, <4 x i64>, <256 x double>, i32) #2
