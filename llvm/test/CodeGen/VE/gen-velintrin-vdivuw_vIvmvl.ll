...
; ModuleID = 'gen/tests/vdivuw_vIvmvl.c'
source_filename = "gen/tests/vdivuw_vIvmvl.c"
...
define dso_local void @vdivuw_vIvmvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
