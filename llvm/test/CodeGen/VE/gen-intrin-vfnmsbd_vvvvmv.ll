...
; ModuleID = 'gen/tests/vfnmsbd_vvvvmv.c'
source_filename = "gen/tests/vfnmsbd_vvvvmv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vfnmsbd_vvvvmv(double* %pvx, double* %pvy, double* %pvz, double* %pvw, i32* %pvm, double* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vfnmsbd_vvvvmv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %11 = tail call <256 x double> @llvm.ve.vfnmsbd.vvvvmv(<256 x double> %1, <256 x double> %3, <256 x double> %5, <4 x i64> %8, <256 x double> %10)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vfnmsbd.vvvvmv(<256 x double>, <256 x double>, <256 x double>, <4 x i64>, <256 x double>) #3
