...
; CHECK-NEXT:  or %s11, 0, %s9
  ...
  %1 = load fp128, fp128* %addr, align 8
  ret fp128 %1
}
...
; CHECK-NEXT:  or %s11, 0, %s9
  %1 = load fp128, fp128* @vf128, align 8
  ret fp128 %1
}
...
; CHECK-NEXT:  or %s11, 0, %s9
  %1 = load i128, i128* @vi128, align 8
  ret i128 %1
}
