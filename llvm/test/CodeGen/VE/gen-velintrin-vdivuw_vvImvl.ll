...
; ModuleID = 'gen/tests/vdivuw_vvImvl.c'
source_filename = "gen/tests/vdivuw_vvImvl.c"
...
define dso_local void @vdivuw_vvImvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
