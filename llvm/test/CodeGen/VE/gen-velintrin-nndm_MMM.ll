...
define dso_local void @nndm_MMM(i64* nocapture %0, i64* nocapture readonly %1, i64* nocapture readonly %2, i32 signext %3) local_unnamed_addr #0 {
...
; CHECK: nndm %vm3, %vm3, %vm5
  ...
  %51 = tail call <8 x i64> @llvm.ve.vl.nndm.MMM(<8 x i64> %47, <8 x i64> %50)
...
; Function Attrs: nounwind readnone
declare <8 x i64> @llvm.ve.vl.nndm.MMM(<8 x i64>, <8 x i64>) #1
