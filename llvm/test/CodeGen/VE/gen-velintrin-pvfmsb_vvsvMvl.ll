...
10:                                               ; preds = %7, %10
  ...
  %31 = tail call <256 x double> @llvm.ve.vl.pvfmsb.vvsvMvl(<256 x double> %22, i64 %2, <256 x double> %24, <8 x i64> %27, <256 x double> %29, i32 %20)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.pvfmsb.vvsvMvl(<256 x double>, i64, <256 x double>, <8 x i64>, <256 x double>, i32) #2
