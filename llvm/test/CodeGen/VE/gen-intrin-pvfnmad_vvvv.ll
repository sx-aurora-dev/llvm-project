...
define void @pvfnmad_vvvv(float* %pvx, float* %pvy, float* %pvz, float* %pvw, i32 %n) {
...
declare <256 x double> @llvm.ve.pvfnmad.vvvv(<256 x double>, <256 x double>, <256 x double>)
