...
; ModuleID = 'gen/tests/pvfnmad_vsvvMv.c'
source_filename = "gen/tests/pvfnmad_vsvvMv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvfnmad_vsvvMv(float* %pvx, i64 %sy, float* %pvz, float* %pvw, i32* %pvm, float* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: pvfnmad_vsvvMv
; CHECK: .LBB0_2
; CHECK: 	pvfnmad %v3,%s1,%v0,%v1,%vm2
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %pvz.addr.029 = phi float* [ %add.ptr4, %for.body ], [ %pvz, %entry ]
  ...
  %1 = bitcast float* %pvz.addr.029 to i8*
  ...
  %10 = tail call <256 x double> @llvm.ve.pvfnmad.vsvvMv(i64 %sy, <256 x double> %2, <256 x double> %4, <8 x i64> %7, <256 x double> %9)
  tail call void @llvm.ve.vst.vss(<256 x double> %10, i64 8, i8* %8)
  %add.ptr = getelementptr inbounds float, float* %pvx.addr.030, i64 512
  %add.ptr4 = getelementptr inbounds float, float* %pvz.addr.029, i64 512
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.pvfnmad.vsvvMv(i64, <256 x double>, <256 x double>, <8 x i64>, <256 x double>) #3
