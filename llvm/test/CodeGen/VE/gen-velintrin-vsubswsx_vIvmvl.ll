...
; ModuleID = 'gen/tests/vsubswsx_vIvmvl.c'
source_filename = "gen/tests/vsubswsx_vIvmvl.c"
...
define dso_local void @vsubswsx_vIvmvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
