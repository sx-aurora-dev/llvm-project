...
; ModuleID = 'gen/tests/vfcmpd_vsvmv.c'
source_filename = "gen/tests/vfcmpd_vsvmv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vfcmpd_vsvmv(double* %pvx, double %sy, double* %pvz, i32* %pvm, double* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vfcmpd_vsvmv
; CHECK: .LBB0_2
; CHECK: 	vfcmp.d %v2,%s1,%v0,%vm1
entry:
...
for.body:                                         ; preds = %entry, %for.body
  %pvx.addr.025 = phi double* [ %add.ptr, %for.body ], [ %pvx, %entry ]
  %pvz.addr.024 = phi double* [ %add.ptr3, %for.body ], [ %pvz, %entry ]
  ...
  %0 = bitcast double* %pvz.addr.024 to i8*
  ...
  %5 = bitcast double* %pvx.addr.025 to i8*
  %6 = tail call <256 x double> @llvm.ve.vld.vss(i64 8, i8* %5)
  %7 = tail call <256 x double> @llvm.ve.vfcmpd.vsvmv(double %sy, <256 x double> %1, <4 x i64> %4, <256 x double> %6)
  tail call void @llvm.ve.vst.vss(<256 x double> %7, i64 8, i8* %5)
  %add.ptr = getelementptr inbounds double, double* %pvx.addr.025, i64 256
  %add.ptr3 = getelementptr inbounds double, double* %pvz.addr.024, i64 256
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vfcmpd.vsvmv(double, <256 x double>, <4 x i64>, <256 x double>) #3
