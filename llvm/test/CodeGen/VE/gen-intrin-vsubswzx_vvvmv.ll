...
; ModuleID = 'gen/tests/vsubswzx_vvvmv.c'
source_filename = "gen/tests/vsubswzx_vvvmv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vsubswzx_vvvmv(i32* %pvx, i32* %pvy, i32* %pvz, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vsubswzx_vvvmv
; CHECK: .LBB0_2
; CHECK: 	vsubs.w.zx %v3,%v0,%v1,%vm1
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %9 = tail call <256 x double> @llvm.ve.vsubswzx.vvvmv(<256 x double> %1, <256 x double> %3, <4 x i64> %6, <256 x double> %8)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vsubswzx.vvvmv(<256 x double>, <256 x double>, <4 x i64>, <256 x double>) #3
