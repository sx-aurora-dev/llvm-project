...
; ModuleID = 'gen/tests/vdivsl_vvv.c'
source_filename = "gen/tests/vdivsl_vvv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vdivsl_vvv(i64* %pvx, i64* %pvy, i64* %pvz, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vdivsl_vvv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %4 = tail call <256 x double> @llvm.ve.vdivsl.vvv(<256 x double> %1, <256 x double> %3)
...
declare <256 x double> @llvm.ve.vdivsl.vvv(<256 x double>, <256 x double>) #3
