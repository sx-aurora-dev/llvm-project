...
; ModuleID = 'gen/tests/vfsubd_vvvmv.c'
source_filename = "gen/tests/vfsubd_vvvmv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vfsubd_vvvmv(double* %pvx, double* %pvy, double* %pvz, i32* %pvm, double* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vfsubd.vvvmv(<256 x double>, <256 x double>, <4 x i64>, <256 x double>) #3
