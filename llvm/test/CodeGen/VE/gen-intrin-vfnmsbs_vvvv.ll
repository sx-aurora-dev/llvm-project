...
; ModuleID = 'gen/tests/vfnmsbs_vvvv.c'
source_filename = "gen/tests/vfnmsbs_vvvv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vfnmsbs_vvvv(float* %pvx, float* %pvy, float* %pvz, float* %pvw, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vfnmsbs_vvvv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %6 = tail call <256 x double> @llvm.ve.vfnmsbs.vvvv(<256 x double> %1, <256 x double> %3, <256 x double> %5)
...
declare <256 x double> @llvm.ve.vfnmsbs.vvvv(<256 x double>, <256 x double>, <256 x double>) #3
