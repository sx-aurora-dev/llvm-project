...
; ModuleID = 'gen/tests/vcmpswsx_vsvmvl_imm.c'
source_filename = "gen/tests/vcmpswsx_vsvmvl_imm.c"
...
define dso_local void @vcmpswsx_vsvmvl_imm(i32* %0, i32* %1, i32* %2, i32* %3, i32 signext %4) local_unnamed_addr #0 {
...
8:                                                ; preds = %5, %8
  ...
  %25 = tail call <256 x double> @llvm.ve.vl.vcmpswsx.vsvmvl(i32 3, <256 x double> %18, <4 x i64> %21, <256 x double> %23, i32 %16)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vcmpswsx.vsvmvl(i32, <256 x double>, <4 x i64>, <256 x double>, i32) #2
