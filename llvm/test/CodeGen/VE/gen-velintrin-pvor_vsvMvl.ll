...
9:                                                ; preds = %6, %9
  ...
  %27 = tail call <256 x double> @llvm.ve.vl.pvor.vsvMvl(i64 %1, <256 x double> %20, <8 x i64> %23, <256 x double> %25, i32 %18)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.pvor.vsvMvl(i64, <256 x double>, <8 x i64>, <256 x double>, i32) #2
