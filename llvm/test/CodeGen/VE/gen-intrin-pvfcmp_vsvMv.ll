...
; ModuleID = 'gen/tests/pvfcmp_vsvMv.c'
source_filename = "gen/tests/pvfcmp_vsvMv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvfcmp_vsvMv(float* %pvx, i64 %sy, float* %pvz, i32* %pvm, float* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.pvfcmp.vsvMv(i64, <256 x double>, <8 x i64>, <256 x double>) #3
