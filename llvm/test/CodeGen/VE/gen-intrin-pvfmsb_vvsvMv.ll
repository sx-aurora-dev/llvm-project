...
; ModuleID = 'gen/tests/pvfmsb_vvsvMv.c'
source_filename = "gen/tests/pvfmsb_vvsvMv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvfmsb_vvsvMv(float* %pvx, float* %pvy, i64 %sy, float* %pvw, i32* %pvm, float* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: pvfmsb_vvsvMv
; CHECK: .LBB0_2
; CHECK: 	pvfmsb %v3,%v0,%s2,%v1,%vm2
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %10 = tail call <256 x double> @llvm.ve.pvfmsb.vvsvMv(<256 x double> %2, i64 %sy, <256 x double> %4, <8 x i64> %7, <256 x double> %9)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.pvfmsb.vvsvMv(<256 x double>, i64, <256 x double>, <8 x i64>, <256 x double>) #3
