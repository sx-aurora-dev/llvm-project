...
; CHECK-LABEL: m5f128:
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:    lea %s0, .LCPI38_0@lo
; CHECK-NEXT:    and %s0, %s0, (32)0
; CHECK-NEXT:    lea.sl %s2, .LCPI38_0@hi(%s0)
...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:    lea %s0, .LCPI41_0@lo
; CHECK-NEXT:    and %s0, %s0, (32)0
; CHECK-NEXT:    lea.sl %s2, .LCPI41_0@hi(%s0)
; CHECK-NEXT:    ld %s0, 8(,%s2)
; CHECK-NEXT:    ld %s1, (,%s2)
; CHECK-NEXT:    or %s11, 0, %s9
...
; CHECK:       .LBB{{[0-9]+}}_2:
; CHECK-NEXT:    lea %s0, .LCPI44_0@lo
; CHECK-NEXT:    and %s0, %s0, (32)0
; CHECK-NEXT:    lea.sl %s2, .LCPI44_0@hi(%s0)
; CHECK-NEXT:    ld %s0, 8(,%s2)
; CHECK-NEXT:    ld %s1, (,%s2)
; CHECK-NEXT:    or %s11, 0, %s9
