...
; ModuleID = 'gen/tests/vsubul_vIvmvl.c'
source_filename = "gen/tests/vsubul_vIvmvl.c"
...
define dso_local void @vsubul_vIvmvl(i64*, i64*, i32*, i64*, i32) local_unnamed_addr #0 {
