...
; ModuleID = 'gen/tests/vmrgw_vvvM.c'
source_filename = "gen/tests/vmrgw_vvvM.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vmrgw_vvvM(i32* %px, i32* %py, i32* %pz, i32* %pm, i32 %n) local_unnamed_addr #0 {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vmrgw.vvvM(<256 x double>, <256 x double>, <8 x i64>) #3
