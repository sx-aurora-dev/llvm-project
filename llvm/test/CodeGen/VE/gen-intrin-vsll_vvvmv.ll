...
; ModuleID = 'gen/tests/vsll_vvvmv.c'
source_filename = "gen/tests/vsll_vvvmv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vsll_vvvmv(i64* %pvx, i64* %pvz, i64* %pvy, i32* %pvm, i64* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vsll_vvvmv
; CHECK: .LBB0_2
; CHECK: 	vsll %v3,%v0,%v1,%vm1
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %pvz.addr.028 = phi i64* [ %add.ptr3, %for.body ], [ %pvz, %entry ]
  ...
  %0 = bitcast i64* %pvz.addr.028 to i8*
  ...
  %9 = tail call <256 x double> @llvm.ve.vsll.vvvmv(<256 x double> %1, <256 x double> %3, <4 x i64> %6, <256 x double> %8)
  tail call void @llvm.ve.vst.vss(<256 x double> %9, i64 8, i8* %7)
  %add.ptr = getelementptr inbounds i64, i64* %pvx.addr.029, i64 256
  %add.ptr3 = getelementptr inbounds i64, i64* %pvz.addr.028, i64 256
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vsll.vvvmv(<256 x double>, <256 x double>, <4 x i64>, <256 x double>) #3
