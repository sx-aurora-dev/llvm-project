...
; CHECK-NEXT:    lvl %s0
; CHECK-NEXT:    vfmsb.s %v0, %v2, %v0, %v1, %vm1
...
; CHECK-NEXT:    lvl %s1
; CHECK-NEXT:    vfmsb.s %v0, %v1, %s0, %v0, %vm1
; CHECK-NEXT:    b.l.t (, %s10)
...
; CHECK-NEXT:    and %s1, %s1, (32)0
; CHECK-NEXT:    lvl %s1
; CHECK-NEXT:    vfmsb.s %v0, %s0, %v0, %v1, %vm1
; CHECK-NEXT:    b.l.t (, %s10)
...
; CHECK-NEXT:    and %s0, %s0, (32)0
; CHECK-NEXT:    lvl %s0
; CHECK-NEXT:    vfmsb.d %v0, %v2, %v0, %v1, %vm1
; CHECK-NEXT:    b.l.t (, %s10)
...
; CHECK-NEXT:    and %s1, %s1, (32)0
; CHECK-NEXT:    lvl %s1
; CHECK-NEXT:    vfmsb.d %v0, %v1, %s0, %v0, %vm1
; CHECK-NEXT:    b.l.t (, %s10)
...
; CHECK-NEXT:    and %s1, %s1, (32)0
; CHECK-NEXT:    lvl %s1
; CHECK-NEXT:    vfmsb.d %v0, %s0, %v0, %v1, %vm1
; CHECK-NEXT:    b.l.t (, %s10)
