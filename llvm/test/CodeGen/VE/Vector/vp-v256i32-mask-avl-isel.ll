...
; CHECK-NEXT:    vsubs.w.sx %v3,%v0,%v1,%vm1
; CHECK-NEXT:    # implicit-def: $v0
; CHECK-NEXT:    vmuls.w.sx %v0,%v2,%v3,%vm1
; CHECK-NEXT:    lea %s1, 256
; CHECK-NEXT:    # kill: def $sw1 killed $sw1 killed $sx1
; CHECK-NEXT:    lvl %s1
; CHECK-NEXT:    vstl %v0,4,%s0
...
; CHECK-NEXT:    # implicit-def: $v0
; CHECK-NEXT:    vdivu.w %v0,%v2,%v1,%vm1
; CHECK-NEXT:    lea %s1, 256
; CHECK-NEXT:    # kill: def $sw1 killed $sw1 killed $sx1
; CHECK-NEXT:    lvl %s1
; CHECK-NEXT:    vstl %v0,4,%s0
...
; CHECK-NEXT:    pvxor.lo %v4,%v0,%v3,%vm1
; CHECK-NEXT:    # implicit-def: $v0
; CHECK-NEXT:    pvsra.lo %v0,%v4,%v1,%vm1
; CHECK-NEXT:    # implicit-def: $v1
; CHECK-NEXT:    pvsrl.lo %v1,%v0,%v2,%vm1
; CHECK-NEXT:    # implicit-def: $v2
; CHECK-NEXT:    pvsll.lo %v2,%v1,%v0,%vm1
; CHECK-NEXT:    lea %s1, 256
; CHECK-NEXT:    # kill: def $sw1 killed $sw1 killed $sx1
; CHECK-NEXT:    lvl %s1
; CHECK-NEXT:    vstl %v2,4,%s0
; CHECK-NEXT:    or %s11, 0, %s9
