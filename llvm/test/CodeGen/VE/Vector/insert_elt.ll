...
define fastcc <512 x i64> @insert_ri_v512i64_even(i64 %s) {
; CHECK-LABEL: insert_ri_v512i64_even:
; CHECK:       # %bb.0:
...
define fastcc <512 x i64> @insert_ri_v512i64_odd(i64 %s) {
; CHECK-LABEL: insert_ri_v512i64_odd:
; CHECK:       # %bb.0:
; CHECK-NEXT:    lea %s1, 186
; CHECK-NEXT:    lsv %v1(%s1), %s0
; CHECK-NEXT:    b.l.t (, %s10)
  %ret = insertelement <512 x i64> undef, i64 %s, i32 373
  ret <512 x i64> %ret
}
...
define fastcc <512 x double> @insert_ri_v512f64_even(double %s) {
; CHECK-LABEL: insert_ri_v512f64_even:
; CHECK:       # %bb.0:
; CHECK-NEXT:    lea %s1, 186
; CHECK-NEXT:    lsv %v0(%s1), %s0
; CHECK-NEXT:    b.l.t (, %s10)
...
define fastcc <512 x double> @insert_ri_v512f64_odd(double %s) {
; CHECK-LABEL: insert_ri_v512f64_odd:
; CHECK:       # %bb.0:
; CHECK-NEXT:    lea %s1, 186
; CHECK-NEXT:    lsv %v1(%s1), %s0
; CHECK-NEXT:    b.l.t (, %s10)
  %ret = insertelement <512 x double> undef, double %s, i32 373
  ret <512 x double> %ret
}
