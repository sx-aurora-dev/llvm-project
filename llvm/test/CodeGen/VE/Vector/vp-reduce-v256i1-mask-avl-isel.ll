...
; CHECK-NEXT:    b.l.t (, %s10)
  %r = call i1 @llvm.vp.reduce.and.v256i1(<256 x i1> %v, <256 x i1> %m, i32 %n)
  ret i1 %r
}

define fastcc i1 @test_reduce_or(<256 x i1> %v, <256 x i1> %m, i32 %n) {
...
; CHECK-NEXT:    or %s0, 0, %s1
; CHECK-NEXT:    b.l.t (, %s10)
  %r = call i1 @llvm.vp.reduce.or.v256i1(<256 x i1> %v, <256 x i1> %m, i32 %n)
  ret i1 %r
}

define fastcc i1 @test_reduce_xor(<256 x i1> %v, <256 x i1> %m, i32 %n) {
