...
define fastcc i1 @extract_ri_m0b3_v256i1(<256 x i1> %v) {
; CHECK-LABEL: extract_ri_m0b3_v256i1:
; CHECK:       # %bb.0:
; CHECK-NEXT:    svm %s0, %vm1, 0
; CHECK-NEXT:    sll %s0, %s0, 3
; CHECK-NEXT:    b.l.t (, %s10)
  %ret = extractelement <256 x i1> %v, i32 3
  ret i1 %ret
}

define fastcc i1 @extract_ri8_m1b59__v256i1(<256 x i1> %v) {
; CHECK-LABEL: extract_ri8_m1b59__v256i1:
; CHECK:       # %bb.0:
; CHECK-NEXT:    svm %s0, %vm1, 1
; CHECK-NEXT:    sll %s0, %s0, 59
; CHECK-NEXT:    b.l.t (, %s10)
  %ret = extractelement <256 x i1> %v, i32 123
  ret i1 %ret
}
