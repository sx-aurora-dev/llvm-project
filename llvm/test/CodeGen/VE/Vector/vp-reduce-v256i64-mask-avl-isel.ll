...
; CHECK-NEXT:    lvl %s0
; CHECK-NEXT:    vfmin.d %v2, %v2, %v3
; CHECK-NEXT:    lvs %s7,%v2(2)
; CHECK-NEXT:    # implicit-def: $v3
; CHECK-NEXT:    lsv %v3(0),%s7
; CHECK-NEXT:    lvs %s7,%v2(3)
; CHECK-NEXT:    lsv %v3(1),%s7
; CHECK-NEXT:    vfmin.d %v2, %v2, %v3
; CHECK-NEXT:    lvs %s7,%v2(1)
; CHECK-NEXT:    # implicit-def: $v3
; CHECK-NEXT:    lsv %v3(0),%s7
; CHECK-NEXT:    vfmin.d %v2, %v2, %v3
; CHECK-NEXT:    lvs %s7,%v2(0)
...
; CHECK-NEXT:    adds.l %s2, %s2, %s36
; CHECK-NEXT:    adds.l %s1, %s37, %s1
; CHECK-NEXT:    adds.l %s1, %s2, %s1
; CHECK-NEXT:    adds.l %s1, %s1, %s38
