...
; CHECK-NEXT:    lvl %s0
; CHECK-NEXT:    vfmin.d %v2,%v2,%v3
; CHECK-NEXT:    or %s4, 8, (0)1
; CHECK-NEXT:    # implicit-def: $v3
; CHECK-NEXT:    lvl %s4
; CHECK-NEXT:    vmv %v3,%s4,%v2,%vm2
; CHECK-NEXT:    lvl %s0
; CHECK-NEXT:    vfmin.d %v2,%v2,%v3
; CHECK-NEXT:    or %s5, 4, (0)1
; CHECK-NEXT:    # implicit-def: $v3
; CHECK-NEXT:    lvl %s5
; CHECK-NEXT:    vmv %v3,%s5,%v2,%vm2
; CHECK-NEXT:    lvl %s0
; CHECK-NEXT:    vfmin.d %v2,%v2,%v3
; CHECK-NEXT:    lvs %s6,%v2(2)
; CHECK-NEXT:    # implicit-def: $v3
; CHECK-NEXT:    lsv %v3(0),%s6
; CHECK-NEXT:    lvs %s6,%v2(3)
; CHECK-NEXT:    lsv %v3(1),%s6
; CHECK-NEXT:    vfmin.d %v2,%v2,%v3
; CHECK-NEXT:    lvs %s6,%v2(1)
; CHECK-NEXT:    # implicit-def: $v3
; CHECK-NEXT:    lsv %v3(0),%s6
; CHECK-NEXT:    vfmin.d %v2,%v2,%v3
; CHECK-NEXT:    lvs %s6,%v2(0)
...
; CHECK-NEXT:    lvl %s2
; CHECK-NEXT:    vmuls.l %v1,%v1,%v2
; CHECK-NEXT:    or %s6, 32, (0)1
; CHECK-NEXT:    # implicit-def: $v2
; CHECK-NEXT:    lvl %s6
; CHECK-NEXT:    vmv %v2,%s6,%v1,%vm2
; CHECK-NEXT:    lvl %s2
; CHECK-NEXT:    vmuls.l %v1,%v1,%v2
; CHECK-NEXT:    or %s7, 16, (0)1
; CHECK-NEXT:    # implicit-def: $v2
; CHECK-NEXT:    lvl %s7
...
; CHECK-NEXT:    lvl %s2
; CHECK-NEXT:    vmuls.l %v1,%v1,%v2
; CHECK-NEXT:    or %s35, 4, (0)1
; CHECK-NEXT:    # implicit-def: $v2
; CHECK-NEXT:    lvl %s35
; CHECK-NEXT:    vmv %v2,%s35,%v1,%vm2
; CHECK-NEXT:    lvl %s2
; CHECK-NEXT:    vmuls.l %v1,%v1,%v2
; CHECK-NEXT:    lvs %s36,%v1(2)
; CHECK-NEXT:    # implicit-def: $v2
; CHECK-NEXT:    lsv %v2(0),%s36
; CHECK-NEXT:    lvs %s36,%v1(3)
; CHECK-NEXT:    lsv %v2(1),%s36
; CHECK-NEXT:    vmuls.l %v1,%v1,%v2
; CHECK-NEXT:    lvs %s36,%v1(1)
; CHECK-NEXT:    # implicit-def: $v2
; CHECK-NEXT:    lsv %v2(0),%s36
; CHECK-NEXT:    vmuls.l %v1,%v1,%v2
; CHECK-NEXT:    lvs %s36,%v1(0)
; CHECK-NEXT:    lvl %s0
; CHECK-NEXT:    vrand %v1,%v0,%vm1
; CHECK-NEXT:    lvs %s37,%v1(0)
; CHECK-NEXT:    vrxor %v1,%v0,%vm1
; CHECK-NEXT:    lvs %s0,%v1(0)
; CHECK-NEXT:    lea %s38, -1
; CHECK-NEXT:    and %s38, %s38, (32)0
; CHECK-NEXT:    lea.sl %s38, 2147483647(, %s38)
; CHECK-NEXT:    lvl %s2
; CHECK-NEXT:    vbrd %v1,%s38
; CHECK-NEXT:    vmrg %v1,%v1,%v0,%vm3
; CHECK-NEXT:    # implicit-def: $v2
; CHECK-NEXT:    lvl %s3
; CHECK-NEXT:    vmv %v2,%s4,%v1,%vm2
...
; CHECK-NEXT:    # implicit-def: $v1
; CHECK-NEXT:    lvl %s35
; CHECK-NEXT:    vmv %v1,%s35,%v2,%vm2
; CHECK-NEXT:    lvl %s2
; CHECK-NEXT:    vcmps.l %v3,%v2,%v1
; CHECK-NEXT:    vfmk.l.lt %vm1,%v3,%vm2
; CHECK-NEXT:    vmrg %v1,%v1,%v2,%vm1
; CHECK-NEXT:    lvs %s38,%v1(2)
; CHECK-NEXT:    # implicit-def: $v2
; CHECK-NEXT:    lsv %v2(0),%s38
; CHECK-NEXT:    lvs %s38,%v1(3)
; CHECK-NEXT:    lsv %v2(1),%s38
; CHECK-NEXT:    vcmps.l %v3,%v1,%v2
; CHECK-NEXT:    vfmk.l.lt %vm1,%v3,%vm2
; CHECK-NEXT:    vmrg %v2,%v2,%v1,%vm1
; CHECK-NEXT:    lvs %s38,%v2(1)
; CHECK-NEXT:    # implicit-def: $v1
; CHECK-NEXT:    lsv %v1(0),%s38
; CHECK-NEXT:    vcmps.l %v3,%v2,%v1
; CHECK-NEXT:    vfmk.l.lt %vm1,%v3,%vm2
; CHECK-NEXT:    vmrg %v1,%v1,%v2,%vm1
; CHECK-NEXT:    lvs %s38,%v1(0)
; CHECK-NEXT:    or %s39, 0, (0)1
; CHECK-NEXT:    vbrd %v1,%s39
; CHECK-NEXT:    vmrg %v1,%v1,%v0,%vm3
; CHECK-NEXT:    # implicit-def: $v0
; CHECK-NEXT:    lvl %s3
; CHECK-NEXT:    vmv %v0,%s4,%v1,%vm2
; CHECK-NEXT:    lvl %s2
...
; CHECK-NEXT:    adds.l %s1, %s1, %s36
; CHECK-NEXT:    adds.l %s0, %s37, %s0
; CHECK-NEXT:    adds.l %s0, %s1, %s0
; CHECK-NEXT:    adds.l %s0, %s0, %s38
