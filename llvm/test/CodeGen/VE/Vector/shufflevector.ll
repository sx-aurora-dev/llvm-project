...
define <8 x i32> @__regcall3__svv512i32(<4 x i32>) {
; CHECK-LABEL: __regcall3__svv512i32:
; CHECK:       # %bb.0:
...
; CHECK-NEXT:    b.l.t (, %s10)
  %2 = shufflevector <4 x i32> %0, <4 x i32> zeroinitializer, <8 x i32> <i32 0, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
  ret <8 x i32> %2
}

; Function Attrs: norecurse nounwind readnone
define <8 x i32> @__regcall3__svv512i32_brd2(<4 x i32>) {
; CHECK-LABEL: __regcall3__svv512i32_brd2:
; CHECK:       # %bb.0:
...
; Function Attrs: norecurse nounwind readnone
define <8 x i32> @__regcall3__svv512i32_brd7(<4 x i32>, <4 x i32>) {
; CHECK-LABEL: __regcall3__svv512i32_brd7:
; CHECK:       # %bb.0:
; CHECK-NEXT:    lvs %s0, %v1(3)
; CHECK-NEXT:    or %s1, 8, (0)1
; CHECK-NEXT:    lvl %s1
; CHECK-NEXT:    vbrd %v0, %s0
; CHECK-NEXT:    b.l.t (, %s10)
...
; Function Attrs: norecurse nounwind readnone
define <256 x i32> @__regcall3__svv512i32_vmrg(<256 x i32>, <256 x i32>) {
; CHECK-LABEL: __regcall3__svv512i32_vmrg:
; CHECK:       # %bb.0:
; CHECK-NEXT:    b.l.t (, %s10)
...
; CHECK-NEXT:    b.l.t (, %s10)
  %3 = shufflevector <256 x i32> %0, <256 x i32> %1, <256 x i32>
    <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7,
     ...
     i32 232, i32 233, i32 234, i32 235, i32 236, i32 237, i32 238, i32 239,
     i32 240, i32 241, i32 242, i32 243, i32 244, i32 245, i32 246, i32 247,
     i32 264, i32 265, i32 266, i32 267, i32 268, i32 269, i32 270, i32 271>
  ret <256 x i32> %3
}

; Function Attrs: norecurse nounwind readnone
define <256 x i32> @__regcall3__svv512i32_vmrg2(<256 x i32>, <256 x i32>) {
; CHECK-LABEL: __regcall3__svv512i32_vmrg2:
; CHECK:       # %bb.0:
; CHECK-NEXT:    or %s0, 8, (0)1
; CHECK-NEXT:    or %s0, 0, %s0
; CHECK-NEXT:    lea %s1, 248
; CHECK-NEXT:    lvl %s1
; CHECK-NEXT:    vmv %v0, %s0, %v0, %vm0
; CHECK-NEXT:    xorm %vm1, %vm0, %vm0
; CHECK-NEXT:    lea.sl %s0, -16777216
; CHECK-NEXT:    or %s1, 16, (0)1
; CHECK-NEXT:    lvm %vm1, 3, %s0
...
; Function Attrs: norecurse nounwind readnone
; Mask(i) = (i + 17) % 256
define <256 x i32> @shuffle_vshift17(<256 x i32> %src) {
; CHECK-LABEL: shuffle_vshift17:
; CHECK:       # %bb.0:
; CHECK-NEXT:    or %s0, 17, (0)1
; CHECK-NEXT:    or %s0, 0, %s0
; CHECK-NEXT:    lea %s1, 239
; CHECK-NEXT:    lvl %s1
; CHECK-NEXT:    vmv %v1, %s0, %v0, %vm0
; CHECK-NEXT:    xorm %vm1, %vm0, %vm0
; CHECK-NEXT:    lea.sl %s1, -32768
...
; CHECK-NEXT:    lvl %s1
; CHECK-NEXT:    vmv %v1, %s0, %v0, %vm2
; CHECK-NEXT:    lea %s0, 130816
; CHECK-NEXT:    andm %vm2, %vm0, %vm1
; CHECK-NEXT:    or %s1, -8, (0)1
; CHECK-NEXT:    lvm %vm2, 0, %s0
; CHECK-NEXT:    or %s0, 0, %s1
...
; CHECK-NEXT:    b.l.t (, %s10)
  ...
  <i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5>
  ret <32 x i32> %r
}
