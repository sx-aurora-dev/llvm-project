...
define fastcc void @vec_store_v1f64(ptr %P, <1 x double> %V) {
; CHECK-LABEL: vec_store_v1f64:
; CHECK:       # %bb.0:
; CHECK-NEXT:    st %s1, (, %s0)
; CHECK-NEXT:    b.l.t (, %s10)
  store <1 x double> %V, ptr %P, align 8
  ret void
}

; Function Attrs: nounwind
define fastcc void @vec_store_v17f64(ptr %P, <17 x double> %V) {
...
; CHECK-NEXT:    b.l.t (, %s10)
  store <17 x double> %V, ptr %P, align 8
  ret void
}

declare void @llvm.masked.store.v256f64.p0v256f64(<256 x double>, ptr, i32 immarg, <256 x i1>)
declare void @llvm.masked.store.v128f64.p0v128f64(<128 x double>, ptr, i32 immarg, <128 x i1>)

; Function Attrs: nounwind
define fastcc void @vec_mstore_v128f64(ptr %P, <128 x double> %V, <128 x i1> %M) {
...
; CHECK-NEXT:    b.l.t (, %s10)
  call void @llvm.masked.store.v128f64.p0v128f64(<128 x double> %V, ptr %P, i32 16, <128 x i1> %M)
  ret void
}
...
; CHECK-NEXT:    vst %v0, 8, %s0, %vm1
; CHECK-NEXT:    b.l.t (, %s10)
  call void @llvm.masked.store.v256f64.p0v256f64(<256 x double> %V, ptr %P, i32 16, <256 x i1> %M)
  ret void
}
