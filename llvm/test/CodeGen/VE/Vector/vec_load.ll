...
; RUN: llc < %s -mtriple=ve-unknown-unknown -mattr=-packed,+vpu --ve-fast-mem=0 | FileCheck %s
; RUN: llc < %s -mtriple=ve-unknown-unknown -mattr=-packed,+vpu --ve-fast-mem=1 | FileCheck -check-prefix=FAST %s
