...
; CHECK-NEXT:    ld %s6, 4352(, %s11)
; CHECK-NEXT:    ld %s7, 4344(, %s11)
; CHECK-NEXT:    ld %s34, 4368(, %s11)
; CHECK-NEXT:    ld %s35, 4360(, %s11)
; CHECK-NEXT:    ld %s36, 4384(, %s11)
; CHECK-NEXT:    ld %s37, 4376(, %s11)
...
; CHECK-NEXT:    ld %s56, 4288(, %s11)
; CHECK-NEXT:    ld %s57, 4280(, %s11)
; CHECK-NEXT:    ld %s58, 4544(, %s11)
; CHECK-NEXT:    ld %s59, 4296(, %s11)
; CHECK-NEXT:    ld %s60, 4536(, %s11)
; CHECK-NEXT:    st %s57, (, %s0)
; CHECK-NEXT:    and %s57, 1, %s58
; CHECK-NEXT:    st1b %s57, 138(, %s0)
; CHECK-NEXT:    srl %s57, %s60, 48
; CHECK-NEXT:    st2b %s57, 136(, %s0)
; CHECK-NEXT:    sll %s57, %s59, 1
; CHECK-NEXT:    and %s56, 1, %s56
; CHECK-NEXT:    or %s56, %s56, %s57
; CHECK-NEXT:    st %s56, 8(, %s0)
; CHECK-NEXT:    srl %s56, %s55, 49
; CHECK-NEXT:    and %s54, 1, %s54
; CHECK-NEXT:    sll %s54, %s54, 15
; CHECK-NEXT:    or %s54, %s56, %s54
; CHECK-NEXT:    sll %s56, %s60, 16
...
; CHECK-NEXT:    srl %s38, %s37, 58
; CHECK-NEXT:    and %s36, 1, %s36
; CHECK-NEXT:    sll %s36, %s36, 6
; CHECK-NEXT:    or %s36, %s36, %s38
; CHECK-NEXT:    sll %s38, %s39, 7
; CHECK-NEXT:    or %s36, %s36, %s38
; CHECK-NEXT:    st %s36, 56(, %s0)
; CHECK-NEXT:    srl %s36, %s35, 59
; CHECK-NEXT:    and %s34, 1, %s34
; CHECK-NEXT:    sll %s34, %s34, 5
; CHECK-NEXT:    or %s34, %s36, %s34
; CHECK-NEXT:    sll %s36, %s37, 6
; CHECK-NEXT:    or %s34, %s34, %s36
; CHECK-NEXT:    st %s34, 48(, %s0)
; CHECK-NEXT:    srl %s34, %s7, 60
; CHECK-NEXT:    and %s6, 1, %s6
; CHECK-NEXT:    sll %s6, %s6, 4
; CHECK-NEXT:    or %s6, %s6, %s34
; CHECK-NEXT:    sll %s34, %s35, 5
; CHECK-NEXT:    or %s6, %s6, %s34
; CHECK-NEXT:    st %s6, 40(, %s0)
; CHECK-NEXT:    srl %s6, %s4, 61
; CHECK-NEXT:    and %s5, 1, %s5
; CHECK-NEXT:    sll %s5, %s5, 3
; CHECK-NEXT:    or %s5, %s6, %s5
; CHECK-NEXT:    sll %s6, %s7, 4
