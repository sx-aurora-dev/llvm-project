...
; CHECK-NEXT:    bsic %s10, (, %s12)
; CHECK-NEXT:    svm %s0, %vm10, 3
; CHECK-NEXT:    st %s0, 24(, %s19)
; CHECK-NEXT:    svm %s0, %vm10, 2
; CHECK-NEXT:    st %s0, 16(, %s19)
; CHECK-NEXT:    svm %s0, %vm10, 1
; CHECK-NEXT:    st %s0, 8(, %s19)
; CHECK-NEXT:    svm %s0, %vm10, 0
...
; CHECK-NEXT:    st %s0, 200(%s1, %s11)
; CHECK-NEXT:    lea %s1, 8(, %s1)
; CHECK-NEXT:    brne.l %s1, %s2, .LBB9_1
; CHECK-NEXT:  # %bb.2:
; CHECK-NEXT:    or %s11, 0, %s9
; CHECK-NEXT:    ld %s10, 8(, %s11)
; CHECK-NEXT:    ld %s9, (, %s11)
...
; CHECK-NEXT:    andm %vm10, %vm0, %vm2
; CHECK-NEXT:    or %s18, 0, %s0
; CHECK-NEXT:    andm %vm11, %vm0, %vm3
; CHECK-NEXT:    sll %s0, %s0, 6
; CHECK-NEXT:    lea %s1, __ve_grow_stack@lo
; CHECK-NEXT:    and %s1, %s1, (32)0
; CHECK-NEXT:    lea.sl %s12, __ve_grow_stack@hi(, %s1)
...
; CHECK-NEXT:    svm %s0, %vm11, 3
; CHECK-NEXT:    st %s0, 24(, %s19)
; CHECK-NEXT:    svm %s0, %vm11, 2
; CHECK-NEXT:    st %s0, 16(, %s19)
; CHECK-NEXT:    svm %s0, %vm11, 1
; CHECK-NEXT:    st %s0, 8(, %s19)
; CHECK-NEXT:    svm %s0, %vm11, 0
; CHECK-NEXT:    st %s0, (, %s19)
; CHECK-NEXT:    svm %s16, %vm11, 0
; CHECK-NEXT:    st %s16, 256(, %s17)
; CHECK-NEXT:    svm %s16, %vm11, 1
