...
; ModuleID = 'gen/tests/vdivul_vIvmv.c'
source_filename = "gen/tests/vdivul_vIvmv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vdivul_vIvmv(i64* %pvx, i64* %pvz, i32* %pvm, i64* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vdivul_vIvmv
; CHECK: .LBB0_2
; CHECK: 	vdivu.l %v2,3,%v0,%vm1
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %7 = tail call <256 x double> @llvm.ve.vdivul.vsvmv(i64 3, <256 x double> %1, <4 x i64> %4, <256 x double> %6)
