...
; ModuleID = 'gen/tests/vmrg_vvvm.c'
source_filename = "gen/tests/vmrg_vvvm.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vmrg_vvvm(i64* %px, i64* %py, i64* %pz, i32* %pm, i32 %n) local_unnamed_addr #0 {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vmrg.vvvm(<256 x double>, <256 x double>, <4 x i64>) #3
