...
define void @xorm_MMM(i64* nocapture %px, i64* nocapture readonly %py, i64* nocapture readonly %pz, i32 %n) {
...
entry:
  ...
  %32 = tail call <8 x i64> @llvm.ve.xorm.MMM(<8 x i64> %29, <8 x i64> %31)
...
; Function Attrs: nounwind readnone
declare <8 x i64> @llvm.ve.xorm.MMM(<8 x i64>, <8 x i64>)
