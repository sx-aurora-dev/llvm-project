...
; ModuleID = 'gen/tests/vbrdu_vsmv_f32.c'
source_filename = "gen/tests/vbrdu_vsmv_f32.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vbrdu_vsmv_f32(float* %pvx, float %sy, i32* %pvm, float* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vbrdu.vsmv.f32(float, <4 x i64>, <256 x double>) #3
