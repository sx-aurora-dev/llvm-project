...
; ModuleID = 'gen/tests/vdivswzx_vvsmv.c'
source_filename = "gen/tests/vdivswzx_vvsmv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vdivswzx_vvsmv(i32* %pvx, i32* %pvy, i32 %sy, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vdivswzx_vvsmv
; CHECK: .LBB0_2
; CHECK: 	vdivs.w.zx %v2,%v0,%s2,%vm1
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %pvy.addr.024 = phi i32* [ %add.ptr3, %for.body ], [ %pvy, %entry ]
  ...
  %0 = bitcast i32* %pvy.addr.024 to i8*
  ...
  %7 = tail call <256 x double> @llvm.ve.vdivswzx.vvsmv(<256 x double> %1, i32 %sy, <4 x i64> %4, <256 x double> %6)
  tail call void @llvm.ve.vstl.vss(<256 x double> %7, i64 4, i8* %5)
  %add.ptr = getelementptr inbounds i32, i32* %pvx.addr.025, i64 256
  %add.ptr3 = getelementptr inbounds i32, i32* %pvy.addr.024, i64 256
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vdivswzx.vvsmv(<256 x double>, i32, <4 x i64>, <256 x double>) #3
