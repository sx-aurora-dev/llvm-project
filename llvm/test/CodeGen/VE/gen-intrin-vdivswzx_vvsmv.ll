...
define void @vdivswzx_vvsmv(i32* %pvx, i32* %pvy, i32 %sy, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vdivswzx.vvsmv(<256 x double>, i32, <4 x i64>, <256 x double>)
