...
; ModuleID = 'gen/tests/vslaw_vvvmv.c'
source_filename = "gen/tests/vslaw_vvvmv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vslaw_vvvmv(i32* %pvx, i32* %pvz, i64* %pvy, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vslaw_vvvmv
; CHECK: .LBB0_2
; CHECK: 	vsla.w %v3,%v0,%v1,%vm1
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %pvz.addr.028 = phi i32* [ %add.ptr3, %for.body ], [ %pvz, %entry ]
  %pvy.addr.027 = phi i64* [ %add.ptr4, %for.body ], [ %pvy, %entry ]
  ...
  %0 = bitcast i32* %pvz.addr.028 to i8*
  %1 = tail call <256 x double> @llvm.ve.vldlsx.vss(i64 4, i8* %0)
  %2 = bitcast i64* %pvy.addr.027 to i8*
  ...
  %9 = tail call <256 x double> @llvm.ve.vslaw.vvvmv(<256 x double> %1, <256 x double> %3, <4 x i64> %6, <256 x double> %8)
  tail call void @llvm.ve.vstl.vss(<256 x double> %9, i64 4, i8* %7)
  %add.ptr = getelementptr inbounds i32, i32* %pvx.addr.029, i64 256
  %add.ptr3 = getelementptr inbounds i32, i32* %pvz.addr.028, i64 256
  %add.ptr4 = getelementptr inbounds i64, i64* %pvy.addr.027, i64 256
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vslaw.vvvmv(<256 x double>, <256 x double>, <4 x i64>, <256 x double>) #3
