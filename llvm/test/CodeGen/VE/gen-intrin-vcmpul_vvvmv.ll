...
; ModuleID = 'gen/tests/vcmpul_vvvmv.c'
source_filename = "gen/tests/vcmpul_vvvmv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vcmpul_vvvmv(i64* %pvx, i64* %pvy, i64* %pvz, i32* %pvm, i64* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vcmpul.vvvmv(<256 x double>, <256 x double>, <4 x i64>, <256 x double>) #3
