...
; ModuleID = 'gen/tests/vmaxswsx_vIvmvl.c'
source_filename = "gen/tests/vmaxswsx_vIvmvl.c"
...
define dso_local void @vmaxswsx_vIvmvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
