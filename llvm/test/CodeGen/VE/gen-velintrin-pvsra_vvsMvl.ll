...
9:                                                ; preds = %6, %9
  ...
  %27 = tail call <256 x double> @llvm.ve.vl.pvsra.vvsMvl(<256 x double> %20, i64 %2, <8 x i64> %23, <256 x double> %25, i32 %18)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.pvsra.vvsMvl(<256 x double>, i64, <8 x i64>, <256 x double>, i32) #2
