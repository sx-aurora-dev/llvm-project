...
; CHECK: xorm %vm2,%vm2,%vm4
; CHECK: xorm %vm3,%vm3,%vm5
  ...
  %51 = tail call <8 x i64> @llvm.ve.vl.xorm.MMM(<8 x i64> %47, <8 x i64> %50)
...
; Function Attrs: nounwind readnone
declare <8 x i64> @llvm.ve.vl.xorm.MMM(<8 x i64>, <8 x i64>) #1
