...
define dso_local void @eqvm_MMM(i64* nocapture %px, i64* nocapture readonly %py, i64* nocapture readonly %pz, i32 %n) local_unnamed_addr #0 {
...
entry:
  ...
  %32 = tail call <8 x i64> @llvm.ve.eqvm.MMM(<8 x i64> %29, <8 x i64> %31)
...
; Function Attrs: nounwind readnone
declare <8 x i64> @llvm.ve.eqvm.MMM(<8 x i64>, <8 x i64>) #1
