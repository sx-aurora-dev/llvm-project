...
define void @veqv_vsvmv(i64* %pvx, i64 %sy, i64* %pvz, i32* %pvm, i64* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.veqv.vsvmv(i64, <256 x double>, <4 x i64>, <256 x double>)
