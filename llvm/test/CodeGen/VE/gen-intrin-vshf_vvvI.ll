...
; ModuleID = 'gen/tests/vshf_vvvI.c'
source_filename = "gen/tests/vshf_vvvI.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vshf_vvvI(i64* %pvx, i64* %pvy, i64* %pvz, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vshf_vvvI
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %4 = tail call <256 x double> @llvm.ve.vshf.vvvs(<256 x double> %1, <256 x double> %3, i64 3)
...
declare <256 x double> @llvm.ve.vshf.vvvs(<256 x double>, <256 x double>, i64) #3
