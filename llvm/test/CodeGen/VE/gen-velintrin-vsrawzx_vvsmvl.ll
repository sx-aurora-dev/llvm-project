...
; ModuleID = 'gen/tests/vsrawzx_vvsmvl.c'
source_filename = "gen/tests/vsrawzx_vvsmvl.c"
...
define dso_local void @vsrawzx_vvsmvl(i32* %0, i32* %1, i64 %2, i32* %3, i32* %4, i32 signext %5) local_unnamed_addr #0 {
; CHECK: vsra.w.zx %v2, %v0, %s2, %vm1
  %7 = icmp sgt i32 %5, 0
...
9:                                                ; preds = %6, %9
  ...
  %26 = tail call <256 x double> @llvm.ve.vl.vsrawzx.vvsmvl(<256 x double> %19, i64 %2, <4 x i64> %22, <256 x double> %24, i32 %17)
