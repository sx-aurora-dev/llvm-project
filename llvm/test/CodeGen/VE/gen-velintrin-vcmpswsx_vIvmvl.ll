...
; ModuleID = 'gen/tests/vcmpswsx_vIvmvl.c'
source_filename = "gen/tests/vcmpswsx_vIvmvl.c"
...
define dso_local void @vcmpswsx_vIvmvl(i32*, i32*, i32*, i32*, i32) local_unnamed_addr #0 {
