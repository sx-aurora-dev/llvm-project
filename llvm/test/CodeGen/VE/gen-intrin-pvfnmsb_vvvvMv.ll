...
; ModuleID = 'gen/tests/pvfnmsb_vvvvMv.c'
source_filename = "gen/tests/pvfnmsb_vvvvMv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvfnmsb_vvvvMv(float* %pvx, float* %pvy, float* %pvz, float* %pvw, i32* %pvm, float* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: pvfnmsb_vvvvMv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %12 = tail call <256 x double> @llvm.ve.pvfnmsb.vvvvMv(<256 x double> %2, <256 x double> %4, <256 x double> %6, <8 x i64> %9, <256 x double> %11)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.pvfnmsb.vvvvMv(<256 x double>, <256 x double>, <256 x double>, <8 x i64>, <256 x double>) #3
