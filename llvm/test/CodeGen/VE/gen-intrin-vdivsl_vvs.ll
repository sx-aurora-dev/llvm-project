...
; ModuleID = 'gen/tests/vdivsl_vvs.c'
source_filename = "gen/tests/vdivsl_vvs.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vdivsl_vvs(i64* %pvx, i64* %pvy, i64 %sy, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vdivsl_vvs
; CHECK: .LBB0_2
; CHECK: 	vdivs.l %v0,%v0,%s2
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %pvy.addr.017 = phi i64* [ %add.ptr3, %for.body ], [ %pvy, %entry ]
  ...
  %0 = bitcast i64* %pvy.addr.017 to i8*
  %1 = tail call <256 x double> @llvm.ve.vld.vss(i64 8, i8* %0)
  %2 = tail call <256 x double> @llvm.ve.vdivsl.vvs(<256 x double> %1, i64 %sy)
  ...
  %add.ptr3 = getelementptr inbounds i64, i64* %pvy.addr.017, i64 256
...
declare <256 x double> @llvm.ve.vdivsl.vvs(<256 x double>, i64) #3
