...
; ModuleID = 'gen/tests/pvsll_vvvMv.c'
source_filename = "gen/tests/pvsll_vvvMv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvsll_vvvMv(i32* %pvx, i32* %pvz, i32* %pvy, i32* %pvm, i32* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.pvsll.vvvMv(<256 x double>, <256 x double>, <8 x i64>, <256 x double>) #3
