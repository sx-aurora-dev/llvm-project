...
define dso_local void @vrand_vvml(i64* %0, i64* %1, i32* %2, i32 signext %3) local_unnamed_addr #0 {
...
7:                                                ; preds = %4, %7
  ...
  %21 = tail call <256 x double> @llvm.ve.vl.vrand.vvml(<256 x double> %16, <4 x i64> %19, i32 %14)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vrand.vvml(<256 x double>, <4 x i64>, i32) #2
