...
; ModuleID = 'gen/tests/vand_vvv.c'
source_filename = "gen/tests/vand_vvv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vand_vvv(i64* %pvx, i64* %pvy, i64* %pvz, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vand_vvv
; CHECK: .LBB0_2
; CHECK: 	vand %v0,%v0,%v1
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %4 = tail call <256 x double> @llvm.ve.vand.vvv(<256 x double> %1, <256 x double> %3)
...
declare <256 x double> @llvm.ve.vand.vvv(<256 x double>, <256 x double>) #3
