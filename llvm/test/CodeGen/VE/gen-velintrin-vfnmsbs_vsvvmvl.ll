...
define dso_local void @vfnmsbs_vsvvmvl(float* %0, float %1, float* %2, float* %3, i32* %4, float* %5, i32 signext %6) local_unnamed_addr #0 {
...
10:                                               ; preds = %7, %10
  ...
  %30 = tail call <256 x double> @llvm.ve.vl.vfnmsbs.vsvvmvl(float %1, <256 x double> %21, <256 x double> %23, <4 x i64> %26, <256 x double> %28, i32 %19)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vl.vfnmsbs.vsvvmvl(float, <256 x double>, <256 x double>, <4 x i64>, <256 x double>, i32) #2
