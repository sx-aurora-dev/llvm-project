...
; ModuleID = 'gen/tests/vfmadd_vsvvmv.c'
source_filename = "gen/tests/vfmadd_vsvvmv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @vfmadd_vsvvmv(double* %pvx, double %sy, double* %pvz, double* %pvw, i32* %pvm, double* nocapture readnone %pvd, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: vfmadd_vsvvmv
; CHECK: .LBB0_2
; CHECK: 	vfmad.d %v3,%s1,%v0,%v1,%vm1
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %9 = tail call <256 x double> @llvm.ve.vfmadd.vsvvmv(double %sy, <256 x double> %1, <256 x double> %3, <4 x i64> %6, <256 x double> %8)
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vfmadd.vsvvmv(double, <256 x double>, <256 x double>, <4 x i64>, <256 x double>) #3
