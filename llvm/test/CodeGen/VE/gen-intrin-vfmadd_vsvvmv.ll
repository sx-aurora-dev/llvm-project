...
define void @vfmadd_vsvvmv(double* %pvx, double %sy, double* %pvz, double* %pvw, i32* %pvm, double* nocapture readnone %pvd, i32 %n) {
...
; Function Attrs: nounwind readnone
declare <256 x double> @llvm.ve.vfmadd.vsvvmv(double, <256 x double>, <256 x double>, <4 x i64>, <256 x double>)
