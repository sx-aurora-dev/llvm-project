...
; ModuleID = 'gen/tests/pvfmad_vvsv.c'
source_filename = "gen/tests/pvfmad_vvsv.c"
target datalayout = "e-m:e-i64:64-n32:64-S64-v16384:64:64"
target triple = "ve"

; Function Attrs: nounwind
define dso_local void @pvfmad_vvsv(float* %pvx, float* %pvy, i64 %sy, float* %pvw, i32 %n) local_unnamed_addr #0 {
; CHECK-LABEL: pvfmad_vvsv
; CHECK: .LBB0_2
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %5 = tail call <256 x double> @llvm.ve.pvfmad.vvsv(<256 x double> %2, i64 %sy, <256 x double> %4)
...
declare <256 x double> @llvm.ve.pvfmad.vvsv(<256 x double>, i64, <256 x double>) #3
