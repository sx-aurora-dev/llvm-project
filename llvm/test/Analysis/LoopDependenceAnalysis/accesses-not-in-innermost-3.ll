...
for.end:                                          ; preds = %for.body7, %for.body3
  ...
  %add8 = add nuw nsw i64 %i.05, 2
  %2 = mul nsw i64 %add8, %y
  %arrayidx9 = getelementptr inbounds i64, i64* %A, i64 %k.08
  %arrayidx10 = getelementptr inbounds i64, i64* %arrayidx9, i64 %2
  store i64 %sum.0.lcssa, i64* %arrayidx10, align 8
  %inc12 = add nuw nsw i64 %i.05, 1
  %cmp2 = icmp slt i64 %inc12, %x
  br i1 %cmp2, label %for.body3, label %for.inc14

for.inc14:                                        ; preds = %for.body, %for.end
  %inc15 = add nuw nsw i64 %k.08, 1
  %cmp = icmp slt i64 %inc15, %x
