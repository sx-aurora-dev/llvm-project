...
" declare <8 x double> @llvm.vp.minnum.v8f64(<8 x double>, <8 x double>, <8 x i1>, i32) "
" declare <8 x double> @llvm.vp.maxnum.v8f64(<8 x double>, <8 x double>, <8 x i1>, i32) "
" declare void @llvm.vp.store.v16i32.p0v16i32(<16 x i32>, <16 x i32>*, <16 x i1>, i32) "
" declare void @llvm.vp.scatter.v16i32.v16p0i32(<16 x i32>, <16 x i32*>, <16 x i1>, i32) "
" declare <16 x i32> @llvm.vp.load.v16i32.p0v16i32(<16 x i32>*, <16 x i1>, i32) "
" declare <16 x i32> @llvm.vp.gather.v16i32.v16p0i32(<16 x i32*>, <16 x i1>, i32) "
" declare float @llvm.vp.reduce.fadd.v16f32(float, <16 x float>, <16 x i1>, i32)  "
" declare float @llvm.vp.reduce.fmul.v16f32(float, <16 x float>, <16 x i1>, i32) "
" declare float @llvm.vp.reduce.fmin.v16f32(<16 x float>, <16 x i1>, i32) "
" declare float @llvm.vp.reduce.fmax.v16f32(<16 x float>, <16 x i1>, i32) "
" declare i32 @llvm.vp.reduce.add.v16i32(<16 x i32>, <16 x i1>, i32) "
" declare i32 @llvm.vp.reduce.mul.v16i32(<16 x i32>, <16 x i1>, i32) "
" declare i32 @llvm.vp.reduce.and.v16i32(<16 x i32>, <16 x i1>, i32) "
" declare i32 @llvm.vp.reduce.xor.v16i32(<16 x i32>, <16 x i1>, i32) "
" declare i32 @llvm.vp.reduce.or.v16i32(<16 x i32>, <16 x i1>, i32) "
" declare i32 @llvm.vp.reduce.smin.v16i32(<16 x i32>, <16 x i1>, i32) "
" declare i32 @llvm.vp.reduce.smax.v16i32(<16 x i32>, <16 x i1>, i32) "
" declare i32 @llvm.vp.reduce.umin.v16i32(<16 x i32>, <16 x i1>, i32) "
" declare i32 @llvm.vp.reduce.umax.v16i32(<16 x i32>, <16 x i1>, i32) "
...
" declare <16 x i1> @llvm.vp.icmp.v16i32(<16 x i32>, <16 x i32>, i8, <16 x i1>, i32) "
...
" declare <8 x double> @llvm.vp.uitofp.v8f64v8i64(<8 x i64>, <8 x i1>, i32) "
...
TEST_F(VPIntrinsicTest, GetParamPos) {
  ...
  for (Function &F : *M) {
    ...
    Optional<unsigned> MemPtrParamPos =
        VPIntrinsic::getMemoryPointerParamPos(F.getIntrinsicID());
    if (MemPtrParamPos) {
